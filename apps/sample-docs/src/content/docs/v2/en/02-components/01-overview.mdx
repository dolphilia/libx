...
| Component | Purpose | Example Use Case |
|-----------|---------|------------------|
| **CardGrid** | Responsive card layout | Feature grids and link collections |
| **TwoColumnContent** | Parallel content | Comparisons, before/after examples |
...
- **default slot**: Content rendered inside the component
...
- **Accessibility**: Uses semantic HTML and is verified by the repository accessibility checks

### Flexibility

- **Customizable**: Accepts `style` and `class`
