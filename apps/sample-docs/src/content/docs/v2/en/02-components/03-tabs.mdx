...
|------|------|---------|-------------|
| default slot | Astro slot | — | TabItem components (required) |
| `syncKey` | string | — | Synchronizes tabs with the same key |
...
| `class` | string | — | Additional CSS classes |
| default slot | Astro slot | — | Content rendered for the tab |
