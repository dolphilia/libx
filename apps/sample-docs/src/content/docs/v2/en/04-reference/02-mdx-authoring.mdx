...
import { Alert, Tabs, TabItem } from '@docs/ui';

# Data Pipelines

<Alert variant="success">Frontmatter drives navigation and meta tags.</Alert>
...
<Tabs>
  <TabItem label="CLI">Use scripts/create-version.js for new versions.</TabItem>
  <TabItem label="UI">Rebuild the sidebar after reorganizing content.</TabItem>
</Tabs>
