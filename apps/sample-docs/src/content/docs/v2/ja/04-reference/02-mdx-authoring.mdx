...
<Alert variant="success">フロントマターはナビゲーションとメタタグに利用されます。</Alert>
...
<Tabs>
  <TabItem label="CLI">新しいバージョンは scripts/create-version.js で作成できます。</TabItem>
  <TabItem label="UI">構造を変更したらサイドバーを再生成してください。</TabItem>
</Tabs>
