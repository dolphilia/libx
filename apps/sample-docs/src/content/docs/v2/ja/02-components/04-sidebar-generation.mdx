...
```
ファイル: apps/sample-docs/src/content/docs/v2/ja/01-guide/02-creating-documents.mdx
URL: /docs/sample-docs/v2/ja/01-guide/02-creating-documents
```
...
[
  {
    ...
    "items": [
      {
        "title": "ドキュメント作成の基本",
        "href": "/docs/sample-docs/v2/ja/01-guide/01-getting-started"
      },
      {
        "title": "ドキュメントの作成",
        "href": "/docs/sample-docs/v2/ja/01-guide/02-creating-documents"
      },
      {
        "title": "ドキュメントの編集", 
        "href": "/docs/sample-docs/v2/ja/01-guide/03-editing-documents"
      }
    ]
  },
  {
    ...
    "items": [
      {
        "title": "コンポーネント概要",
        "href": "/docs/sample-docs/v2/ja/02-components/01-overview"
      },
      {
        "title": "アイコンコンポーネント",
        "href": "/docs/sample-docs/v2/ja/02-components/02-icons"
      }
    ]
  }
]
...
```bash
# ファイル名を確認
ls -la apps/sample-docs/src/content/docs/v2/ja/01-guide/
...
```bash
# 生成されたJSONを確認
cat apps/sample-docs/public/sidebar/sidebar-ja-v2.json
...
- **[コンテンツ整理](/v2/ja/01-guide/04-organizing-content)**: 効果的なコンテンツ構造の設計
- **[自動化](/v2/ja/03-advanced/02-automation)**: ビルドプロセスの自動化
- **[カスタマイズ](/v2/ja/03-advanced/01-customization)**: 高度なカスタマイズオプション
