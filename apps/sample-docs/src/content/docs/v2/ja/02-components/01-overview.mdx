...
| コンポーネント | 目的 | 使用例 |
|--------------|------|---------|
| **CardGrid** | レスポンシブなカード配置 | 機能一覧、リンク集 |
| **TwoColumnContent** | 並列コンテンツ | 比較、変更前後の例 |
...
<div style="display: flex; gap: 1rem; margin: 1rem 0;">
  <Button href="/v2/ja/01-guide/01-getting-started">始める</Button>
  <Button variant="outline" href="/v2/ja/02-components/02-icons">アイコンを見る</Button>
</div>

### コンテンツカード

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem; margin: 1rem 0;">
  <Card title="始める" href="/v2/ja/01-guide/01-getting-started">
    ステップバイステップガイドでドキュメントの作成と管理の基本を学びましょう。
  </Card>
  
  <Card title="コンポーネント" href="/v2/ja/02-components/02-icons">
    インタラクティブ要素でドキュメントを強化する利用可能なUIコンポーネントを探索しましょう。
  </Card>
  
  <Card title="高度なトピック" href="/v2/ja/03-advanced/01-customization">
...
- **class**: スタイリング用のCSSクラス
- **style**: インラインスタイルオブジェクト
- **default slot**: コンポーネント内にレンダリングするコンテンツ
...
- **アクセシビリティ**: 意味的なHTMLを使い、リポジトリのアクセシビリティ検査で確認

### 柔軟性

コンポーネントは柔軟になるよう設計されています：

- **カスタマイズ可能**: styleとclassのpropsを受け取る
...
- **[アイコン](/v2/ja/02-components/02-icons)**: 視覚的インジケーターと強調を追加
- **[タブ](/v2/ja/02-components/03-tabs)**: 関連コンテンツをタブで整理
- **[サイドバー自動生成](/v2/ja/02-components/04-sidebar-generation)**: 大規模ドキュメントでも迷わないナビゲーションを提供
...
```jsx
<Button class="custom-button">カスタムスタイルボタン</Button>
```

## コンポーネントの開始

1. **[アイコンを探索](/v2/ja/02-components/02-icons)**: 最も一般的に使用されるコンポーネントから開始
2. **[タブを試す](/v2/ja/02-components/03-tabs)**: コンテンツを効果的に整理する方法を学ぶ
3. **[サイドバー自動生成](/v2/ja/02-components/04-sidebar-generation)**: 自動ナビゲーションのカスタマイズポイントを確認

## 次のステップ

コンポーネントでドキュメントを強化する準備はできていますか？

- **[アイコンコンポーネント](/v2/ja/02-components/02-icons)**: 多機能アイコンシステムについて学ぶ
- **[タブコンポーネント](/v2/ja/02-components/03-tabs)**: タブ付きインターフェースでコンテンツを整理
- **[サイドバー生成](/v2/ja/02-components/04-sidebar-generation)**: 自動ナビゲーションを理解
