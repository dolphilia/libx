...
* [Crypto 101][repo-crypto-101] ([Site][site-crypto-101], cc-nc) - 暗号に関する導入書
* [The little book about OS development][repo-littleosbook] ([Site][site-littleosbook], cc-nc-sa) - この文書は『オペレーティングシステム開発に関する小さな本』のソースコードです
...
* [Open Data Structures][repo-ods] ([Site][site-ods], cc) - 高品質なオープンソースコンテンツデータ構造の教科書を、数学的に厳密であり、完全な実装を提供する
* Algorithms, Etc. ([Site][site-algorithm-etc], cc-nc-sa) - このページには、イリノイ大学アーバナ・チャンプーン校でジェフ・エリクソンが担当したさまざまなアルゴリズム講義の授業ノートおよびその他のコース資料が含まれています。
* Introduction to Theory of Computation ([Site][site-michiel-computation], cc-sa) - これは、カーロン大学で2002年から教えている計算理論の大学院レベルの講義用の無料教科書です
* Discrete Structures for Computer Science: Counting, Recursion, and Probability ([Site][site-michiel-structures], cc-nc-sa) - これは、カーロン大学で2013年から教えているコンピュータサイエンス用の離散構造の大学院レベルの講義用の無料教科書です
* [graphbook][repo-graphbook] (GNU-FDL) - GNU-FDLによるアルゴリズムグラフ理論の書籍　著：デイビッド・ジョイナー、ミン・ファン・ナグエン、デイビッド・フィリップス。これはアルゴリズムグラフ理論に関する入門書である
* [Operating Systems and Middleware: Supporting Controlled Interaction][repo-operating-middleware] ([Site][site-operating-middleware] cc-sa) - 無料で編集可能なオペレーティングシステムの原理に関する教科書
* Programming on Parallel Machines ([Site][site-parallel-machine], cc-nd) - この書籍の目的は、あなたの精神を損なうリスクをもたずに、共有メモリ並列マシンをプログラムすることを支援することである
* [Is Parallel Programming Hard, And, If So, What Can You Do About It?][repo-perfbook] ([Site][site-perfbook], cc-sa) - この書籍の目的は、新規にプログラマーおよび科学者に高性能計算の基礎を教えることである
* High Performance Computing ([Site][site-high-perfomance-computing], cc)
* Natural Language Processing for the Working Programmer ([Site][site-nlpwp], cc) - 私たちは、所謂計算言語学者が人間の言語の構造を分析し、コンピュータが扱える形に変換するために使う技術について、多くのものを紹介する
* Fundamentals of Programming: With Object Oriented Programming ([Site][site-funop], cc-nc-sa) - この書籍は、Pythonを用いた初級コースにオブジェクト指向の原則を導入するためのバランスの取れたかつ柔軟なアプローチを提示している
* Introduction to Computing ([Site][site-introtocom], cc-nc-sa) - この書籍は、SchemeおよびPythonというプログラミング言語を用いて、コンピューティングにおける最も重要な概念を紹介している。本書は、手続きを定義することによって情報プロセスを記述する方法、手続きを実行するために必要なコストを分析する方法、そして機械的に計算できるものとできないものの根本的な制限についてに焦点を当てている。
* [Computer Science from the Bottom Up][repo-csftbu] ([Site][site-csftbu], cc-sa) - 下から上にコンピュータ科学を学ぶ — 自由に利用できるオンライン書籍。内容には二進数と二進論理、オペレーティングシステムの内部構造、ツールチェーンの基本、システムライブラリの基本が含まれる
* [Problem Solving with Algorithms and Data Structures][repo-psads] ([Site][site-psads], cc-nc-sa) - 問題解決におけるアルゴリズムとデータ構造の使用によるPythonによる例と実践
* Data Compression Explained ([Site][site-dce], custom liscense) - この本は、データ圧縮がどのように機能するかを理解したい人、またはデータ圧縮ソフトウェアを書くことを希望する人向けです。
...
### データサイエンス・統計 {#data-science-and-statistics}

* [LearnDataScience][repo-leads] (BSD) - データサイエンスにおける自己指導学習用のオープンコンテンツ
* [Think Stats][repo-thinkstats] ([Site][site-thinkstats], cc-sa) - プログラマー向けの確率と統計
* A Brief Introduction to Neural Networks ([Site][site-abinn], cc-nc-nd)
* Data Mining for the Masses ([PDF][site-dmftm], cc)
* [Bayesian Methods for Hackers][repo-baymh] ([Site][site-baymh], MIT) - ベイズ的方法および確率プログラミングについての導入：計算／理解を第一に、数学を第二に考える視点から
* Journal of Statistical Software ([Site][site-jstatsoft], cc-by)
* [The Book Of Jupyter][repo-jupyter-book] ([Site][site-jupyter-book], cc) - これは2015年7月に実施された（または実施される）高度なJupyter/IPython SciPyチュートリアルに含まれる一部の資料です
...
* [Ops School Curriculum][repo-ops-school] ([Site][site-ops-school], cc) - Ops School は、運用エンジニアになるための学習を支援する包括的なプログラムです
* [Twelve Factor App][repo-twelve-factor] ([Site][site-twelve-factor], MIT) - 12要因アプリは、ソフトウェアアズアサービスアプリを構築するための手法である
* Digital Oceans - チュートリアル ([Site][site-do-tutorials], cc-nc-sa) - 開発およびシステム管理チュートリアル
* [.htaccess Snippets][repo-htaccess] (Public Domain) - 便利な.htaccessのコード例をすべて一か所に集めたものです。
* [Travis CI][repo-travis-docs] ([Site][site-travis-docs], MIT) - トラビスのドキュメンテーション
* [CoreOS Documentation][repo-coreos] ([Site][site-coreos], Apache 2.0) - コアOSのドキュメンテーション
* [Packer Documentation][repo-packer] ([Site][site-packer], MPL) - Packerに関するドキュメンテーション
* [The Art of Command Line][repo-art-command-line] (cc-sa) - コマンドラインを1ページでマスター
* [Command Line Text Processing][repo-cli-text-processing] ([Site][site-cli-text-processing], cc-nc-sa) - テキストの検索から置換、並べ替えからテキストの美化まで
* [Linux Command Line][repo-linux-cli] ([Site][site-linux-cli], cc-nc-sa) - Linuxコマンドとシェルスクリプトの導入
...
### 数学・物理学 {#mathematics--physics}

* [Homotopy type theory][repo-hott-book] ([Site][site-hott-book], BSD) - ホモトピー型理論は、マーティン・ローフの内包型理論を抽象ホモトピー理論に解釈するものである。
* [Collision Detection][repo-jeff-collision] ([Site][site-jeff-collision], cc-nc-sa) - 衝突検出に関する書籍と例
...
* [Free Software Free Society: Selected Essays][repo-fsfs] ([Site][site-fsfs], GNU-FDL) - オープンソースアプリケーションのアーキテクチャ
* [Free as in Freedom (2.0)][repo-free-freedom-2] ([Site][site-free-freedom-2], GNU-FDL) - フリーとは自由（2.0）は、スタルマンが元の生物を改訂したものである。
...
* [500 Lines or Less][repo-500-lines] (cc & mit) - これは『500行以内』という書籍の元となる資料であり、オープンソースアプリケーションのアーキテクチャシリーズの第4巻である。
* [Guides][repo-thoughtbot-guides] (cc) - やりたいことの実現、良好なプログラミング、そしてスタイルの良いプログラミングに関するガイド。
* [An App Launch Guide][repo-app-launch-guide] ([Site][site-app-launch-guide], Public Domain) - このガイドは、製品を検証し、構築し、マーケティングし、リリースするためのすべての必要なステップを詳細に説明しており、特にアプリ開発に焦点を当てています。
* [Reverse Engineering for Beginners][repo-refb-book] ([Site][site-refb-book], cc-nc-nd) - 議論されたトピック：x86/x64、ARM/ARM64、MIPS、Java/JVM。
* [Build Podcast][repo-build-podcast] ([Site][site-build-podcast], Public Domain) - ビルド・ポッドキャストは、デザインと開発に使えるテクノロジーのツールについて、ハッキングや創造、物を作ることの楽しさをテーマにした番組です！
* Mozilla Developer Network ([Site][site-mdn], cc-by-sa) - オープンウェブの共有知識
* [The Little Introduction To Programming][repo-tlitp] ([Site][site-tlitp], cc-nc) - この本は、プログラミングの基礎を学ばせてくれます。あなたのプログラミングの目標がどのようなものであれ、そのすべてに基礎をなすものになります。
* [The Programming Historian][repo-tphistorian] ([Site][site-tphistorian], cc) - プログラミング・ヒストリアンは、人文学者が多様なデジタルツール、技術、ワークフローを学び、研究を進めるのを支援する、オンラインで開放アクセスであり、同行レビューを受けるチュートリアルセットである。
* [WHAT IS CODE?][repo-what-is-code] ([Site][site-what-is-code], cc-nc-nd) - パウル・フォードの『コードとは何か？』
...
* [Elasticsearch - [The Definitive Guide][repo-elastic-dg] ([Site][site-elastic-dg], cc-nc-nd) - Elasticsearchの定番ガイド
...
* [HTTP API Design Guide][repo-http-api] (cc) - Heroku プラットフォーム API の開発から抽出された HTTP API デザインガイド
* [Dive Into HTML5][repo-diveintohtml5] ([Site][site-diveintohtml5], cc) - HTML5に潜入：HTML5仕様およびその他の優れた標準から厳選された機能について詳しく解説
* [Web Fundamentals][repo-web-fundamentles] ([Site][site-web-fundamentles], Apache 2.0) - 現代ウェブ開発におけるベストプラクティス
* [Code Guide][repo-code-guide] ([Site][site-code-guide], MIT) - 柔軟で耐久性があり、持続可能なHTMLとCSSの基準
* [HTML Best Practices][repo-html-best] (cc0) - HTMLドキュメントを維持可能でスケーラブルに書くため
* [WebComponents.org][repo-webcomponents] ([Site][site-webcomponents], cc-sa) - Webコンポーネントのベストプラクティスを議論し、進化させる場
* [How to lose weight (in the browser)][repo-browser-diet] ([Site][site-browser-diet], cc-sa, MIT) - 定番のフロントエンドパフォーマンスガイド
* [North][repo-north] ([Site][site-north], MIT) - MIT設計および開発基準により、プロジェクトを統一し、導く
* RESTful Web APIs ([Site][site-restful-web-apis], cc-nc-nd) - RESTful Web APIs は、REST デザインについての最初の書籍形式の解説であり、RESTful Web APIs の前身である。
* DOM Enlightenment ([Site][site-domenlight], cc-nc-nd) - JavaScriptと現代のHTML DOMの関係を調査する
* [http2 explained][repo-http2-explained] ([Site][site-http2-explained], cc-nc-nd) - http2 explained は、広く普及している HTTP/1.1 プロトコルの後継である HTTP/2 を詳細に説明および記述した文書です
* RESTful API Guidelines ([Site][zalando-guidelines], cc) - 包括的で、「API First」設計ガイドラインをザランドが開発
...
### 執筆・ドキュメント {#writing-and-documentation}

* [Write the Docs][repo-write-the-docs] ([Site][site-write-the-docs], cc) - スフィンクスのドキュメンテーションや一般的な文章作成の場。
* [The Hitchhiker's Guide to Documentation!][repo-thgtd] ([Site][site-thgtd], cc-nc-sa) - このガイドは、ドキュメンテーションを作成するためのアドバイスとベストプラクティスハンドブックを提供することを目的としています。
* [CommonMark Spec][repo-commonmark-spec] ([Site][site-commonmark-spec], cc-sa) - CommonMarkは、マークダウン構文の合理的なバージョンであり、CおよびJavaScriptで実装された仕様とBSDライセンスに基づく参照実装が存在する。
* reStructuredText Markup Specification ([Site][site-rst-spec], Public Domain)
* [Prose for Programmers][repo-prose-prog] (cc-nc-nd) - ソフトウェア開発者に良い文章を書くのを助ける本
...
### ジャーナリズム・可視化 {#journalism-and-visualization}

* [Data Journalism Handbook][site-data-journalism-handbook] (cc-sa) - データジャーナリズムハンドブックは、データジャーナリズムという新しい分野に興味があるすべての人向けの無料オープンソースの参考書です
* [Intro to D3.js][repo-intro-to-d3] ([Site][site-intro-to-d3], Apache 2.0) - チュートリアルは、ブラウザ内でデータ可視化を作成するためのJavaScriptライブラリD3.jsについての概要を提供します。
* [The Nature of Code][repo-natureofcode] ([Site][site-natureofcode], cc-nc, LGPL) - この書籍は、Processingを用いた自然系のシミュレーションにおけるプログラミング戦略と技術について述べている
* [Data Science 45-min Intros][repo-data-science-45min] (Public Domain) - Jupyter Notebookによる基本的なプログラミング、統計学、機械学習技術の初学者向けプレゼンテーション
* [Data + Design][repo-data-design] ([Site][site-data-design],  cc-nc-sa) - 情報の準備と可視化についての簡単な導入
* [D3 101 Screencasts][repo-d3-101-screencasts] ([Site][site-d3-101-screencasts], MIT) - カーラン・ケレーラのD3.jsのスクリーンキャスト
* [Thematic Cartography Guide][repo-themacg] ([Site][site-themacg], cc-nc) - テーマベースのマッピングの基本原則についての短い、親しみやすいガイド
...
* Android Developers - APIガイド（[Site][site-android-api-guide]、cc）－Android開発用ドキュメンテーション
* [Best practices in Android development][repo-android-bp] (cc) - Android開発における「すべきこと」と「すべきでないこと」、フュチュリース開発者による
...
* [iOS Good Practices][repo-ios-good-practices] (cc) - iOS開発に役立つ良いアイデア、フューテリス開発者のもの。
* [iOS Developer and Designer Interview Questions][repo-ios-questions] (MIT) - iOS開発やデザインに開発者やデザイナーを雇い考える人々に役立つ小さなガイド
...
* [Cocktails for programmers][repo-cocktails-for-programmer] (MIT) - プログラマー向けのコクテール。プログラムマーカー向けのコクテール。
* [Solarized][repo-solarized] ([Site][site-solarized], MIT) - 機械と人のための高精度カラー
* [ØMQ - ガイド][repo-zguide] ([Site][site-zguide] cc-nc-sa) - ØMQの学習と使用
* [NPR Visuals' Best Practices][repo-npr-bp] (cc) - NPR視覚チーム向けのベストプラクティスおよびコーディング規約
* [10up Engineering Best Practices][repo-10up-bp] ([Site][site-10up-bp], MIT) - このガイドは、私たちは企業としてウェブサイトを設計する方法を示しています
* [Peco REAMDE][repo-peco] (MIT) - Peco（簡易的なインタラクティブフィルタツール）のドキュメンテーション
* [Learn X in Y minutes][repo-xyminutes] ([Site][site-xyminutes], cc-sa) - 次のお気に入りの言語を、風のように速く回遊してみよう！コミュニティが中心！
* [RxMarbles][repo-rxmarbles] ([Site][site-rxmarbles], BSD) - Rx Observableのインタラクティブな図解
...
* [Some Assembly Required][repo-sar] (cc-sa) - アセンブリへの親しみやすい導入
...
* [C Style][repo-cstyle] (cc-sa) - 私の好きなC言語のプログラミング習慣
* C Programming ([Site][site-c-programming], cc-sa) - C言語とその機能についての包括的な見方
...
* [Cofeescript Cookbook][repo-coffee-cookbook] ([Site][site-coffee-cookbook], cc) - コミュニティによるコミュニティのためのCoffeeScriptのレシピ。
...
* [Bootstrap][repo-bootstrap] ([Site][site-bootstrap], cc) - ブートストラップは、ウェブ上でレスポンシブかつモバイルファーストのプロジェクトを開発する際に最も人気のあるHTML、CSS、JavaScriptフレームワークです。
* [idiomatic CSS][repo-idiomatic-css] (cc) - 一貫性のある書く原則
* [Font Awesome][repo-font-awesome] ([Site][site-font-awesome], cc) - アイコン的なフォントとCSSツールキット
...
* Introduction to Programming using Fortran 95 ([Site][site-ipufortran], cc-nc-sa) - このテキストは、フォートラン95プログラミング言語を用いたプログラミングおよび問題解決についての導入を提供しています。
...
* [Why's Poignant Guide to Ruby][repo-poignant-ruby] ([Site][site-poignant-ruby], cc-sa) - これはただ小さなRubyの本です。あなたを圧迫しません。それは羽のように軽いです
* [Rails Guide][repo-rails-guide] ([Site][site-rails-guide], cc-sa) - Ruby on Rails用公式ガイド
* [The Rails Style Guide][repo-rails-style-guide] (cc) - コミュニティが中心となるRuby on Rails 4スタイルガイド
* [Ruby Style Guide][repo-ruby-style-guide] (cc) - コミュニティが中心となるRubyのコーディングスタイルガイド
* [Better Spec][repo-better-spec] ([Site][site-better-spec], MIT) - RSpec ベストプラクティス
* [Ruby Hacking Guide][repo-rhg] ([Site][site-rhg-english], cc-nc-sa) - Rubyハッキングガイド英語翻訳
* Practicing Ruby ([Site][site-practicing-ruby], cc-sa) - 我們提供涵蓋廣泛不同主題的濃縮程式設計經驗
* [Ruby Best Practices][repo-rbp] (cc-nc-sa) - ルビーのベストプラクティス、グレゴリー・ブラウン著
* [Neo Ruby Koans][repo-ruby-koan] ([Site][site-ruby-koan], cc-nc-sa) - ラブの言語を教えるためのコアンのセット
* [Middleman][repo-middleman] ([Site][site-middleman], cc) - ミドルマインのドキュメンテーション
* [Jekyll][repo-jekyll] ([Site][site-jekyll], MIT) - Jekyllに関するドキュメンテーション
* [Ruby Scripting][repo-ruby-scripting] ([Site][site-ruby-scripting], cc-nc-sa) - Rubyスクリプト用の例に基づくガイド
* [Ruby Regexp][repo-ruby-regexp] ([Site][site-ruby-regexp], cc-nc-sa) - Rubyの正規表現についてのステップバイステップガイド
...
* [ClojureDocs][repo-clojure-docs] ([Site][site-clojure-docs], Eclipse Public License) - クロージャープログラミング言語用のコミュニティが運営するドキュメンテーションと例のリポジトリ
* [Clojure Documentation][repo-clojure-doc] ([Site][site-clojure-doc], cc) - クロージャープログラミング言語用のコミュニティが運営するドキュメンテーションサイト
...
* [Elixir Getting Started][repo-elixir-getting-started] ([Site][site-elixir-getting-started], Apache 2.0) - 公式 Elixir チュートリアル
* [repo-30-days-of-elixir][repo-30-days-of-elixir] (MIT) - エリクス言語を30の練習で歩く
* [Elixir Style Guide][repo-elixir-style-guide] (cc) - エリクス向けコミュニティが運営するスタイルガイド
...
* [Structure and Interpretation of Computer Program][repo-sicp-lfe] ([Site][site-sicp-lfe], cc-sa) - 構造と解釈のコンピュータプログラム、LFE版
...
* [Go by Example][repo-go-by-example] (cc) - Go by Exampleは、注記付きの例プログラムを用いたGoの実践的な導入書
* [Build Web Application With Golang][repo-bwawg] (cc-sa) - Go言語の電子書籍：WebアプリケーションをGoで構築する方法の導入
...
* Learn You a Haskell for Great Good! ([Site][site-lyhfgg], cc-nc-sa) - 『Learn You a Haskell for Great Good!』は、この複雑な関数型言語についてのユーモラスで図解されたガイド書
* [How to learn Haskell][repo-howtlh] (cc0) - これは、他人を助ける経験に基づいて推奨されるHaskell学習のパスです
* [Haskell By Example][repo-haskell-example] ([Site][site-haskell-example], cc) - Haskell by Example は Go by Example の Haskell への移植である
...
* Learning JavaScript Design Patterns ([Site][site-ljdp], cc-nc-nd) - この書籍では、JavaScriptプログラミング言語に古典的および現代的な設計パターンを適用する方法を検討します
* [JavaScript-Garden][repo-javascript-garden] ([Site][site-javascript-garden], MIT) - JavaScript言語の最も不思議な部分についてのドキュメンテーションのコレクション
* [ECMAScript 6 Features][repo-es6-features] (MIT) - ECMAScript 6 は、ECMAScript 2015 とも呼ばれる ECMAScript の最新版
* [React Primer Draft][repo-react-primer] (GNU) - Reactを用いたシングルページアプリケーションの構築に必要な入門書
* [Angular Style Guide][repo-angular-style-guide] (MIT) - アンガルスタイルガイド：アンガル開発チームが良い実践を通じて一貫性を提供するための出発点
* [JavaScript : The Right Way][repo-jstherightway] ([Site][site-jstherightway], cc-nc-sa) - これは、JavaScriptに新規開発者を導入し、経験のある開発者にそのベストプラクティスについて学ばせるためのガイドです
* [Idiomatic JavaScript][repo-idiomatic-js] (cc) - JavaScriptの一貫性と自然な表現の原則
* [Angular Test Patterns][repo-angular-test-pattern] (MIT) - Angular 1.xアプリケーションのテスト用の高品質ガイド
* [Airbnb JavaScript Style Guide][repo-airbnb-javascript] (MIT) - JavaScriptに対するほぼ合理的なアプローチ
* [JavaScript Garden][repo-js-garden] ([Site][site-js-garden], MIT) - JavaScript言語の最もユニークな部分に関するドキュメンテーションのコレクション
* [Node.js Style Guide][repo-node-style-guide] (cc-sa) - node.js / JavaScript のコードのスタイルを整えるためのガイド。フォークして好みに合わせて調整してください
* [Node.js Best Practices][repo-nodejs-bp] ([Site][site-nodejs-bp], MIT) - これは、堅牢なNode.jsコードを書くためのベストプラクティスのリストです。これは、Felix GeisendörferのNode Style Guideや、コミュニティ内で一般的なものをインスピレーションとしています
* [function qualityGuide () {][repo-function-quality] (MIT) - このスタイルガイドは、チーム内の異なる開発者間で高い読みやすさと一貫性を保つために、アプリケーションのJavaScriptコードに適用すべき基本ルールを提供することを目的としています
* [The Node Beginner Book][repo-node-biginner] ([Site][site-node-biginner], cc-nc-sa) - ノード初心者書は、Node.jsおよび関数型プログラミングなど、JavaScriptのより高度なトピックについての包括的な紹介を提供する
* [Learn You The Node.js For Much Win!][repo-learn-node-win] (MIT) - ノード.jsを学ぶための勝利！ 自己指導型ワークショップを用いたノード.jsの導入
* Understanding ECMAScript 6 ([Site][site-understanding-es6], cc-nc-nd) - ECMAScript 6が近づいてきました、準備はいいですか？新しい概念はたくさんあります。この本で先に進んでみましょう！
* [An introduction to Node.js][repo-art-of-node] (cc-sa) - node.jsについての短い紹介
* [stream-handbook][repo-stream-handbook] (cc) - ノードプログラムでストリームを使用する方法
* [You Don't Know JS][repo-you-dont-know-js] ([Site][site-you-dont-know-js], cc-nc-nd) - JavaScriptに関する書籍シリーズ。@YDKJS on twitter。
* Eloquent JavaScript ([Site][site-eloquent-javascript], cc-nc) - JavaScriptについて、プログラミング、そしてデジタルの奇跡について
* [CasperJS][repo-casperjs] ([Site][site-casperjs], MIT) - CasperJSのドキュメンテーション
* [Ember.js Guide][repo-emberjs] ([Site][site-emberjs], MIT) - オーバービュー：Ember.js
* [React Document][repo-react] ([Site][site-react], cc) - Reactに関するドキュメンテーション
* [Flux Application Architecture][repo-flux] ([Site][site-flux], cc) - Fluxアプリケーションアーキテクチャに関するドキュメンテーション
* [Redux Document][repo-redux] ([Site][site-redux], MIT) - Reduxに関するドキュメンテーション
* [JavaScript RegExp][repo-js-regexp] ([Site][site-js-regexp], cc-nc-sa) - JavaScriptの正規表現についてのステップバイステップガイド
...
* [DIY Lisp][repo-diy-lisp] (BSD) - シンプルなプログラミング言語の実装に向けた、実践的かつテスト中心のガイド
* [Build Your Own Lisp][repo-buildyourownlisp] ([Site][site-buildyourownlisp], cc-nc-sa) - Cを学び、自作のプログラミング言語を1000行のコード以内で構築しよう！
...
* [NYTimes Objective-C Style Guide][repo-nytimes-objective-c-style-guide] (MIT) - このスタイルガイドは、ニューヨーク・タイムズのiOSチームが採用するコーディング規約を示しています。
...
* Real World OCaml ([Site][site-real-world-ocaml], cc-nc-nd) - リアルワールドOCAMLは、従来のプログラミング言語にある程度の経験があるプログラマーを対象としており、特に静的型付き関数プログラミングに特化したものではない。
...
* [Perl intro][repo-perl-intro] ([Site][site-perl-intro], cc-nc-sa) - perl 5 への導入コース（例をもとに
...
* [PHP: The Right Way][repo-php-right-way] ([Site][site-php-right-way], by-nc-sa) - PHPのベストプラクティス、受け入れられているコーディング標準、およびウェブ上の信頼できるチュートリアルへのリンクを、読みやすく、すぐに参照できるリファレンス
...
* [The Hitchhiker’s Guide to Python!][repo-python-hguide] ([Site][site-python-hguide], cc-nc-sa) - Pythonのベストプラクティスガイドブック、人間向けに書かれたもの。
* [Django Documentation][repo-django-document] ([Site][site-django-document], bsd) - DjangoというPythonのウェブフレームワークに関するドキュメンテーション
* Dive Into Python 3 ([Site][site-diveintopython3], cc-sa) - Dive Into Pythonは、経験のあるプログラマ向けの無料Python書籍
* [Explore Flask][repo-explore-flask] ([Site][site-explore-flask], Public Domain) - エクスプロール・フラスクは、フラスクでウェブアプリケーションを開発する際のベストプラクティスおよびパターンについての書籍
* [Full Stack Python][repo-full-python] ([Site][site-full-python],  MIT) - フルスタックPythonソースコード（ペリカン、ブートストラップ、マーカード）
* [A Byte of Python][repo-byte-python] ([Site][site-byte-python], cc-sa) - "A Byte of Python" は Python ライブラリを使用したプログラミングについての無料書籍です。これは初心者向けの Python ライブラリのチュートリアルまたはガイドとして機能します。
* Learning to Program Using Python ([Site][site-lpupython], cc-sa)
* [A guide to Python's magic methods][repo-magic-methods] ([Site][site-magic-methods], cc-nc-sa) - このガイドは数か月間のブログ記事のまとめです。テーマはマジックメソッドです
* [Think Python][repo-think-python] ([Site][site-think-python], cc-nc) - コンピュータサイエンティストのように考える方法
* Automate the Boring Stuff with Python ([Site][site-automatetheboringstuff], cc-nc-sa) - Pythonを使ってプログラムを書く方法を学び、手動で行うのに数時間かかる作業を数分で行うことができます。事前にプログラミング経験が不要です。
* [A Whirlwind Tour of Python][repo-whirlwind-tour] ([Site][site-whirlwind-tour], cc0) - プログラミングに既に慣れている研究者や開発者向けに、Python言語の基本的な要素についての速い導入
* [Practical Python Programming][repo-practical-python] ([Site][site-practical-python], cc-sa) - Pythonのプログラミングにおける基本的な側面を、スクリプトの作成、データ操作、およびプログラムの構成に焦点を当てて説明
* [Python Basics][repo-python-basics] ([Site][site-python-basics], cc-nc-sa) - Pythonの導入
* Google's Python Class ([Site][site-google-python], cc) - これは、少しのプログラミング経験がある人々がPythonを学ぶための無料講座です（注：このコースはPython 2.6以降を対象として設計されています。Python 3.xは対象外です）
* [Think DSP][repo-think-dsp] ([Site][site-think-dsp], cc-nc) - Pythonを使用したデジタル信号処理の導入
* [Python re(gex)?][repo-python-regex] ([Site][site-python-regex], cc-nc-sa) - Pythonの正規表現を学ぶためのステップバイステップガイド
...
* [The Rust Programming Language][repo-trpl] ([Site][site-trpl], MIT) - オフィシャル・ガイド for Rust
* [Rust by Example][repo-rust-by-example] ([Site][site-rust-by-example], MIT) - Rust by Example は、さまざまな Rust の概念および標準ライブラリを示す例の集合である
* [Rust For Rubyists][repo-rust-rubyist] ([Site][site-rust-rubyist], AGPL) - Rust for Rubyists は、Rust に対する最初のコミュニティによるチュートリアルだった
...
* [Introduction to R][repo-intro-r] ([Site][site-intro-r], cc-nc-sa & apache 2.0) - これらは、Pythonプログラマ向けに開催するRの初級ワークショップのノートです
* Cookbook for R ([Site][site-r-cookbook], cc-sa) - このクッキーの目的は、データ分析における一般的なタスクや問題に対する解決策を提供することである
...
* Racket Documentation ([Site][site-racket-documentation], LGPL) - Racketに関するドキュメンテーション
...
* [Scala Best Practices][repo-scala-bp] (cc) - ベストプラクティスのコレクション。貢献したい人々にやさしい
* [twitter.github.com/effectivescala][repo-effective-scala] ([Site][site-effective-scala], cc-by) - Twitterの効果的なScalaガイド
* [Scala School!][repo-scala-school] ([Site][site-scala-school], Apache 2.0) - スケールの基本を学ぶための教科書
...
* Deep into Pharo ([Site][site-deep-pharo], cc-sa) - ファロの内部に深く、ファロをカバーする書籍シリーズの2冊目
* Pharo by example ([Site][site-pharo-example], cc-sa) - Pharoによる例が、学生および開発者向けに作成されたもので、複数の例と演習を用いて、Pharo言語と環境を丁寧に導いてくれます
* Dynamic Web Development with Seaside ([Site][site-dwd-seaside], cc-nc-sa) - Seasideを用いた動的Web開発（開発者向け）は、Seasideの核心機能およびウェブ2.0サポートやデプロイなどの高度な機能を紹介する
* Squeak by Example ([Site][site-squeak-example], cc-sa) - Squeakを例によって学ぶ（学生および開発者向け）は、例と演習を用いて、Squeak言語と環境を丁寧に導いてくれます
...
* [Nginx Server Configs][repo-nginx-configs] (MIT) - Nginx HTTPサーバーのボイラープレート設定
...
* GNU Emacs manual ([Site][site-emacs-manual], GNU-FDL) - エマックスは、拡張可能でカスタマイズ可能であり、自説明型のリアルタイムディスプレイエディタである。このマニュアルは、エマックスで編集する方法およびそのカスタマイズ方法の一部を説明している
* GNU Emacs Lisp Reference Manual ([Site][site-elisp-manual], GNU-FDL) - Emacs Lispに関するドキュメンテーション
* [Emacs is sexy!][repo-emacs-sexy] ([Site][site-emacs-sexy], GNU) - Emacsへの愛を共有するためのシンプルなウェブサイト
* [Learn Vimscript the Hard Way][repo-vimscript-hard-way] ([Site][site-vimscript-hard-way], custom license) - Vimエディタのユーザー向けに、Vimをカスタマイズする方法を学ぶための書籍
* [The Emacs Lisp Style Guide][repo-elisp-style-guide] (cc) - このEmacs Lispスタイルガイドは、現実のEmacs Lisp開発者が他の現実のEmacs Lisp開発者によって維持可能なコードを書けるよう、ベストプラクティスを提案しています
* A Byte of Vim ([Site][site-byte-vim], cc-sa) - 『Vimの1バイト』は、すべてがコンピュータキーボードの使い方しか知らないあなたでも、Vimエディタ（バージョン7）の使い方を学ぶのを助ける書籍です
* [Vim Reference][repo-vim-reference] ([Site][site-vim-reference], cc-nc-sa) - 初心者から中級者向けのガイド
...
* [Pro Git][repo-progit] ([Site][site-progit], cc-nc-sa) - オープンソースのGitに関する書籍　スコット・チャコーンとベン・ストラブによる
* [A Git Style Guide][repo-git-style-guide] (cc) - これは、「Linuxカーネルに変更を導入する方法」、gitのマニュアルページおよびコミュニティ内で一般的に採用されているさまざまな慣例を参考にしたGitスタイルガイドです。
* [Github Cheatsheet][repo-github-cheatsheet] (MIT) - Git および GitHub の面白い機能の一覧
* [Git Magic][repo-git-magic] ([Site][site-git-magic], GPL) - Gitを使用するためのガイド
* [Git it][repo-git-it] ([Site][site-git-it], BSD) - GitとGitHubを学ぶためのワークショップ
...
* Gibber User Manual ([Site][site-gibber-manual], cc) - ギバーはブラウザ内で実行される創造的なコーディング環境です。本書ではギバーが開発された理由、その特徴、および使い方を解説しています
...
## ライブラリのドキュメント {#library-documentation}

* [riak docs][repo-riak] ([Site][site-riak], cc) - riakに関するドキュメンテーション
* [Vagrant][repo-vagrant] ([Site][site-vagrant], MIT) - Vagrantに関するドキュメンテーション
* [Docker][repo-docker] ([Site][site-docker], Apache 2.0) - Dockerに関するドキュメンテーション
* [phpMyAdmin][repo-phpmyadmin] ([Site][site-phpmyadmin], GPL) - phpMyAdminのドキュメンテーション
* [OmegaT][repo-omegat] ([Site][site-omegat], GPL) - オメガTのドキュメンテーション
* [Sphinx documentation][repo-sphinx-doc] ([Site][site-sphinx-doc], BSD) - スフィンクスのドキュメンテーション
* [Ansible Documentation][repo-ansible-document] ([Site][site-ansible-document], GPL) - Ansibleのドキュメンテーション
...
* 점프 투 파이썬 ([Site][site-jump-to-python], cc-nc-nd) - この書籍は、Pythonという言語に初めて触れる読者や、プログラミングをこれまで一度も経験したことがない人々を対象としています。プログラミングにおいて使用される専門用語を、わかりやすく解説しようと努めました。また、Pythonという言語の個別の特徴にのみ注目するのではなく、プログラミング全体に関する内容を、Pythonという言語を通じてわかりやすく説明しています。
...
* [JavaScript 标准参考教程][repo-jstutorial] ([Site][site-jstutorial], cc-nc) - オープンソースJavaScriptチュートリアル書、クライアントデバイスに焦点を当てた、中国語で書かれた
* [Build Web Applciation With Golang][repo-build-web-app-golang] (cc-sa) - Go言語の電子書籍：WebアプリケーションをGoで構築する方法の導入
* [七天学会NodeJS][repo-7days-node] ([Site][site-7days-node], MIT) - NodeJS初心者向けの入門教材で、NodeJSを使った各種プログラム開発に必要な知識を扱います。
* [C++ 并发编程指南][repo-adcct] (MIT) - C++の並列処理に関する詳細なチュートリアル
* [Backbone.js入门教程][repo-backbonejs-note] (MIT) - backbonejs学习笔记更新版，使用backbone1.1.0
* [ECMAScript 6入门][repo-es6tutorial-cn] ([Site][site-es6tutorial-cn], cc-nc) - ECMAScript 6で追加された構文機能を包括的に紹介する、オープンソースのJavaScript言語チュートリアル。
* [Nginx开发从入门到精通][repo-nginx-book-cn] ([Site][site-nginx-book-cn], cc-nc) - Nginxモジュール開発と内部原理を包括的に解説する、オープンソースのNginx開発チュートリアル。
* [FreeBSD 从入门到跑路](https://github.com/44bits/awesome-opensource-documents/blob/5452f2fefc0de6a91b8ac2b53d7d01de2baaeb75/repo-freebsdask-book-cn) ([Site][site-freebsdask-book-cn], cc-by) - これは FreeBSD オペレーティングシステムの書籍で、OpenBSD、NetBSD、DragonFly BSD、TwinCAT/BSD など BSD ファミリーのオペレーティングシステムについての概要章も含まれています
...
* [Android Development Training Course][repo-and-training] ([Site][site-and-training], Apache 2.0) - androidアプリ開発用のトレーニングコースリポジトリ
...
## その他の文書リスト・参考資料 {#another-documents-list--references}

* [Beautiful Docs][repo-beautiful-docs] - ポインタを用いた、有用でよく書かれており、他の面でも美しいドキュメンテーション
* [Papers We Love][repo-papers-we-love] - コンピュータサイエンス界から読む・議論するべき論文
* [Awesome Awesomeness][repo-awesome-awesomeness] - キュレーションされた、驚くべき素晴らしい素晴らしさのリスト
* [Awesome][repo-awesome] - 素晴らしいリストの厳選リスト
* [Readings in Databases][repo-db-readings] - データベースを理解し、新しいデータシステムを構築するために必要な論文のリスト
* [Python Reference][repo-python-reference] - 便利な関数、チュートリアル、その他Python関連の項目
* [Guides][repo-narkoz-guides] - 設計および開発ガイド
* [List of Free Learning Resources][repo-free-programming-books] - 自由に利用可能なプログラミング書籍
* [Gitbook][site-gitbook] - 現代的な出版ツールチェーン。アイデアから完成した、洗練された本までを簡単に導く
* [O'Reilly Open Books][site-oreilly-openbook] - オライリーレイは、年々、さまざまな「オープン」ライセンス形式の著作権を持つ「オープンブック」を多数出版してきました。著作権を「オープン」にした理由および、それらがオープンされた際の具体的なライセンス契約は、私たちの著者たちの多様な考えによって、それぞれ異なります
* [OnlineProgrammingBooks.com][site-online-programming-books] - このサイトは、プログラミング、コンピュータ科学、ソフトウェアエンジニアリング、ウェブデザイン、モバイルアプリ開発、ネットワーク、データベース、情報技術、AI、グラフィックスおよびコンピュータハードウェアに関する無料電子書籍およびオンライン書籍を、出版元または著者が自サイト上で合法的に提供しているものをリストしています
* [Free Software Foundation - books/documentation][site-fsf-book]
* [Green Tea Press][site-greentea-press] - アレン・ダウンイの無料書籍
* [Wikipedia books(community books)][site-wikipedia-book]
* [Python Books][repo-python-books] - PythonBooksは、Pythonに関する最高の無料電子書籍を紹介するサイトです
* [JSbooks][site-jsbooks] - 最も良い無料JavaScriptリソース
