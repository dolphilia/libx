...
- [オブジェクト](#objects)
- [配列](#arrays)
- [ブラウザー機能](#browser-features)
- [Node.js機能](#nodejs-features)
...
- ⭐️ [core-js-pure](https://github.com/zloirock/core-js) - 標準ライブラリ全体。
...
- [css-vars-ponyfill](https://github.com/jhildenbiddle/css-vars-ponyfill/) - [CSS変数／カスタムプロパティ](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties)
