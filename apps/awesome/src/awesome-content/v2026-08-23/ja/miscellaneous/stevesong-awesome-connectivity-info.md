...
- [](#)
  - [目次](#contents)
  - [世界の接続性指数](#global-connectivity-indexes)
  - [接続性マップ](#connectivity-maps)
  - [世界の定期接続性レポート](#periodic-global-connectivity-reports)
  - [地域別の接続性レポートとデータ](#regional-connectivity-reports-and-data)
  - [その他の情報源](#other-sources)
  - [ライセンス](#license)



<a id="global-connectivity-indexes"></a>
## 世界の接続性指数

**[`^        back to top        ^`](#)**

- ITU Global Connectivity Report - ([2022](https://www.itu.int/itu-d/reports/statistics/global-connectivity-report-2022/)) - 通信の現状を詳細に評価した内容。
- [ITU Measuring digital development](https://www.itu.int/en/ITU-D/Statistics/Pages/facts/default.aspx) - 事実とデータ。 ([2025](https://www.itu.int/itu-d/reports/statistics/facts-figures-2025/))([2023](https://www.itu.int/dms_pub/itu-d/opb/ind/d-ind-ict_mdd-2023-1-pdf-e.pdf)) ([March 2023 - Focus on Least Developed Countries​](https://www.itu.int/hub/publication/d-ind-ict_mdd-2023/)) ([2022](https://www.itu.int/hub/publication/d-ind-ict_mdd-2022/)) ([2021](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/FactsFigures2021.pdf)) ([2020](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/FactsFigures2020.pdf)) ([2019](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/FactsFigures2019.pdf)) ([2017](https://www.itu.int/en/ITU-D/Statistics/Documents/facts/ICTFactsFigures2017.pdf)).
- Portulans Institute - [Network Readiness Index](https://networkreadinessindex.org/) - ([2024](https://download.networkreadinessindex.org/reports/data/2024/nri-2024.pdf)) ([2023](https://networkreadinessindex.org/wp-content/uploads/reports/nri_2023.pdf)) ([2022](https://networkreadinessindex.org/wp-content/uploads/reports/nri_2022.pdf)) ([2021](https://networkreadinessindex.org/wp-content/uploads/reports/nri_2021.pdf)) ([2020](https://networkreadinessindex.org/wp-content/uploads/2020/11/NRI-2020-V8_28-11-2020.pdf)) ([2019](https://networkreadinessindex.org/2019/wp-content/uploads/2020/03/The-Network-Readiness-Index-2019-New-version-March-2020-2.pdf)) ポルタランズ研究所が発表した121か国を対象としたネットワーク準備指数
- [GSMA Mobile Connectivity Index](https://www.mobileconnectivityindex.com/) - (2024) モバイルインターネットの導入を支える4つの要因：インフラ、価格、消費者の準備、コンテンツに対して国を評価。
- A4AI Affordability Drivers Index - ([2021](https://web.archive.org/web/20220423194006/https://a4ai.org/affordability-report/data/?_year=2021&indicator=INDEX) - インターネットアーカイブ経由)([2020](https://a4ai.org/affordability-report/data/?_year=2020&indicator=INDEX)) - Alliance for Affordable Internet Access（[A4AI](https://a4ai.org)）によるインターネット料金の手頃さを示す指数。
- A4AI Mobile Broadband Data Costs - ([2020](https://web.archive.org/web/20210414222555/https://a4ai.org/extra/baskets/A4AI/2020/mobile_broadband_pricing_gni) - インターネットアーカイブ経由) ([Q4 2018](https://a4ai.org/extra/mobile_broadband_pricing_usd-2018Q4)) ([2017](https://a4ai.org/mobile-broadband-pricing-data/)) - 1GBのプリペイド式モバイルデータ料金を、1人当たりGNIに占める割合で示します。
- [Inclusive Internet Index](https://theinclusiveinternet.eiu.com/) - (2022) メタがスポンサードするインターネット接続の評価指数。可用性、価格、関連性、準備度を評価。
- [Huawei Global Connectivity Index](https://www.huawei.com/minisite/gci/en/) - (2020) 50か国における「デジタル変革」の状況を、供給、需要、体験、可能性に基づいて測定したスナップショット。
- [Cisco Visual Networking Index](https://www.cisco.com/c/en/us/solutions/service-provider/visual-networking-index-vni/index.html) - 2017–2022年の予測とトレンド、白書。
- [ITU Broadband Atlas](https://www.itu.int/ITU-D/treg/atlas/broadbandatlas.asp) - (2010) 世界のブロードバンド展開の状況とブロードバンドの規制環境を示すインタラクティブな情報図。
- [InternetLiveStats](http://www.internetlivestats.com/internet-users-by-country/) - (2016) 国別インターネットユーザー数。ITU、国連人口開発部、インドインターネット・モバイル協会（IAMAI）、世界銀行のデータから補間。
- [Internet World Stats](https://www.internetworldstats.com/) - インターネットユーザー数はニールセンおよびITUの統計から集計。
- [ITU ICT Development Index](https://www.itu.int/en/ITU-D/Statistics/Pages/IDI/default.aspx) - ([2024](https://www.itu.int/itu-d/reports/statistics/idi2024)) ([2023](https://www.itu.int/itu-d/reports/statistics/IDI2023/)) ([2017](http://www.itu.int/net4/ITU-D/idi/)) 3つの柱（ICTアクセス、ICT利用、ICTスキル）に基づく合成指数。
...
- [Speedtest Global Index](https://www.speedtest.net/global-index) - (2024) 世界のモバイルおよび固定ブロードバンド速度を月次で測定したインデックス。
- cable.co.uk's Worldwide Broadband Price Comparison - ([2023](https://www.cable.co.uk/mobiles/worldwide-data-pricing/2023/worldwide_mobile_data_pricing_data.xlsx)) ([2022](https://www.cable.co.uk/mobiles/worldwide-data-pricing/)) ([2019](https://www.cable.co.uk/broadband/speed/worldwide-speed-league/)) ([2018](https://www.cable.co.uk/broadband/pricing/worldwide-comparison/)) 世界のブロードバンドコストを固定線／無線アクセスに基づくインデックス。
- [Internet Poverty Index](https://internetpoverty.io/) 2024 - [World Data Lab.](https://worddatalab.com/)によるインターネット貧困指数
- [Emerging Digital Powerhouse Index](https://www.airgain.com/blog/emerging-digital-powerhouse-index/) 2024 - OECD諸国における大学進学率から5G接続までを含む要因に基づくランキング。無線メーカー [Airgain](https://www.airgain.com/)が発表。

<a id="connectivity-maps"></a>
## 接続性マップ

**[`^        back to top        ^`](#)**

- [African Undersea Cables](https://manypossibilities.net/african-undersea-cables/) - スティーブ・ソンのアフリカの海底光ファイバーケーブルの地図。
- [African Terrestrial Fibre Optic Infrastructure](https://afterfibre.nsrc.org/) - アフリカの陸上光ファイバーネットワークの地図、クリエイティブ・コモンズ、オープンデータ。
- [Global CDN Infrastructure Map](https://opentelecomdata.org/cdns/) - スティーブ・ソンによる世界中のコンテンツ配信ネットワーク（CDN）を示すオープンデータ地図（2024年5月）。
- [Africa Telecoms Map 2024](https://africa-map-2024.telegeography.com/) - Telegeographyの2024年のアフリカの通信事業者に関する地図（海底ケーブル、国際帯域幅、クラウドデータセンターを含む）。
- [Africa Bandwidth Maps](http://www.africabandwidthmaps.com/) - パウル・ハミルトンによるアフリカの陸上光ファイバーおよびマイクロ波ネットワーク地図。
- [Telegeography Submarine Cable Map](https://www.submarinecablemap.com/) - インタラクティブな海底光ファイバーケーブル地図。
...
- [Submarine Telecoms Forum](https://subtelforum.com/online-map/) - サブテルフォーラムは、海底ケーブルの優れたインタラクティブ地図とディレクトリ、および年次アルマンアックを提供しています。
- [Telegeography Cloud Infrastructure Map](https://www.cloudinfrastructuremap.com/) - 世界中のクラウドインフラストラクチャプロバイダーの地図。
- [ITU Infrastructure Connectivity Map](https://bbmaps.itu.int/bbmaps/) - ITUによる海底および陸上光ファイバーネットワークのオンライン地図。
- [GSMA Mobile Coverage Maps @ Mobile World Live](http://maps.mobileworldlive.com/) - 国ごとに分けて作成された、多少古いがまだ有用なモバイルネットワークカバレッジ地図。
- [Hurricane Electric 3D map](http://he.net/3d-map/) -  海底ケーブルおよびハリケーン電気のポイント・オブ・プレゼンス（POPs）およびルートを示すインタラクティブ3D地図。
- [GSMA Mobile Network Coverage Maps](https://www.mobilecoveragemaps.com) - 2024年4月にオフラインにした地図。
- [nperf Mobile coverage maps](https://www.nperf.com/en/map) - データを[nperf app](https://www.nperf.com/en/nperf-applications/)から収集したモバイルカバレッジに基づく地図。
- [ITU Disaster Connectivity Map](https://dcm.itu.int/) - 災害対応最初のレスポンダーが通信ネットワークインフラ、カバレッジ、パフォーマンスの状態を確認するために使用できる地図。
- [Ookla Data for Good](https://www.ookla.com/ookla-for-good/open-data) - Ooklaは、そのSpeedtest Globalインデックスの結果を示すオープンデータセットと地図を維持しています。

<a id="periodic-global-connectivity-reports"></a>
## 世界の定期接続性レポート

**[`^        back to top        ^`](#)**

- We Are Social ([2024](https://wearesocial.com/ca-en/blog/2024/01/digital-2024/)) ([2023](https://wearesocial.com/ca-en/blog/2023/01/digital-2023/)) ([2022](https://wearesocial.com/uk/blog/2022/01/digital-2022-another-year-of-bumper-growth-2/)) ([2021](https://wearesocial.com/uk/blog/2021/01/digital-2021-uk/)) ホートスイートによるインターネットおよびソーシャルメディアの採用に関する年次レポート。
- [Mobile Gender Gap Report](https://www.gsma.com/r/gender-gap/) GSMAから（[2024](https://www.gsma.com/solutions-and-impact/connectivity-for-good/mobile-for-development/blog/the-mobile-gender-gap-report-2024/)) ([2023](https://www.gsma.com/r/wp-content/uploads/2023/07/The-Mobile-Gender-Gap-Report-2023.pdf)) ([2022](https://www.gsma.com/r/wp-content/uploads/2022/06/The-Mobile-Gender-Gap-Report-2022.pdf)) ([2021](https://www.gsma.com/r/wp-content/uploads/2021/07/The-Mobile-Gender-Gap-Report-2021.pdf)) ([2020](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2020/02/GSMA-The-Mobile-Gender-Gap-Report-2020.pdf)) ([2019](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2019/03/GSMA-Connected-Women-The-Mobile-Gender-Gap-Report-2019.pdf)) ([2018](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2018/04/GSMA_The_Mobile_Gender_Gap_Report_2018_32pp_WEBv7.pdf))
...
- [Akamai State of the Internet / Connectivity Report](https://www.akamai.com/uk/en/multimedia/documents/state-of-the-internet/q1-2017-state-of-the-internet-connectivity-report.pdf) - (Q1 2017) 大規模CDN企業による接続性に関する報告書.
- [World Economic Forum - Global Information Technology Report](http://reports.weforum.org/global-information-technology-report-2016/) - (2016) 情報通信技術（ICT）がイノベーションを推進する役割を検討し、ネットワーク準備度指数を含む.
- UN E-Government Survey [2018](https://publicadministration.un.org/egovkb/en-us/Reports/UN-E-Government-Survey-2018) [2016](https://publicadministration.un.org/egovkb/en-us/Reports/UN-E-Government-Survey-2016) - 世界各国の電子政府および電子参加の発展を示す指数。
- [AfterAccess - Mobile & Internet Use in the Global South](http://afteraccess.net/wp-content/uploads/After-Access-Website-layout-r1.pdf) - 16か国におけるグローバル南の発展途上国における世論調査の結果を示す情報図解。調査対象は家庭および個人のICTアクセスと利用に関するもの。
- ITU Measuring Digital Development: ICT Price Trends - [2019](https://www.itu.int/en/ITU-D/Statistics/Documents/publications/prices2019/ITU_ICTpriceTrends_2019.pdf) - モバイル音声サービス、モバイルデータ、固定ブロードバンドの価格データの分析および比較。『情報社会の測定報告書』を置き換える。
- [DataReportal](https://datareportal.com/) - 市場分析会社ケピオスが提供する第三者からのデータ収集に基づくグローバルおよび国家レベルのデータ利用に関する報告書。

<a id="regional-connectivity-reports-and-data"></a>
## 地域別の接続性レポートとデータ

**[`^        back to top        ^`](#)**

- Development and Access to Information (DA2i) [Regional Reports](https://public.tableau.com/app/profile/da2i.reports/viz/DA2iRegionalReports/Introduction) - ワシントン大学の[TASCHA group](https://tascha.uw.edu/)が提供する接続性、自由、性別格差に関するダッシュボード。[IFLA](https://www.ifla.org/)が支援。
- [e-Conomy Africa 2020](https://www.ifc.org/wps/wcm/connect/publications_ext_content/ifc_external_publication_site/publications_listing_page/google-e-conomy): アフリカの1800億ドルインターネット経済の未来 - IFC／Googleが支援するアフリカのインターネット経済に関する報告書
...
- RIA Africa Mobile Pricing (RAMP) Indices Portal - ([Q3 2022](https://researchictafrica.net/research-ict-africa-ramp-index-2/)) - 音声/SMSパック、1GBデータパック、価格対価パックの価格情報。
...
- [Open Signal - State of Mobile Networks Reports](http://opensignal.com/reports/) - OpenSignalデータ収集に基づく、多様な国々をカバーするレポート
- [Open Signal - The state of mobile network experience in Africa](https://www.opensignal.com/2024/11/11/the-state-of-mobile-network-experience-in-africa) - (2024年11月) 27カ国におけるダウンロード速度とネットワーク品質の調査
- [Lions go digital: The Internet’s transformative potential in Africa](https://www.mckinsey.com/industries/high-tech/our-insights/lions-go-digital-the-internets-transformative-potential-in-africa) - (2013) 世界的なコンサルティング企業McKinseyによる、アフリカにおけるインターネットの影響力に関するレポート。
...
- [The Global Findex](https://www.worldbank.org/en/publication/globalfindex) - 2011年から公開されているGlobal Findex。2025年版にはデジタル接続性トラッカーが含まれます。
- [Internet Resilience Index (IRI)](https://pulse.internetsociety.org/resilience)- インターネット・ソサイエティが開発したIRIは、インターネットの耐性を測るための選定された重み付けされた指標を監視
- [ITU Data Hub](https://datahub.itu.int/) - ITUの世界ICT/通信指標データベース（WTID）のリニューアル版、現在は非営利用途に無料提供
- [SpeedChecker Insights](https://insights.speedchecker.com/) - モバイルインターネットの速度、遅延、カバレッジに関する国別定期レポート
- [Cloudflare Radar](https://radar.cloudflare.com/) - ([2024](https://blog.cloudflare.com/radar-2024-year-in-review/)) ([2023](https://blog.cloudflare.com/radar-2023-year-in-review/)) ([2022](https://blog.cloudflare.com/radar-2022-year-in-review/)) インターネットトラフィック、セキュリティ、ルーティング、停止、DNSなどに関する貴重なリソース
- [GSMA - Enabling Rural Coverage](https://www.gsma.com/mobilefordevelopment/wp-content/uploads/2018/02/Enabling_Rural_Coverage_English_February_2018.pdf) - (2018年2月) 開発国におけるモバイルブロードバンドのカバレッジを促進する規制および政策提言
- [SimilarWeb - Mobile App Ranking](https://www.similarweb.com/apps/top/google/app-index/us/all/top-free) - 国ごとの人気モバイルアプリのランキング
- [Global Stats by StatCounter](http://gs.statcounter.com/) - ブラウザ、地域、OS別に時間軸でブラウザ市場シェア
- [Global Mobile Suppliers Association](https://gsacom.com/) - LTEおよび5Gの導入に関するさまざまなレポート
- [Continent of Africa: High Resolution Population Density Maps](https://data.humdata.org/dataset/highresolutionpopulationdensitymaps) Metaによって開発されたHRSLデータセットが、人口マッピングにおいて極めて高い精度を提供
- [Kleiner Perkins Mary Meeker Internet Trends Report](https://www.kleinerperkins.com/perspectives/internet-trends-report-2018/) - (2018年5月) 世界中におけるインターネットの普及を左右するトレンド
- [WEF Internet for All](https://www.weforum.org/reports/internet-for-all-a-framework-for-accelerating-internet-access-and-adoption/) - (2016) インターネットアクセスと普及を加速するためのフレームワーク
- [M-Lab Global Network Diagnostic Tool](https://datastudio.google.com/s/r6ZnlTmHfwE) - M-Labは、グローバルネットワークパフォーマンスを測定するオープンかつ検証可能なプラットフォーム
- [LTE, WiMAX, HSPA+, 3G, GSM information by country](https://www.worldtimezone.com/4g.html) - 世界中のモバイルネットワークの最新リストおよび関連する周波数
- [Cisco Annual Internet Report (2018–2023) White Paper](https://www.cisco.com/c/en/us/solutions/collateral/executive-perspectives/annual-internet-report/white-paper-c11-741490.html) - 更新日：2020年2月28日
- [IPinfo.io - Country Pages](https://ipinfo.io/countries) - 国別IPデータの要約：トップAS、重要なルーター、都市レベル情報、キャリアIP、その他IPデータ
- [Cloudflare Radar's Internet Quality Index](https://radar.cloudflare.com/quality) - 国ごとのインターネットダウンロード速度とパフォーマンスの推定値
- [USAID Digital Ecosystem Country Assessments](https://www.usaid.gov/digital-strategy/implementation-tracks/track1-adopt-ecosystem/digital-ecosystem-country-assessments) - [Ghana 2024](https://www.usaid.gov/sites/default/files/2024-03/USAID_DECA_Ghana.pdf) [Tanzania 2023](https://www.usaid.gov/sites/default/files/2023-05/Tanzania%20DECA%20Report.pdf) [Mali 2023](https://www.usaid.gov/sites/default/files/2023-05/Mali%20DECA_English.pdf) [Zambia 2022](https://www.usaid.gov/sites/default/files/2022-12/USAID_Zambia_DECA.pdf) [Bangladesh 2023](https://www.usaid.gov/sites/default/files/2023-06/USAID_Bangladesh_DECA_1.pdf) [Nepal 2022](https://www.usaid.gov/sites/default/files/2022-05/USAID_Nepal_Digital_Ecosystem_Country_Assessment_FINAL.pdf) [Libya 2022](https://www.usaid.gov/sites/default/files/2022-12/USAID_Libya_DECA.pdf) その他はウェブサイトを参照
...
法律で認められる範囲で、[Steve Song](https://manypossibilities.net) は本作品に関するすべての著作権および関連する権利を放棄しています。
