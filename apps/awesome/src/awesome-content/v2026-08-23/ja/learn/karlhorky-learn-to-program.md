...
Web開発とデザインの動画コースを提供する**有料**プラットフォーム\
*(HTML, CSS, JavaScript, web development, web design)*

#### [Thinkful](https://www.thinkful.com/)
業界の専門家によるメンタリング付きWeb・モバイル開発コースを提供する**有料**プラットフォーム\
*(web development, frontend web development, AngularJS, Android, iOS)*

#### [exercism.io](https://exercism.io/)
プログラミング演習とコードレビューを扱う、クラウドソーシング型メンタリングの**無料**プラットフォーム\
...
AI学習アシスタントが支援する仮想環境内の実践的な技術スキルラボを提供する**フリーミアム**サービス\
...
任意の言語でプログラミングツールを一から再実装する**フリーミアム**サービス\
...
法律で認められる範囲において、[Karl Horky](https://github.com/karlhorky)はこの作品に関するすべての著作権および関連する権利または隣接権を放棄しています。

## コントリビューション <a id="contributing"></a>

正式なスタイルガイドの代わりとして、このリストの既存スタイルを維持するよう注意してください。
