...
* [CodePen](http://codepen.io) - ブラウザー上で使う無料のウェブエディター。
* [Hurl.it](https://www.hurl.it/) - ブラウザーで HTTP リクエストを実行。
* [Localtunnel](http://localtunnel.me) - localhost のポートを外部へ公開。
* [Placehold](http://placehold.it) - 任意サイズの独自プレースホルダー画像を生成。
* [Postman](https://www.getpostman.com/) - HTTP リクエスト、モックサーバー生成、API ドキュメント作成を行うツール。
