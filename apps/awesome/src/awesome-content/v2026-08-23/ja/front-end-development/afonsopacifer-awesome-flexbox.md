...
## ガイド <a id="guides"></a>
*開発者やデザイナーがこの素晴らしい技術の学習を始めるためのガイド。*
...
## クロスブラウザー <a id="cross-browser"></a>
*プロジェクトをどこでも動作させるためのヒントと技法 :D*
...
#### プリプロセッサーの実践 <a id="preprocessors-in-action"></a>
...
## その他の興味深い記事 <a id="other-interesting-articles"></a>
*Flexboxに関連する話題のリスト。*
...
*読むのに疲れましたか？対話型プレゼンテーションを見て、今すぐFlexboxを学びましょう。*
...
* [What the flexbox?](http://flexbox.io) - 習得を助けるシンプルな20本の動画講座。
* [Flexbox Fundamentals](https://egghead.io/lessons/misc-flexbox-fundamentals)


### [Sketching with CSS](http://www.sketchingwithcss.com) Flexboxガイド、著者：[@sfioritto](https://github.com/sfioritto)

#### 読み物 <a id="read-materials"></a>
* [Access 20+ Page Guide on Flexbox](http://www.sketchingwithcss.com/flexbox-tutorial/)

#### 動画資料 <a id="video-materials"></a>
...
#### スライドとノート <a id="slides-and-notes"></a>
...
## ライブラリとフレームワーク <a id="libraries-and-frameworks"></a>
*Flexboxベースの優れたライブラリ一覧。*
...
* [Fuux](https://github.com/henriquecustodia/fuux) - クラスと同様のFlexboxインターフェースを使うFlexboxライブラリ。
* [Ginger Grid](https://github.com/erwstout/ginger/) - かわいい犬にちなんで名付けられたFlexboxグリッドフレームワーク。
* [Bulma](http://bulma.io/) - Flexboxベースの現代的CSSフレームワーク。
* [Milligram](http://milligram.github.io/) - 最小限のCSSフレームワーク。
* [RolleiFLEX](http://kaisermann.github.io/rolleiflex/) - レスポンシブFlexboxグリッド。
* [Waffle Grid](https://lucasgruwez.github.io/waffle-grid) - 使いやすいFlexboxグリッドシステム。

## 注目プロジェクト <a id="featured-projects"></a>
*Flexboxに関する優れたプロジェクト。*
* [Cool examples of flexbox layout](http://codepen.io/collection/KegmA/) - CodePenコレクション。
* [flex-box](https://github.com/potch/flex-box) - Flexboxの基本を使いやすくするCustom Element。
* [Flexbugs](https://github.com/philipwalton/flexbugs) - Flexboxの問題とクロスブラウザー回避策をコミュニティがまとめたリスト。
* [Flexbox Froggy](http://flexboxfroggy.com/) - CSS Flexboxを学ぶゲーム。
* [Flexbox Patterns](http://www.flexboxpatterns.com/) - CSS FlexboxでUIコンポーネントを構築する方法を教える例とソースコード。
* [Flexbox Defense](http://www.flexboxdefense.com/) - すべての塔をCSS Flexboxで配置する、ひねりのあるタワーディフェンス。
* [Flexbox tester](http://madebymike.com.au/demos/flexbox-tester/) - Flex Itemの幅の計算方法を理解する。
* [Flexbox layout](https://github.com/google/flexbox-layout) - CSS Flexible Box Layout Moduleに似た機能をAndroidへもたらすライブラリプロジェクトFlexboxLayout。
* [FlexLayout for iOS](https://github.com/lucdion/FlexLayout) - Swiftを使ってFlexboxをiOSへ提供。簡潔、直感的、連鎖可能な構文。
* [grid-styled](https://github.com/jxnblk/grid-styled) - styled-componentsで構築されたFlexboxベースのレスポンシブReactJSグリッドシステム。
* [iron-flex-layout](https://www.webcomponents.org/element/PolymerElements/iron-flex-layout) - クロスプラットフォームFlexboxレイアウト向けStyle Mixin。
* [Post Apocalypse Flexbox](https://github.com/afonsopacifer/post-apocalypse-flexbox)
* [React-flexbox](https://github.com/tcoopman/react-flexbox) - インラインスタイルを使うReactでのCSS Flexbox実装。
* [Reflexbox](https://github.com/jxnblk/reflexbox) - レスポンシブReact Flexboxグリッドシステムの高階コンポーネント。
* [Solved by flexbox](https://github.com/philipwalton/solved-by-flexbox) - 以前はCSSだけで解くのが困難または不可能だった問題が、Flexboxで非常に簡単になった事例集。:metal:
* [Visualizing Flexbox](http://codepen.io/paultrone/pen/xwxNmQ?utm_campaign=CSS%2BLayout%2BNews&utm_medium=email&utm_source=CSS_Layout_News_6) - Flexプロパティを試せる小さく優れたCodePenデモ。
* [ZEEF CSS Flexbox](https://css-flexbox.zeef.com/afonso.pacifer) - ZEEF上のAwesome Flexbox。:metal:
* [Flexbox Zombies](http://flexboxzombies.com/p/flexbox-zombies) - CSS Flexboxを学ぶゲーム。
...
## フォローすべき人物 <a id="who-to-follow"></a>
*この話題について発信する人々。*
...
コントリビュートしたいですか？[こちらの推奨事項に従ってください](https://github.com/afonsopacifer/awesome-flexbox/blob/master/contributing.md)。
