...
*魅力的なサードパーティー製ターミナルエミュレーションアプリケーション。*
...
*macOS、Linux、Windows の CLI 向けパッケージマネージャー。*
