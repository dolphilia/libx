...
description: "Elixir／OTPの分野別ライブラリ、フレームワーク、運用ツール、教材、コミュニティ資源を分類した定本スナップショット"
licenseSource: "github-h4cc-awesome-elixir-readme-md"
---

# ElixirのAwesomeリスト [![CI Badge](https://github.com/h4cc/awesome-elixir/actions/workflows/ci.yml/badge.svg)](https://github.com/h4cc/awesome-elixir) [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) <a id="awesome-elixir--"></a>
Elixirの優れたライブラリや資料を集めた厳選リストで、[awesome-php](https://github.com/ziadoz/awesome-php)から着想を得ています。

追加すべきパッケージがある場合は、該当Issueに:+1:（`:+1:`）を付けるか、新しいIssueを作成してください。

[Elixirパッケージの厳選リストを掲載する他サイト](#other-awesome-lists)も参照できます。

- [ElixirのAwesomeリスト](#awesome-elixir--)
  - [アクター](#actors)
  ...
  - [認証](#authentication)
  - [認可](#authorization)
  - [ビヘイビアとインターフェース](#behaviours-and-interfaces)
  - [ベンチマーク](#benchmarking)
  ...
  - [キャッシュ](#caching)
  - [チャット](#chatting)
  - [クラウド基盤と管理](#cloud-infrastructure-and-management)
  - [コード解析](#code-analysis)
  - [コマンドラインアプリ](#command-line-applications)
  - [設定](#configuration)
  - [暗号](#cryptography)
  - [CSV](#csv)
  ...
  - [エンコードと圧縮](#encoding-and-compression)
  - [エラーと例外処理](#errors-and-exception-handling)
  - [イベント処理](#eventhandling)
  - [サンプルと興味深いもの](#examples-and-funny-stuff)
  - [機能フラグとトグル](#feature-flags-and-toggles)
  - [フィード](#feeds)
  ...
  - [HTTP](#http)
  - [画像](#images)
  - [計測／監視](#instrumenting--monitoring)
  - [JSON](#json)
  - [言語](#languages)
  ...
  - [Markdown](#markdown)
  - [その他](#miscellaneous)
  - [ネイティブ実装関数](#native-implemented-functions)
  - [自然言語処理（NLP）](#natural-language-processing-nlp)
  - [ネットワーク](#networking)
  - [オフィス](#office)
  - [ORMとデータマッピング](#orm-and-datamapping)
  - [OTP](#otp)
  ...
  - [RESTとAPI](#rest-and-api)
  - [検索](#search)
  - [セキュリティ](#security)
  - [SMS](#sms)
  - [静的ページ生成](#static-page-generation)
  - [統計](#statistics)
  - [テンプレート](#templating)
  - [テスト](#testing)
  - [テキストと数値](#text-and-numbers)
  - [サードパーティAPI](#third-party-apis)
  - [翻訳と国際化](#translations-and-internationalizations)
  - [ユーティリティ](#utilities)
  - [バリデーション](#validations)
