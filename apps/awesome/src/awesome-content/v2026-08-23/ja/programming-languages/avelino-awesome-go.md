...
description: "Goの分野別ライブラリ、開発・運用ツール、ソフトウェア、学習資料を分類した定本スナップショット"
licenseSource: "github-avelino-awesome-go-readme-md"
---

# GoのAwesomeリスト <a id="awesome-go"></a>
...
即時連絡には_[Golang Bridge](https://github.com/gobridge/about-us/blob/master/README.md)_コミュニティのSlackを利用します。[参加フォームはこちら](https://invite.slack.golangbridge.org/)です。

<a href="https://www.producthunt.com/posts/awesome-go?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-awesome-go" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291535&theme=light" alt="awesome-go - Curated list awesome Go frameworks, libraries and software | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>

**スポンサー:**

_GoのAwesomeリストに関するGoライブラリ、ツール、または資料です。_
...
> Goの優れたフレームワーク、ライブラリ、ソフトウェアの厳選リストです。[awesome-python](https://github.com/vinta/awesome-python)から着想を得ています。

**貢献:**

最初に[貢献ガイドライン](https://github.com/avelino/awesome-go/blob/main/CONTRIBUTING.md)を確認してください。すべての[貢献者](https://github.com/avelino/awesome-go/graphs/contributors)に感謝します。

> _保守されていない、または一覧に適さないパッケージやプロジェクトは、ファイル改善のためプルリクエストを送ってください。_
