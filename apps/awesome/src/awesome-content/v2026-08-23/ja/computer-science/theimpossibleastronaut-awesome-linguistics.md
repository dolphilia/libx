...
- [プログラミング](#programming)
    ...
    - [データセット](#data-sets)
- [リソース](#resources)
    - [深層学習モデルとTransformer](#deep-learning-models-and-transformers)
    - [Wikipedia上](#on-wikipedia)
    - [YouTube上](#on-youtube)
    - [書籍](#books)
        - [無料](#free)
        - [有料](#non-free)
...
### プログラミング
*アプリケーション開発に役立つライブラリ、フレームワーク、アプリケーション。*

### プラットフォームとツールキット
* [CLARIN-D web tools](https://www.clarin-d.net/en/analysing) - 研究データを分析するためのツール
* [CorpusExplorer](https://notes.jan-oliver-ruediger.de/software/corpusexplorer-overview/) - コーパス言語学者とテキスト／データマイニング愛好者向けのソフトウェア。CorpusExplorerは、使いやすいインターフェースの下に50以上の対話型可視化を組み合わせます。
* [Haxe-linguistics](https://github.com/sexybiggetje/haxe-linguistics) - Haxe向けの初期段階の言語学的分析・自然言語処理ライブラリ。
* [Natural](https://github.com/NaturalNode/natural) - Node.js向けの汎用自然言語ツール。
* [Natural Language ToolKit (NLTK)](http://www.nltk.org/) - 人間の言語データを扱うPythonプログラムを構築するための最も完全なプラットフォーム。
* [Snowball](https://snowballstem.org/) - ステミングアルゴリズムを容易に表現できる言語。
* [Spacy](https://spacy.io/) - Pythonによる産業水準の自然言語処理。
* [Mate Tools](http://hdl.handle.net/11022/1007-0000-0000-8E4E-A)、WebLicht経由のウェブサービス
* [UBIAI](https://ubiai.tools/) - 最も包括的な自動アノテーション機能を備えた、チーム向けの使いやすいテキストアノテーションツール。NER、関係、文書分類に加え、請求書ラベル付け用のOCRアノテーションもサポートします。
* [textblob-de](https://github.com/markuskiller/textblob-de) - spacy（上記）の優れた代替。
* [tyo](https://github.com/mongsvo/tyo) - Typo-Bridgesを見つけるためのユーティリティ。
* [UralicNLP](https://github.com/mikahama/uralicNLP) - 形態的に豊かで、その多くが危機に瀕するウラル語族を処理するためのオープンソースPythonライブラリ。多数のウラル語族について、形態素解析、生成、見出し語化、曖昧性解消、語彙検索を行えます。

### アルゴリズム
* [Stemming algorithms for various European languages](http://snowball.tartarus.org/texts/stemmersoverview.html) - snowballによる各種ステミングアルゴリズム。
* [The Porter Stemmer Algorithm](http://tartarus.org/martin/PorterStemmer/) - 作者Martin Porterが執筆・保守するPorter Stemming Algorithm配布の「公式」ホームページ。

### データセット
* [EuroRomCom Data](https://github.com/kirkins/euroromcom) - JSON形式の汎ロマンス語単語リスト。
* [Araneum Germanicum](http://aranea.juls.savba.sk/aranea_about/_germanicum.html)
* [CEHugeWebCorpus](https://lindat.mff.cuni.cz/repository/xmlui/handle/11372/LRT-2638) - CommonCrawlに基づくドイツ語コーパス
...
* [IDS Corpora](https://www1.ids-mannheim.de/kl/projekte/korpora) - ドイツ語参照コーパス
* [Leipzig Corpora Collection](https://wortschatz.uni-leipzig.de/en/download/) - 各言語でサンプリングした文。
* [SdeWaC](https://www.ims.uni-stuttgart.de/forschung/ressourcen/korpora/sdewac.en.html) - 大規模なドイツ語インターネットコーパス
...
### リソース
* [Low Resource Languages](https://github.com/RIchardLitt/low-resource-languages) - 低資源（人間）言語の保全、開発、文書化に関するリソースのリスト。
* [Language Science Press](https://langsci-press.org/) - 言語学分野のデジタルネイティブな研究者主導オープンアクセス出版社。
...
* [GermLM](https://github.com/tonianelope/Multilingual-BERT) (NERの探索)
...
### YouTube上
* [Computational Linguistics Lecture Playlist (Youtube)](https://www.youtube.com/playlist?list=PLegWUnz91WfuPebLI97-WueAP90JO-15i) - メリーランド大学の計算言語学授業の講義。
* [The Virtual Linguistics Campus](https://www.youtube.com/channel/UCaMpov1PPVXGcKYgwHjXB3g) - 同名のマールブルク大学eラーニングプラットフォームと相互接続された、CCライセンスの教育動画。

### 書籍
*より興味深く、完成度の高い書籍の一部。*

#### 無料
* [Essentials of Linguistics, 2nd edition](https://ecampusontario.pressbooks.pub/essentialsoflinguistics2/) - 入門書（第2版）。
* [Introduction to Linguistics](https://linguistics.ucla.edu/people/Kracht/courses/ling20-fall07/ling-intro.pdf)
* [Natural Language Processing with Python](https://www.nltk.org/book/) - NLTKパッケージの書籍。
