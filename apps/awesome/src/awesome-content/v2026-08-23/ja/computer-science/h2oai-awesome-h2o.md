...
- [コース](#courses)
- [H2Oを使用したソフトウェア](#software)
- [ライセンス](#license)

<a id="blog-posts--tutorials"></a>
## ブログ記事とチュートリアル
...
- [Are categorical variables getting lost in your random forests?](http://roamanalytics.com/2016/10/28/are-categorical-variables-getting-lost-in-your-random-forests/) - カテゴリー変数の符号化方式とツリーベースモデルへの影響を比較するベンチマーク（Scikit-learn対H2O）。2016年10月28日
- [Deep learning in R](http://www.rblog.uni-freiburg.de/2017/02/07/deep-learning-in-r/) - R向けオープンソース深層学習パッケージのベンチマーク。2016年3月7日
- [Szilard's machine learning benchmark](https://github.com/szilard/benchm-ml) - 一般的なオープンソース機械学習フレームワークにおけるRandom Forest、GBM、Deep Learning、GLM実装のベンチマーク。2015年7月3日
...
- [University of San Francisco (USF) Distributed Data System Class (MSDS 697)](https://github.com/dianewoodbridge/2020-msds697-example) - データサイエンス修士課程。
...
- [UCLA: Tools in Data Science (STATS 418)](https://github.com/szilard/teach-data-science-UCLA-master-appl-stats) - 応用統計学修士課程。
- [GWU: Data Mining (Decision Sciences 6279)](https://github.com/jphall663/GWU_data_mining) - ビジネスアナリティクス修士課程。
- [University of Cape Town: Analytics Module](http://www.stats.uct.ac.za/stats/study/postgrad/honours) - 統計科学の大学院優等課程。
- [Coursera: How to Win a Data Science Competition: Learn from Top Kagglers](https://www.coursera.org/learn/competitive-data-science) - Advanced Machine Learning専門講座。

<a id="software"></a>
## ソフトウェア

- [modeltime.h2o R package](https://business-science.github.io/modeltime.h2o/): H2O AutoMLを使用した予測。
- [Evaporate](https://github.com/ML4LHS/Evaporate): JavaScriptを介してブラウザー内でH2Oモデルを実行します。詳細は[こちら](https://twitter.com/kdpsinghlab/status/1367992786239242248)。
- [splash R package](https://github.com/ML4LHS/splash): H2O MOJOファイルへユーザーインターフェースを追加します。詳細は[こちら](https://twitter.com/kdpsinghlab/status/1367809740705792008)。
- [h2oparsnip R package](https://github.com/stevenpawley/h2oparsnip): H2Oアルゴリズムを[parsnip](https://parsnip.tidymodels.org/)パッケージへ接続するラッパー群です。
- [Spin up PySpark and PySparkling on AWS](https://github.com/kcrandall/EMR_Spark_Automation)
- [Forecast the US demand for electricity](https://github.com/RamiKrispin/USelectricity): H2O GLMで予測した米国電力需要のリアルタイム[ダッシュボード](https://ramikrispin.github.io/USelectricity/)です。
- [h2o3-pam](https://github.com/navdeep-G/h2o3-pam): H2O-3向けPartition Around Medoids（PAM）クラスタリングアルゴリズム。
- [h2o3-gapstat](https://github.com/navdeep-G/h2o3-gapstat): H2O-3向けGap Statisticアルゴリズム。
...
法律で認められる範囲において、[H2O.ai](http://h2o.ai)はこの作品に関するすべての著作権および関連する権利を放棄しています。
