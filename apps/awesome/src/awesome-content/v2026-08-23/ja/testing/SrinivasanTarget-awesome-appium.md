...
description: "SrinivasanTarget/awesome-appium の正規スナップショット"
...
> 優れた[Appium](http://appium.io/)の[資料](#contents)を厳選した一覧です。

PRによるリンク追加や、議論を始めるためのissue作成を歓迎します。

[awesome](https://github.com/sindresorhus/awesome)リストから着想を得ています。
...
- [ブログ](#blogs)
- [ワークショップ](#workshops)
- [クラウド／Dockerソリューション](#cloud-and-docker-solutions)
- [GitBook](#git-books)
...
<a id="server"></a>
## サーバー
- [Appium](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) - Appiumは、ネイティブ、ハイブリッドおよびモバイルWebおよびデスクトップアプリのためのオープンソース、クロスプラットフォームテスト自動化ツールであり、iOSのシミュレータ、Androidのエミュレータ、およびiOS、Android、Windows、Macの実際のデバイスでテストが可能。
...
<a id="inspectors"></a>
## インスペクター
- [Appium Desktop](https://github.com/appium/appium-desktop) - Mac、Windows、LinuxのデスクトップGUIにおけるAppiumサーバーとインスペクタ。
- [WebDriverAgent Inspector](https://github.com/facebook/WebDriverAgent/wiki/Starting-WebDriverAgent) - iOS用のWebDriverサーバーでシミュレータ内に実行。
- [Selendroid Inspector](http://selendroid.io/inspector.html) - selendroidテストサーバーに埋め込まれたウェブアプリ。
- [Appium iOS Inspector](https://github.com/mykola-mokhnach/Appium-iOS-Inspector) - Selendroidインスペクタの元のソースに基づくiOS要素の位置を特定するツール。
- [app-inspector](https://github.com/macacajs/app-inspector) - Macacajs App Inspector。

<a id="become-an-appium-pro"></a>
## Appium Proになる
...
<a id="tutorials"></a>
## チュートリアル
- [TOOLSQA](http://toolsqa.com/mobile-automation/appium/appium-tutorial/) - 初心者向けAppiumチュートリアル（Android＆iOS）。
- [GURU99](http://www.guru99.com/introduction-to-appium.html) - 初心者向けAppiumチュートリアル。
- [QTPSELENIUM](http://qtpselenium.com/home/course/training/mobile-automation-appium-tutorial) - Appiumチュートリアル。
- [Testing Diaries](http://www.testingdiaries.com/appium-tutorial/) - 完全初心者向けAppiumチュートリアル。
- [Appium Bootcamp](https://saucelabs.com/resources/articles/appium-bootcamp-chapter-1) - SauceによるAppium Bootcamp。
- [Appium Mobile Grid Setup](http://www.slideshare.net/justinison75/mobile-selenium-grid-setup) - モバイルグリッド – Android＆iOSの初歩。
- [Selenium Camp 2016](http://www.slideshare.net/justinison75/selenium-camp-2016) - Selenium Camp 2016。

<a id="blogs"></a>
## ブログ
 - [All about Appium Desired Capabilities](https://caps.cloudgrey.io/) - Appiumのdesired capabilitiesについてのすべて。
 - [Appium Architecture & Appium Desktop](https://www.zaizi.com/blog/appium-mobile-apps-automation-tool) - Appiumのアーキテクチャ、設定など（更新済）。
 - [Appium Architecture](http://www.3pillarglobal.com/insights/appium-a-cross-browser-mobile-automation-tool) - Appiumのアーキテクチャ
 - [All about Appium](https://en.wordpress.com/tag/appium/) - WordpressにおけるAppiumのすべて
 - [Appium with Image Recognition](https://medium.com/@SimonKaz/appium-with-image-recognition-17a92abaa23d#.x19ffxwbk) - 画像認識によるAppium - Simon Kaz
 - [Automate Android Actions using Appium](http://testingalert.com/automate-android-actions-using-appium/) - Appiumを使用したAndroid操作の自動化 - kkashyap1707
 - [Network Connection in Appium](https://medium.com/@eliasnogueira/how-to-deal-with-network-connection-in-appium-4-0-0-2134021fac25#.z5dfdv2jg) - Appium 4.0.0からのネットワーク接続の処理方法 - Elias Nogueira
 - [How to change language in Appium](https://medium.com/@eliasnogueira/appium-tips-changing-the-app-language-f0a1762dd927#.68mvqisri) - Appiumのヒント — アプリの言語変更 - Elias Nogueira
 - [Automated UI testing of a UWP app using Appium](https://medium.com/@yostane/automated-ui-testing-of-a-uwp-app-using-appium-dc10d8df6631#.3efp60w1j) - WindowsアプリドライバーによりUWPアプリがAppiumで利用可能になる - Yassine benabbas
 - [Context Switching in Appium](https://medium.com/@kevinmarkvi/switching-to-a-dynamically-named-context-handle-with-appium-and-java-c78d2b972eb6#.2ylda6ul6) AppiumとJavaで動的に名前付けされたコンテキストハンドルに切り替え - Kevin Berg
 - [A Robot Should Be Running Your Appium Tests](https://medium.com/devs-foodit/iphone-automation-with-a-one-fingered-robot-a2936c840285#.l37adndb3) - ロボットを使用したAppiumテストの実行方法 - Dan Cuellar
 - [Appium Tests on Buddybuild](https://medium.com/@stipe.kolovrat/appium-cucumber-tests-up-running-on-buddybuild-8955a88ab589#.wsyazko3g) - モバイルアプリの構築・デプロイおよびフィードバック収集を自動化 - Stipe Kolovrat
 - [Android setup Linux](https://www.smashingmagazine.com/2016/04/from-zero-to-appium-guide-configuring-appium-android/) - ゼロからAppium：AndroidでのAppium設定に関するハウツガイド
 ...
 - [GraphWalker](http://graphwalker.github.io/appium-example/) - GraphWalkerは、テスト自動化用のオープンソースのモデルベーステストツールであり、グラフを使ってテスト設計を簡単に行うように設計されている
 - [Appium + Mobile Game Testing](http://bitbar.com/mobile-game-testing-part-2-ui-and-functionality-image-recognition/) - モバイルゲームテスト – パート#2：UIおよび機能性＋画像認識
 - [WinAppDriver](http://www.hanselman.com/blog/WinAppDriverTestAnyAppWithAppiumsSeleniumlikeTestsOnWindows.aspx) - WinAppDriver - Windows上でAppiumのSeleniumのようなテストで任意のアプリをテスト
 - [IMAGE RECOGNITION WITH APPIUM](http://bitbar.com/appium-tip-27-using-appium-for-mobile-game-testing/) - Appiumを用いたモバイルゲームテスト
 - [Uncover invisible changes in automated tests](https://sourcediving.com/how-to-uncover-invisible-changes-in-automated-tests-b6a5dbff564e) - KazuCocoa による
  - [Adding AI to Appium](https://medium.com/testdotai/adding-ai-to-appium-f8db38ea4fac) - test.ai による


<a id="workshops"></a>
## ワークショップ
- [Appium Workshop Selnium Conf 2016](https://github.com/isonic1/appium-workshop) - 2016年のSeleniumカンファレンスにおけるAppiumワークショップ用リポジトリ - ジュスティン・アイソン．

<a id="cloud-and-docker-solutions"></a>
## クラウド／Dockerソリューション
- [Appium Tests in AWS Device Farm](https://github.com/awslabs/aws-device-farm-appium-tests-for-sample-app) - AWSデバイスファーム上で実行されるAppiumテストのサンプル．
- [Appium Tests in OpenSTF Device Farm](https://github.com/openstf/stf-appium-example) - STFデバイスファーム上で実行されるAppiumテストのサンプル．
- [Official Appium Docker Images](https://github.com/appium/appium-docker-android) - Appium Android実機用のDockerファイル．
- [Appium Docker Images](https://github.com/butomo1989/docker-android) - Appium Android用のDockerファイル．
- [Appium Docker File](https://github.com/aluedeke/appium-android) - Appium Android用のDockerファイル．
- [Appium Docker File](https://github.com/softsam/docker-appium) - Appium Android用のDockerファイル．
- [TestingBot](https://testingbot.com) - クラウドベースのデバイスファームで、物理的なAndroidおよびiOSデバイス上でAppiumテストを実行．

<a id="git-books"></a>
## GitBook
- [Appium Essentials](https://www.packtpub.com/application-development/appium-essentials/?utm_source=POD&utm_medium=referral&utm_campaign=1784392480) - Appiumを使ってモバイルオートメーションを体験し、ネイティブ、ウェブ、ハイブリッドアプリケーションの新しいテスト方法を発見 - マノージ・ハンス．
- [Appium for Android](https://www.gitbook.com/book/nishantverma/appium-for-android) - Javaを使ってAndroidアプリを自動化するAppiumの使い方に関する速報書 - ニシャント・ヴェルマ．

<a id="test-frameworks"></a>
## テストフレームワーク
- [Appium Cucumber Test](https://github.com/priyankshah217/AppiumCucumberTest) - Appium Cucumberプロジェクトのサンプル．
- [Appium-Native-Crawler](https://github.com/isonic1/Appium-Native-Crawler) - AppiumネイティブクロールCLI - 特徴：スクリーンショット、パフォーマンス、アクセシビリティ検出、Google翻訳、Applitools、Monkey Testerを含む．
- [coteafs-appium](https://github.com/WasiqB/coteafs-appium) - Android、iOSおよびWindowsの実機またはエミュレーター用のウェブおよびネイティブアプリのテストをサポートする、Appiumに基づいたテストに優しいモバイルオートメーションフレームワーク．
- [Optimus](https://github.com/testvagrant/optimusTemplate) - キュウリベースのモバイル自動化フレームワークで、テストの並列実行をサポートしています。
- [PageObject Pattern Framework](https://github.com/saikrishna321/PageObjectPatternAppium) - 直接使用できるサンプルページオブジェクトパターンフレームワーク。
- [Parallel Framework Java-Client](https://github.com/saikrishna321/AppiumTestDistribution) - iOSおよびAndroidデバイスでAppiumテストを並列実行できます。
...
貢献を歓迎します。最初に[貢献ガイドライン](https://github.com/SrinivasanTarget/awesome-appium/blob/2ff155d5e6c23c145a1270f94cde49a82ffdddf9/contributing.md)を確認してください。
...
法律で認められる範囲において、[Srinivasan Sekar](https://github.com/SrinivasanTarget)はこの作品に関するすべての著作権および関連する権利を放棄しています。
