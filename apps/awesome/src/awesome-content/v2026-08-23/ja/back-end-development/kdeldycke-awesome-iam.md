---
title: "Awesome IAM"
description: "IAMを扱う資料や関連プロジェクトをまとめたAwesomeリストです。"
licenseSource: "github-kdeldycke-awesome-iam-readme-md"
---

# Awesome IAM

IAMを扱う資料や関連プロジェクトをまとめたAwesomeリストです。
...
- [`gman`](https://github.com/benbalter/gman) - 🆓 "指定されたメールアドレスまたはウェブサイトの所有者があらゆる政府機関（＝THE MAN）に勤務しているかどうかを確認するためのRubyのgem。" 自分のユーザーベースに潜在的な政府顧客を特定するための良いリソース。
