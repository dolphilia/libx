...
- [Amble](https://github.com/pygmy-twylyte/amble) - Parser (text adventure) game development platform (uses Pest both for parsing player input and for the DSL used in world creation).
...
- [pest_debugger](https://docs.rs/pest_debugger/latest/pest_debugger/) - It is a crate for debugging pest grammars. It can be used as a CLI tool or as a library. [See instructions for using the CLI debugger](https://github.com/pest-parser/awesome-pest/blob/eae74f52bc40d120c974590e33aa9fe61e7f7185/debugger.md).
