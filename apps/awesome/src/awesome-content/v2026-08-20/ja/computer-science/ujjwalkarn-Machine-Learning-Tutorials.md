...
- [線形回帰](#linear)
- [ロジスティック回帰](#logistic)
- [リサンプリングによるモデル検証](#validation)
    - [交差検証](#cross)
    - [ブートストラップ](#boot)
- [深層学習](#deep)
    - [フレームワーク](#frame)
    - [フィードフォワードネットワーク](#feed)
    - [再帰型ニューラルネットワーク、LSTM、GRU](#rnn)
    - [制限ボルツマンマシン、DBN](#rbm)
    - [オートエンコーダー](#auto)
    - [畳み込みニューラルネットワーク](#cnn)
    - [グラフ表現学習](#nrl)
...
- [Stat Trek Website](http://stattrek.com/) - 統計学を学ぶための専門サイト

- [Learn Statistics Using Python](https://github.com/rouseguy/intro2stats) - アプリケーション中心のプログラミングアプローチで統計学を学ぶ

- [Statistics for Hackers | Slides | @jakevdp](https://speakerdeck.com/jakevdp/statistics-for-hackers) - ジャック・ヴァンデルプラスのスライド

- [Online Statistics Book](http://onlinestatbook.com/2/index.html) - Studying Statistics向けのAn Interactive Multimedia Course。
...
- [OpenIntro Statistics](https://www.openintro.org/stat/textbook.php?stat_book=os) - 無料PDFテキストブック

<a name="blogs" />

## 有用なブログ

- [Edwin Chen's Blog](http://blog.echen.me/) - 数学、統計、機械学習、コアスローリング、データサイエンスに関するブログ

- [The Data School Blog](http://www.dataschool.io/) - beginners!向けのData science。

- [ML Wave](http://mlwave.com/) - Learning Machine Learning向けのA blog。

- [Andrej Karpathy](http://karpathy.github.io/) - ディープラーニングおよびデータサイエンスに関する一般のブログ

- [Colah's Blog](http://colah.github.io/) - 素晴らしいニューラルネットワークブログ

- [Alex Minnaar's Blog](http://alexminnaar.com/) - 機械学習とソフトウェアエンジニアリングに関するブログ

- [Statistically Significant](http://andland.github.io/) - アンドリュー・ランドグラフのデータサイエンスブログ

- [Simply Statistics](http://simplystatistics.org/) - 3人の生物統計学教授によるブログ

- [Yanir Seroussi's Blog](https://yanirseroussi.com/) - データサイエンスに関するブログ・その先まで

- [fastML](http://fastml.com/) - 機械学習をわかりやすく

- [Trevor Stephens Blog](http://trevorstephens.com/) - トレバー・ステップスの個人ページ

- [no free hunch | kaggle](http://blog.kaggle.com/) - kaggleのデータサイエンスに関するすべての話題を扱うブログ

- [A Quantitative Journey | outlace](http://outlace.com/) - 定量的応用を学ぶ

- [r4stats](http://r4stats.com/) - データサイエンスの世界を分析し、Rを使って学ぶ人々を支援する

- [Variance Explained](http://varianceexplained.org/) - デイビッド・ロビンソンのブログ

- [AI Junkie](http://www.ai-junkie.com/) - 人工知能についてのブログ

- [Deep Learning Blog by Tim Dettmers](http://timdettmers.com/) - 深層学習を誰でも理解できるようにする

- [J Alammar's Blog](http://jalammar.github.io/)- Blog posts about Machine Learning and Neural Nets

- [Adam Geitgey](https://medium.com/@ageitgey/machine-learning-is-fun-80ea3ec3c471#.f7vwrtfne) - 機械学習への最も簡単な入り口

- [Ethen's Notebook Collection](https://github.com/ethen8181/machine-learning) - 常に更新される機械学習ドキュメンテーション（主にPython3）。内容には、機械学習アルゴリズムのゼロから実装された教育的な実装とオープンソースライブラリの使用が含まれる
...
- [交差検証](https://en.wikipedia.org/wiki/Cross-validation_(statistics))
...
- [ブートストラップ](https://en.wikipedia.org/wiki/Bootstrapping_(statistics))
...
- オートエンコーダー: 教師なし学習（target = inputに設定してから誤差逆伝播を適用）
...
- [Discover structure behind data with decision trees](http://vooban.com/en/tips-articles-geek-stuff/discover-structure-behind-data-with-decision-trees/) - 決定木を学ぶための資料。
