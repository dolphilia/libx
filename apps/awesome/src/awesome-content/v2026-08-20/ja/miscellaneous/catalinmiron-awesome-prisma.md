...
- [:tipping_hand_woman: このリストについて](#tipping_hand_woman-about-this-list)
- [:books: ドキュメント](#books-docs)
- [:studio_microphone: イベント](#studio_microphone-events)
- [:safety_vest: コミュニティ Prisma ツール](#safety_vest-community-prisma-tools)
- [:thinking: ハウツー](#thinking-how-tos)
- [:bird: Twitter](#bird-twitter)
- [:trophy: チュートリアル](#trophy-tutorials)
- [:family_man_woman_girl_boy: コミュニティ](#family_man_woman_girl_boy-community)
- [:space_invader: Prisma を使うプロジェクト](#space_invader-projects-using-prisma)
- [Prisma 1](#prisma-1)

## :tipping_hand_woman: このリストについて

これは [Prisma](https://www.prisma.io/ 'Modern Database Access for TypeScript & Node.js') に関する**優れたリソース**のコレクションです :heart_eyes:

**Prisma はオープンソース ORM です**。TypeScript・Node.js 向けの型安全性と自動生成クエリビルダーにより、データベースアクセスを容易にします。
...
### :man_technologist: Prisma クライアント
...
- [Prismaliser - Prisma スキーマモデル・関係を可視化](https://prismaliser.app/)
- [Archibase - Prisma SDL に基づく共同スキーマエディター](https://archibase.dev/)
- [Prisma Editor - Prisma Schema を可視化・編集する強力なツール](https://github.com/mohammed-bahumaish/prisma-editor)
- [`prisma-markdown` - ERD・説明を含む Markdown 生成器](https://github.com/samchon/prisma-markdown)
- [Hubql - Prisma スキーマ対応の可視化プラットフォーム](https://www.hubql.com/prisma)
...
### [Nexus](https://www.nexusjs.org/#/) を使うチュートリアル
...
## :space_invader: Prisma を使うプロジェクト
...
- [NestJS Crud Prisma](https://github.com/silicon-hills/nestjs-crud-prisma) - NestJS・Prisma で構築した RESTful API 向け CRUD（[NestJSX CRUD](https://github.com/nestjsx/crud) を使用）。
- [tRPC Prisma Starter](https://github.com/trpc/examples-next-prisma-starter) - [tRPC](https://trpc.io) を使う、Prisma + Next.js + CI + テスト + E2E 型安全性を備えたスタータープロジェクト。
- [prisma-next-auth-graphql-starter](https://github.com/wangel13/prisma-next-auth-graphql-starter) - Prisma、next-auth、next.js、tailwindcss、graphql-shield を使うフルスタックスターター。
- [Wasp](https://github.com/wasp-lang/wasp) Wasp は、少ないコードでモダン JavaScript フルスタック Web アプリを開発、ビルド、デプロイするための宣言的ドメイン固有言語。
- [Neighborhood Pet Manager](https://github.com/AustinGil/npm)
- [Dotfyle](https://dotfyle.com) - Neovim プラグインを発見・共有する。

## Prisma 1

これは awesome Prisma の第 2 版であり、Prisma 2 に焦点を当てています。
[Awesome Prisma 1 リスト](https://github.com/catalinmiron/awesome-prisma/blob/5f22ba2cd0d56145fe4278b2d8b36f17d64a16c8/awesome-prisma1.md)を確認してください。

## 貢献

貢献を歓迎します。まず[貢献ガイドライン](https://github.com/catalinmiron/awesome-prisma/blob/5f22ba2cd0d56145fe4278b2d8b36f17d64a16c8/contributing.md)を読んでください。

## ライセンス

[![CC0](http://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](http://creativecommons.org/publicdomain/zero/1.0)

法律の許す限り、Catalin Miron はこの作品に関するすべての著作権および関連する権利・隣接権を放棄しています。
