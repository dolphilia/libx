...
description: "Crypto Currency Tools & Algorithmsを扱う資料や関連プロジェクトをまとめたAwesomeリストです。"
licenseSource: "github-Zheaoli-awesome-coins-readme-md"
---

# Awesome Crypto Currency Tools & Algorithms

Crypto Currency Tools & Algorithmsを扱う資料や関連プロジェクトをまとめたAwesomeリストです。

## 始める前に…

アルゴリズムやデータ構造に馴染みがない場合、この「コイン」の話は分かりにくいかもしれません。ここまでに分かっていることを説明します。

多くの[コイン](http://coinbin.org/coins)が存在します。人々は株式やポケモンカードのようにそれらを[取引](https://www.cryptopia.co.nz/Register?referrer=kennethreitz)し、家庭用コンピューターや専用ハードウェアで[採掘](https://www.nicehash.com/?refby=386829)もします。

コインは、オンライン、自分のローカルコンピューター、または紙に保存できるウォレットに格納されます。
...
- **[Coinbin.org](http://coinbin.org)** — コインデータ（為替レート、予測など）をすばやく取得する、人に優しいAPI。
...
- [CoinMarketCap](https://coinmarketcap.com) — すべての通貨をリアルタイムダッシュボードに表示する。
- ~~[CoinScanner.co](https://coinscanner.co/) — Gives you multiple trade routes from 1 crypto to another.~~
- [The Coin Perspective](https://thecoinperspective.com) — 時価総額、供給量、価格を比較し、異なるコインを理解する助けとなる。

## ☤ 読み物

- [Overview of Cryptocurrencies](https://github.com/kilimchoi/cryptocurrency) — GitHub Repo.
- [Map of Coins](http://mapofcoins.com) – ホワイトペーパーから現在までの暗号通貨の歴史を視覚的に探索する。
...
- [Binance Academy](https://www.binance.vision) — Binanceが提供するオープンアクセス教育。
- [Bitcoin Developer Reference](https://bitcoin.org/en/developer-reference)
- [Blockchain for humans](https://github.com/anderson-joyle/blockchain-for-humans) — 非常に簡略化したブロックチェーン解説（作成中）。
...
これは[WhatToMine](https://whattomine.com)のリストです。
...
- [NiceHash](https://www.nicehash.com/?refby=386829) — 一般的なアルゴリズムをすべてサポートし、処理能力に対して**BTC**で支払う。
...
**注意:** コインコミュニティは、これらのサービスの利用を好ましく見ません。コインを直接管理できず、実際には所有しているのは利用者ではなくサービスであり、通常の銀行の仕組みに似ているためです。
...
## ☤ [NiceHash Stratum Proxy](https://www.nicehash.com/?refby=386829)がサポートするアルゴリズム
