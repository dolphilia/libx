...
- [Help SAP Commerce](https://help.sap.com/docs/SAP_COMMERCE?locale=en-US) - 公式SAP Commerceドキュメントを提供する。
- [Community SAP Commerce Cloud](https://pages.community.sap.com/topics/commerce-cloud) - SAP Commerceに関する注目コンテンツ。
- [SAP Commerce Terminology](https://help.sap.com/docs/SAP_COMMERCE_CLOUD_PUBLIC_CLOUD/12be4ac419604b01aabb1adeb2c4c8a2/8bc7d09486691014ac87950f99acad26.html?locale=en-US) - SAP Commerce Cloudドキュメントで使われる用語を理解する。
- [Learning SAP Commerce Cloud](https://learning.sap.com/learning-journeys/explore-the-technical-essentials-of-sap-commerce-cloud) - SAP Commerceの技術的基礎を提供する。
- [Learning Journeys](https://help.sap.com/learning-journeys/overview?search=sap%20commerce) - SAP Commerce開発者ロール向けの学習ジャーニーを提供する。 
- [SAP Learning Hub](https://learninghub.sap.com/) - サブスクリプションが必要な技術動画・記事。 
- [SAP Store](https://store.sap.com/dcp/en/search?query=:relevance:worksWith:SAP%20Commerce:worksWith:SAP%20Commerce%20Cloud:solutionTypes:Extensions%20and%20Add-ons&GStoken=r1ke) - SAP Commerce向けの関連拡張機能・アドオン。いくつかは詳細に試せる無料トライアルを提供する。
- [Support SAP Commerce](https://support.sap.com/en/product/support-by-product/67837800100800007216.html) - 専門サービスチームからサポートを受ける。
- [SAP Commerce Newsletter](https://www.sap.com/cmp/nl/cx-commerce-cloud-news/index.html) - 毎月のニュースを直接受信トレイへ配信するニュースレター。

_このWebサイトにはSAP Commerceのzipファイルがあり、毎年新しい[バージョン](https://help.sap.com/docs/SAP_COMMERCE/c5613bd3cc9942efb74d017b40eb0892/1c6c687ad0ed4964bb43d409818d23a2.html)がリリースされる。ダウンロード前に、顧客がどのバージョンを使っているかを知ることが重要。_

- [Download SAP Commerce](https://launchpad.support.sap.com/#/softwarecenter/search/SAP%2520Commerce%2520Cloud%2520V2) - S-userによるログインが必要。
...
_これらは公式SAP開発者認定であり、開発者が最新状態を保つために不可欠で、SilverまたはGoldのSAP Partnerステータスを目指す雇用主にとっても価値がある。_
...
_有効な認定資格の詳細は[SAP Training](https://training.sap.com/certification/validity)を参照。_

- [SAP Certification Hub](https://sapcertification.questionmark.com/700161/ext/CertificationHub/)

### SAPブログ記事

_SAP Commerceに関する技術記事。_
...
_SAP Commerceに関する多くの質問がStack Overflowで回答されている。_
...
_知識を共有したい多くの経験者がSAP Commerceについて執筆している。_
...
_最新公開動画を基準に整理された技術チャンネル。_

- [Chenna RRRS](https://www.youtube.com/@chennarrrs3886) - SAP Commerce専用チャンネル。
- [Nitin Kumar](https://www.youtube.com/@NitinKumarHybris) - チュートリアルでSAP Commerceの基礎を解説する。
- [Yours Tanmay](https://www.youtube.com/@YoursTanmay) - 実践的なSAP Commerce・Springのガイドと手順を提供する。
- [Dasdilko](https://www.youtube.com/@dasdilko) - Hybrisを説明するために自主的に作成された動画。
...
_SAP Commerce開発者の作業を容易にするツール。_

- [Developers Toolset](https://plugins.jetbrains.com/plugin/12867-sap-commerce-developers-toolset) - SAP Commerce用IntelliJプラグイン。
- [JRebel](https://www.jrebel.com/blog/sap-hybris) - ビルド時間を大幅に短縮する。
...
_SAPがサポートする公式リポジトリ。_

- [SAP Machine Java](https://github.com/SAP/SapMachine) - SAP Commerce専用のJavaバージョン。
- [SAP Commerce Gradle Plugin](https://github.com/SAP/commerce-gradle-plugin) - SAP Commerceフォルダー構造をサポートするGradleプラグイン。
- [SAP Spartacus](https://github.com/SAP/spartacus) - SAP Composable Storefrontへ改称。 
...
_Apache Antは標準のコードビルド・ソース管理ツール。_

- [Apache Ant](https://ant.apache.org/) - Official Ant web site.

### Groovy

_Apache Groovyはスクリプトを実行できる関数型プログラミング言語。_

- [Tutorials Point](https://www.tutorialspoint.com/groovy/groovy_basic_syntax.htm) - 基本構文を理解するためのGroovyチュートリアル。

### Solr

_Apache Solrは標準の検索エンジン。_
...
_SpartacusはJSP Storefrontを置き換えた、SAP Commerce Cloud向けの軽量なAngularベースJavaScriptストアフロント。近年、SAP Composable Storefrontへ改称された。_
...
- [Erkin Erol](https://www.erkinerol.com/hybris-solr-ince-ayarlari/) - Eコマース専門家による個人ブログ。
- [Haratres Teknoloji](https://www.youtube.com/@haratresteknoloji/playlists) - Hybris 101のYouTube動画。
- [Ugur Halil Blog](https://ugurhalil.com/hybris-nedir-ve-nasil-kurulur/) - Hybris開発者によるブログ。
...
[CONTRIBUTING](https://github.com/eminyagiz42/awesome-sap-commerce/blob/main/CONTRIBUTING.md)ガイドラインと[検証ツール](https://github.com/sindresorhus/awesome-lint)を確認してください。
