...
### 🎵 音声 (39) <a id="audio"></a>
- [[Un]MuteMic](https://github.com/CocoaHeadsBrasil/MuteUnmuteMic) - マイクロフォンの入力音量をミュート・アンミュートできるmacOSアプリ。ポッドキャスト制作に最適です。
...
- [Audacity](https://github.com/audacity/audacity) - 無料、オープンソース、マルチプラットフォーム対応のオーディオソフトウェア

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://www.audacityteam.org/](https://www.audacityteam.org/)
...
- [AUHost](https://github.com/vgorloff/AUHost) - AVFoundation APIを使用してAudioUnits v3をホストするアプリケーション。
...
- [Aural Player](https://github.com/kartik-venugopal/aural-player) - Aural PlayerはmacOS用のオーディオプレイヤーで、Windows用のクラシックWinampにインスパイアされたもので、シンプルかつ使いやすい設計です。
  ...
  *（リポジトリには他に5件のスクリーンショットがあります）*

  </p>
  </details>

- [AutoMute](https://github.com/yonilevy/automute) - ヘッドフォンが抜かれたときやMacが睡眠から覚醒したときに自動的に音をミュートします。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://yoni.ninja/automute/](https://yoni.ninja/automute/)
...
- [Background Music](https://github.com/kyleneideck/BackgroundMusic) - Background MusicはmacOS用のオーディオツール。音楽を自動的に一時停止し、各アプリケーションの音量を設定し、システム音声を録音できます。
...
- [BlackHole](https://github.com/ExistentialAudio/BlackHole) - BlackHoleは、macOS用の現代的な仮想オーディオドライバーで、アプリケーション間でオーディオを0の遅延で転送できます。

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [CAM](https://github.com/hanayik/CAM) - ffmpegを使用したmacOSでのカメラ録画
  ...
  *（リポジトリには他に1件のスクリーンショットがあります）*

  </p>
  </details>

- [Clementine](https://github.com/clementine-player/Clementine) - ClementineはWindows、Linux、macOS向けの現代的な音楽プレイヤーおよびライブラリ管理ツール。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://www.clementine-player.org/](https://www.clementine-player.org/)
...
- [Cog](https://bitbucket.org/losnoco/cog/src) - CogはmacOS向けのオープンソースオーディオプレイヤー。基本的なレイアウトは、単一のパネルのプレイリストインターフェースで、ユーザーの音楽フォルダをナビゲートするための1つの引き出しと、ビットレートなどのオーディオファイルプロパティを確認するための別の引き出しを備えています。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://cogx.org/](https://cogx.org/)

- [eqMac2](https://github.com/bitgapp/eqMac) - Mac用のシステム全体のエイコール。
...
- [fre:ac](https://github.com/enzo1982/freac) - fre:acオーディオ変換プロジェクト。
...
- [iTunes-Volume-Control](https://github.com/alberti42/iTunes-Volume-Control) - このアプリは、ボリュームアップ・ダウンのショートカットキーを使ってiTunesの音量を制御できます。
...
- [jmc](https://github.com/jcm93/jmc) - jmcは新しいmacOS用メディア管理ツール。
...
- [Karaoke Forever](https://github.com/bhj/KaraokeEternal) - みんながスマホのブラウザから曲を並び、素晴らしいカラオケパーティを主催できるアプリ。MP3+GおよびMP4を再生し、WebGLによる視覚化を実現。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://www.karaoke-eternal.com/](https://www.karaoke-eternal.com/)
...
- [LocalRadio](https://github.com/dsward2/LocalRadio) - LocalRadioは、Macおよびモバイルデバイスで「ソフトウェア定義ラジオ」を聴くためのソフトウェアです。
...
- [LosslessCut](https://github.com/mifi/lossless-cut) - リエンコードなしで、損失なく動画・音声編集を行う万能ツール

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://mifi.no/losslesscut/](https://mifi.no/losslesscut/)
...
- [LyricGlow](https://github.com/ateymoori/lyricglow) - Spotify、Apple Music、YouTube Musicで同期された歌詞をアニメーション付きの文字ごとの光効果で表示するmacOSアプリ。
...
- [Lyricism](https://github.com/lyc2345/Lyricism) - 現在iTunesまたはSpotifyが再生中の歌詞を表示するmacOSアプリ。
...
- [LyricsX](https://github.com/ddddxxx/LyricsX) - iTunes、SpotifyおよびVoxの歌詞。
...
- [MonitorControl](https://github.com/MonitorControl/MonitorControl) - 外部モニタの明るさ、コントラスト、または音量を、メニュー項目またはキーボードのネイティブキーから直接制御
...
- [Mous Player](https://github.com/bsdelf/mous) - BSD／Linux／macOS向けシンプルで強力なオーディオプレイヤー。
  ...
  *（リポジトリには他に2件のスクリーンショットがあります）*

  </p>
  </details>

- [MPV](https://github.com/mpv-player/mpv) - 軽量で高度にカスタマイズ可能なメディアプレイヤー

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://mpv.io](https://mpv.io)
...
- [NoiseBuddy](https://github.com/insidegui/NoiseBuddy) - AirPods Proのリスニングモードを、TouchBarまたはメニューバーで制御

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [PlayStatus](https://github.com/nbolar/PlayStatus) - PlayStatusはmacOSアプリで、メニューバーからSpotifyおよびiTunesの音楽再生を制御できます
...
- [Plug](https://github.com/wulkano/Plug) - Hype Machineから音楽を発見して聴く

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.plugformac.com/](https://www.plugformac.com/)
...
- [Pulp](https://github.com/bazalp/pulp) - オーディオサンプルマネージャー。
...
- [Scope](https://github.com/billthefarmer/audiotools/tree/master/Scope/swift) - オーディオオシロスコープ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://billthefarmer.github.io/audiotools/](https://billthefarmer.github.io/audiotools/)
...
- [shairport-sync](https://github.com/mikebrady/shairport-sync) - macOS／Linux／FreeBSD／OpenBSD用のAirplayオーディオリスケーバー。

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [ShazamScrobbler](https://github.com/ShazamScrobbler/shazamscrobbler-macos) - レコード、ラジオ、映画をLast.fmにスコールできます。
...
- [Sonora](https://github.com/sonoramac/Sonora) - macOS向けミニマムで美しく設計された音楽プレイヤー。
...
- [Spotify4BigSur](https://github.com/fabiusBile/Spotify4BigSur) - 通知センター向けのSpotifyウィジェット。
...
- [SpotMenu](https://github.com/kmikiy/SpotMenu) - メニューバーにSpotifyおよびiTunesを表示。
...
- [SpotSpot](https://github.com/will-stone/SpotSpot) - macOS向けのSpotifyミニプレイヤー。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [StargateDAW](https://github.com/stargatedaw/stargate) - すべてを一括で提供するデジタルオーディオワークステーション（DAW）およびプラグインセット
  ...
  *（リポジトリには他に3件のスクリーンショットがあります）*

  </p>
  </details>

- [Suohai](https://github.com/Sunnyyoung/Suohai) - macOS向けのオーデ連入出力ソースロック。
...
- [Tickeys](https://github.com/yingDev/Tickeys) - タイプ時の即時オーディオフィードバック。macOS版。
...
- [Tuner](https://github.com/billthefarmer/ctuner) - 楽器チューンナー。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://billthefarmer.github.io/ctuner/ ](https://billthefarmer.github.io/ctuner/ )
...
- [waveSDR](https://github.com/getoffmyhack/waveSDR) - macOSネイティブのデスクトップソフト定義ラジオアプリケーション（RTL-SDR USBデバイスを使用）。
...
### 💾 バックアップ (6) <a id="backup"></a>
- [backy](https://github.com/vdbsh/backy) - ファイルバックアップ用の小さなマルチプロセスユーティリティ。

  **Languages:** <img src='./icons/golang-64.png' alt='Go icon' title='Go' height='16'/> Go 

- [BorgBase/Vorta](https://github.com/borgbase) - シンプルで安全なオフサイトバックアップ

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://www.borgbase.com/](https://www.borgbase.com/)

- [Mackup](https://github.com/lra/mackup) - アプリケーション設定を同期（macOS／Linux）します。

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [shallow-backup](https://github.com/alichtman/shallow-backup) - インストール済みアプリケーションやドットファイルなどについて、簡単に軽量なドキュメントを作成できます。
...
- [Syncalicious](https://github.com/zenangst/Syncalicious) - 複数のmacOSの設定を同期するのは大変ですが、それは当然ではありません。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [UrBackup](https://github.com/uroni/urbackup_backend) - UrBackupは、Windows、macOSおよびLinux向けのクライアント／サーバー型ネットワークバックアップです。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

### 🌐 ブラウザー (13) <a id="browser"></a>
- [Beaker Browser](https://github.com/beakerbrowser/beaker) - Beakerは実験的なピアツーピアWebブラウザです。
...
- [Brave Browser](https://github.com/brave/brave-browser) - Windows、macOS、Linuxで動作するデスクトップおよびラップトップ用のBraveブラウザ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [browserosaurus](https://github.com/will-stone/browserosaurus) - リンクを開くときにブラウザを選択するように促すmacOS用のツール。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Chromium](https://chromium.googlesource.com/chromium/src/) - Chromiumは、すべてのユーザーがより安全で、速く、安定したウェブ体験を実現することを目指すオープンソースブラウザプロジェクトです。
  ...
  **Webサイト:** [https://www.chromium.org/](https://www.chromium.org/)

- [Finicky](https://github.com/johnste/finicky) - 正しいブラウザが常に開かれます。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Firefox](https://hg.mozilla.org/mozilla-central/) - 非営利団体が開発した高速かつプライバシーに配慮したブラウザ。Windows、macOSおよびLinuxで動作。
  ...
  **Webサイト:** [https://www.mozilla.org/en-US/firefox/browsers/](https://www.mozilla.org/en-US/firefox/browsers/)

- [Helium](https://github.com/JadenGeller/Helium) - macOS用のフローティングブラウザウィンドウ。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Min Browser](https://github.com/minbrowser/min) - 高速かつ効率的な最小ブラウザ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://minbrowser.org](https://minbrowser.org)

- [otter-browser](https://github.com/OtterBrowser/otter-browser) - Otter Browserは、Qt5を用いて、クラシックなOpera（12.x）のUIの優れた点を再現することを目的としています。
...
- [Pennywise](https://github.com/kamranahmedse/pennywise) - Pennywiseは、任意のウェブサイトやメディアを小さなフロートウィンドウで開き、他のアプリの上に常に表示されます。Heliumの代替として非常に優れています。
...
- [Plash](https://github.com/sindresorhus/Plash) - 任意のウェブサイトをデスクトップ壁紙に設定。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://sindresorhus.com/plash](https://sindresorhus.com/plash)
...
- [Privacy Redirect for Safari](https://github.com/smmr-software/privacy-redirect-safari) - Twitter、YouTube、Reddit、Google Maps、Google Search、Google Translateをプライバシーに配慮した代替アプリにリダイレクト

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [seb-mac](https://github.com/SafeExamBrowser/seb-mac) - macOSおよびiOS向けの安全な試験ブラウザ。

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

### 💬 チャット (20) <a id="chat"></a>
- [Adium](https://github.com/adium/adium) - XMPP（Jabber）、IRCなどに接続できるインスタントメッセージングアプリケーション。

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://adium.im/](https://adium.im/)
...
- [Beagle IM](https://github.com/tigase/beagle-im) - ファイル転送、VoIP、端末間暗号化をサポートする強力なXMPPクライアント。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://beagle.im/](https://beagle.im/)
...
- [ChitChat](https://github.com/stonesam92/ChitChat) - WhatsApp Web用のネイティブMacアプリケーションのラッパー。
...
- [Electronic WeChat](https://github.com/geeeeeeeeek/electronic-wechat) - macOSおよびLinuxでのより良いWeChat
...
- [Element](https://github.com/vector-im/element-web) - Elementは、現在Electronを用いる、プロトコル向けの協働アプリです。 [Matrix](https://matrix.org/)

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Franz](https://github.com/meetfranz/franz) - WhatsApp、Slack、Messengerなど多くのサービスに対応するメッセージアプリケーション『Franz』
...
- [Google Allo for Desktop](https://github.com/kelyvin/Google-Allo-For-Desktop) - Google Allo用の本格的なmacOSおよびWindowsデスクトップアプリ
...
- [GroupMe](https://github.com/dcrousso/GroupMe) - 非公式なGroupMeアプリ
...
- [MessagesHistoryBrowser](https://github.com/glaurent/MessagesHistoryBrowser) - Messages.appの履歴を快適に閲覧・検索できるmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [RocketChat](https://github.com/RocketChat/Rocket.Chat.Electron) - チーム向けの無料オープンソースチャットシステム。Slackの代替として、自前でホストすることも可能

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://www.rocket.chat/](https://www.rocket.chat/)

- [Seaglass](https://github.com/neilalexander/seaglass) - macOS用の本格的なクライアントです。 [Matrix](https://matrix.org/blog/home/)
...
- [Signal Desktop](https://github.com/signalapp/Signal-Desktop) - AndroidまたはiOSのSignalアプリと連携するElectronアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Swiftcord](https://github.com/SwiftcordApp/Swiftcord) - SwiftとSwiftUIで構成された本格的なDiscordクライアント。RAMおよびCPUを軽量化
...
- [Telegram](https://github.com/overtake/TelegramSwift) - macOS用Telegramのソースコード（Swiftで記述）

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Telegram Desktop](https://github.com/telegramdesktop/tdesktop) - Telegramデスクトップメッセージアプリ
...
- [Textual](https://github.com/Codeux-Software/Textual) - macOS用のIRCクライアント『Textual』
...
- [Thunderbird](https://hg.mozilla.org/mozilla-central) - モzillaが支援するThunderbirdは、メール、ニュースフィード、チャット、カレンダーを扱う拡張可能なクライアントです。
  ...
  **Webサイト:** [https://www.thunderbird.net/en-US/](https://www.thunderbird.net/en-US/)
...
- [Torchat-Mac](https://github.com/javerous/TorChat-Mac) - TorChat for Macは、TorchatのmacOS本格版および非公式版

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [WhatsAppBar](https://github.com/aldychris/WhatsAppBar) - メニューバーからWhatsAppメッセージを送信
...
- [Wire Desktop](https://github.com/wireapp/wire-desktop) - チャットアプリWire用のスタンドアローンElectronアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

### 💰 暗号資産 (5) <a id="cryptocurrency"></a>
- [Bitcoin Core](https://github.com/bitcoin/bitcoin) - ビットコインノードを完全に実行するための公式ビットコインコアソフトウェア
  ...
  **Webサイト:** [https://bitcoincore.org/](https://bitcoincore.org/)
...
- [CoinBar](https://github.com/adamwaite/CoinBar) - 暗号通貨の価格を追跡するmacOSメニューバーアプリ
...
- [Copay](https://github.com/bitpay/copay) - デスクトップおよびモバイルデバイス向けの安全なビットコインウォレットプラットフォーム

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

- [Crypto Bar](https://github.com/geraldoramos/crypto-bar) - Electronで構成されたmacOSメニューバーアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Float coin](https://github.com/kaunteya/FloatCoin) - 浮遊ウィンドウをサポートし、多くの取引所に対応する本格的なメニューバーアプリ
...
### 🗄️ データベース (18) <a id="database"></a>
- [Bdash](https://github.com/bdash-app/bdash) - 軽量データ分析用のシンプルSQLクライアント
...
- [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) - SQLite、MySQL、MariaDB、Postgres、CockroachDB、SQL Server、Amazon Redshiftに対応したSQLエディタとマネージャー

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://www.beekeeperstudio.io](https://www.beekeeperstudio.io)
...
- [DB Browser for SQLite](https://github.com/sqlitebrowser/sqlitebrowser) - SQLiteデータベース管理用GUI
...
- [DBeaver](https://github.com/dbeaver/dbeaver) - ユニバーサルデータベースツールおよびSQLクライアント
...
- [DbGate](https://github.com/dbgate/dbgate) - MySQL、PostgreSQL、SQL Server、MongoDB、SQLiteなどに対応するデータベースマネージャー。Windows、Linux、Macでも動作し、Webアプリケーションとして利用可能
  ...
  **Webサイト:** [https://dbgate.org](https://dbgate.org)
  ...
  *（リポジトリには他に6件のスクリーンショットがあります）*

  </p>
  </details>

- [Medis](https://github.com/luin/medis) - 💻 Medisは、Redis用の美しい、使いやすいMacデータベース管理アプリケーション
...
- [mongoDB.app](https://github.com/gcollazo/mongodbapp) - MacでmongoDBを使うための最も簡単なスタート方法
...
- [MongoHub](https://github.com/jeromelebel/MongoHub-Mac) - 別の軽量Mac本体用MongoDBクライアントを追加

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [Postbird](https://github.com/Paxa/postbird) - macOS用のPostgreSQL GUIクライアント
...
- [Postgres.app](https://github.com/PostgresApp/PostgresApp) - MacでPostgreSQLを使うための最も簡単なスタート方法

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Redis Desktop Manager](https://github.com/uglide/RedisDesktopManager) - Redis ®に対応するマルチプラットフォームオープンソースデータベース管理ツール
...
- [redis-pro](https://github.com/cmushroom/redis-pro) - SwiftUIで構成されたRedis管理ツール
...
- [Redis.app](https://github.com/jpadilla/redisapp) - MacでRedisを使うための最も簡単なスタート方法
...
- [reventlou](https://github.com/b3z/reventlou) - 個人用データベースとしての情報管理システム
...
- [Robo 3T](https://github.com/Studio3T/robomongo) - Robo 3T（以前はRobomongo）は、MongoDB愛好家向けの無料軽量GUI
...
- [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) - Sequel Aceは、MySQLおよびMariaDBデータベースを扱うためのシンプルで使いやすいMacデータベース管理アプリケーション

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://sequel-ace.com/](https://sequel-ace.com/)

- [Sequel Pro](https://github.com/sequelpro/sequelpro) - macOS用のMySQL/MariaDBデータベース管理ツール
...
- [sqlectron](https://github.com/sqlectron/sqlectron-gui) - シンプルで軽量なSQLクライアント（デスクトップ／ターミナル）で、複数データベース・プラットフォームに対応。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://sqlectron.github.io/](https://sqlectron.github.io/)
...
### 👨‍💻 開発 (16) <a id="development"></a>
- [Apache Netbeans](https://github.com/apache/netbeans) - Apache NetBeansは、Java、JavaScript、PHP、HTML5、CSSなどでの開発に適したIDE、ツールプラットフォームおよびアプリケーションフレームワークです

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://netbeans.apache.org/](https://netbeans.apache.org/)
...
- [Brackets](https://github.com/brackets-cont/brackets) - HTML、CSS、JavaScriptで構築された現代的なオープンソースコードエディタです

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://brackets.io/](https://brackets.io/)
...
- [Clipboard](https://github.com/Slackadays/Clipboard) - すべてのターミナルで動作する、使いやすいクリップボードマネージャーで、時間短縮機能を備えている。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://GetClipboard.app](https://GetClipboard.app)
...
- [ColorSet](https://github.com/DigiDNA/ColorSet) - ColorSetは、開発者がカスタムインターフェースカラーを簡単に管理できるmacOS用のユーティリティおよびフレームワークです
  ...
  **Webサイト:** [https://imazing.com/colorset](https://imazing.com/colorset)
...
- [DevLint](https://github.com/csprasad/DevLint) - Swiftの文法をフォーマット・訂正するための軽量アプリ。
...
- [Eclipse](https://github.com/eclipse-platform/eclipse.platform) - Eclipseは、コンピュータプログラミングで使用されるオープンソース統合開発環境（IDE）で、ベースワークスペースとカスタマイズ可能な拡張プラグインシステムを備えています

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://www.eclipse.org](https://www.eclipse.org)

- [GitAhead](https://github.com/gitahead/gitahead/) - ソースコードの履歴を理解し、管理するためのグラフィカルなGitクライアド。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://gitahead.github.io/gitahead.com/](https://gitahead.github.io/gitahead.com/)

- [Gridfy](https://github.com/Slllava/gridfy) - 列の幅を迅速に計算し、グリッドに適切な結果を取得できます

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://gridfy.astroon.pro/](https://gridfy.astroon.pro/)
...
- [JustTags](https://github.com/kaphacius/just-tags) - BERTLV EMVタグの作業に使うmacOSアプリ「JustTags」。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://kaphacius.github.io/just-tags/](https://kaphacius.github.io/just-tags/)
...
- [KiCad](https://gitlab.com/kicad/code/kicad) - 電子設計自動化（EDA）用のソフトウェアセット。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://www.kicad.org/](https://www.kicad.org/)

- [Layout Designer for UICollectionView](https://github.com/amirdew/CollectionViewPagingLayout) - UICollectionViewの複雑なレイアウトを作成するためのシンプルで強力なツールです

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apps.apple.com/nl/app/layout-designer/id1507238011?l=en&mt=12](https://apps.apple.com/nl/app/layout-designer/id1507238011?l=en&mt=12)
...
- [LocationSimulator](https://github.com/Schlaubischlump/LocationSimulator) - iOSまたはiPhoneSimulatorの位置を偽装するアプリケーションです

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://schlaubischlump.github.io/LocationSimulator](https://schlaubischlump.github.io/LocationSimulator)
...
- [M-Courtyard](https://github.com/Mcourtyard/m-courtyard) - Apple Silicon MacでLLMをゼロコードで微調整できるデスクトップアプリ。ドキュメントをインポートし、AIでトレーニングデータセットを生成し、LoRAで微調整し、テストし、Ollamaにエクスポートする——すべてオフラインで完了。
  ...
  **Webサイト:** [https://github.com/Mcourtyard/m-courtyard](https://github.com/Mcourtyard/m-courtyard)
...
- [Pasteboard Viewer](https://github.com/sindresorhus/Pasteboard-Viewer) - システムのクリップボードを確認する。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://sindresorhus.com/pasteboard-viewer](https://sindresorhus.com/pasteboard-viewer)
...
- [Stringz](https://github.com/mohakapt/Stringz) - iOS、macOS、tvOS、watchOSアプリケーションのローカライズに最適な軽量かつ強力なエディタ
...
- [utmapp](https://github.com/utmapp/) - 他のオペレーティングシステムの仮想化。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://mac.getutm.app/](https://mac.getutm.app/)
...
#### 📦 Git (20) <a id="git"></a>
- [Cashew](https://github.com/dhennessy/OpenCashew) - カシューナッツ macOS GitHub インシデントトラッカー

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [Git Interactive Rebase Tool](https://github.com/MitMaro/git-interactive-rebase-tool) - インタラクティブリベースに必要な、完全機能のターミナルベースのシーケンスエディタ。

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://gitrebasetool.mitmaro.ca/](https://gitrebasetool.mitmaro.ca/)
...
- [GitBlamePR](https://github.com/maoyama/GitBlamePR) - ファイルの各行のプルリクエストの最終変更を表示するmacOSアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Gitee](https://github.com/Nightonke/Gitee) - Gitee、macOSステータスバーアプリケーション。
  ...
  *（リポジトリには他に11件のスクリーンショットがあります）*

  </p>
  </details>

- [Github contributions](https://github.com/remirobert/Github-contributions) - GitHubの貢献度を表示するiOS、WatchOS、macOS用アプリ。
...
- [GitHub Desktop](https://github.com/desktop/desktop) - デスクトップから簡単な協働を実現します
...
- [GithubListener](https://github.com/ad/GithubListener) - 監視しているリポジトリへの新しいコミットについて通知するシンプルなアプリ
...
- [GithubNotify](https://github.com/erik/github-notify) - 未読のGitHub通知があるときにアラートを表示するシンプルなmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Gitify](https://github.com/manosim/gitify) - メニューバーにGitHubの通知を表示します

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://www.gitify.io/](https://www.gitify.io/)
...
- [GitSync](https://github.com/eonist/GitSync) - macOS用のシンプルなGitクライアント
...
- [GitUp](https://github.com/git-up/GitUp) - あなたが一生ずっと見失っていたGitインターフェースがついに登場しました
...
- [GitX](https://github.com/gitx/gitx) - Gitのバージョン管理システム用のグラフィカルクライアント

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [GPM](https://github.com/mtgto/GPM) - GitHubプロジェクトを簡単に操作できるmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [osagitfilter](https://github.com/doekman/osagitfilter) - OSA言語（AppleScript、JavaScript）をGitにフィルタし、テキストファイルのように扱う機能

  **Languages:** <img src='./icons/shell-64.png' alt='Shell icon' title='Shell' height='16'/> Shell <code>applescript</code> 

- [Streaker](https://github.com/jamieweavis/streaker) - GitHubの貢献連続性を追跡するメニューバー用アプリ
...
- [TeamStatus-for-GitHub](https://github.com/marcinreliga/TeamStatus-for-GitHub) - チーム内のコードレビュープロセスを追跡するmacOSステータスバーアプリ
...
- [Tempo](https://github.com/maoyama/Tempo) - Git CLIを明確なUIとAI支援で置き換える
...
- [Trailer](https://github.com/ptsochantaris/trailer) - GitHubおよびGitHub Enterpriseでのプルリクエストとイシューの管理
...
- [Xit](https://github.com/Uncommon/Xit) - Gitリポジトリを操作するためのグラフィカルツール
...
#### 🔄 JSONパース (4) <a id="json-parsing"></a>
- [j2s](https://github.com/zadr/j2s) - macOSアプリでJSONオブジェクトをSwift構造体に変換（現在はSwift 4およびCodableに対応）。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [JSON Mapper](https://github.com/AppCraft-LLC/json-mapper) - JSONからSwift Object Mapperクラスを生成するシンプルなmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [JSON to Model class](https://github.com/chanonly123/Json-Model-Generator) - テンプレートベースで高度にカスタマイズ可能なmacOSアプリ。JSON文字列からクラスを生成し、多数の言語をサポート。
...
- [JSONExport](https://github.com/Ahmed-Ali/JSONExport) - macOS用のデスクトップアプリで、JSONオブジェクトを、あなたの好きな言語に紐づけたモデルクラス、コンストラクタ、ユーティリティメソッド、セッター、ゲッターとしてエクスポートできます
...
#### 🔧 その他の開発 (5) <a id="other-development"></a>
- [Boop](https://github.com/IvanMathy/Boop) - 開発者向けのスクリプト可能なスクラッチパッド
  ...
  **Webサイト:** [https://boop.okat.best](https://boop.okat.best)
...
- [ChefInspector](https://github.com/Yasumoto/ChefInspector) - Chef用のノードと属性閲覧ツール
...
- [macho-browser](https://github.com/dcsch/macho-browser) - macOS用のMach-Oバイナリをブラウザで表示

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [MQTTX](https://github.com/emqx/MQTTX) - エレガントなクロスプラットフォームMQTT 5.0デスクトップクライアント
...
- [vegvisir](https://github.com/ant4g0nist/vegvisir) - **LLDB**デバッガのブラウザベースGUI
...
#### 🌍 Web開発 (14) <a id="web-development"></a>
- [aws-s3-uploader](https://github.com/RafalWilinski/s3-uploader) - Amazon Web Servicesへのファイルアップロード用のシンプルなmacOSアプリ
...
- [Corectl App for macOS](https://github.com/TheNewNormal/corectl.app) - Corectl Appは、corectldコマンドラインツールをラッパーとして動作するmacOSステータスバーアプリで、サーバー実行プロセスを制御します
...
- [CoreOS VM](https://github.com/TheNewNormal/coreos-osx) - CoreOS VMは、Mac上でCoreOS VMを簡単に制御できるmacOSステータスバーアプリです
...
- [HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) - HTTP Toolkitは、HTTPをインターセプト・デバッグ・モックするクロスプラットフォームツール

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://httptoolkit.com/](https://httptoolkit.com/)
...
- [Insomnia](https://github.com/Kong/insomnia) - InsomniaはElectronに基づいたクロスプラットフォームRESTクライアント
...
- [iTunesConnect](https://github.com/trulyronak/itunesconnect) - iTunesConnectへのアクセスを可能にするmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [KubeMonitor](https://github.com/Daniel-Sanche/KubeMonitor) - KubeMonitorは、メニューバーにあなたのアクティブなKubernetesクラスタの情報を表示するmacOSアプリです
...
- [KubeSwitch](https://github.com/nsriram/KubeSwitch) - KubeSwitchは、MacのメニューバーにKubernetesクラスタコンテキストのリストを表示します
...
- [Lantern](https://github.com/RoyalIcing/Lantern) - ウェブサイトのアудィットおよびクロールに特化したmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [LocalSites](https://github.com/plan44/localSites) - macOS用のシンプルなメニューバー（ステータスバー）アプリで、ローカルのBonjourウェブサイトをリスト表示（Safari 11以降ではBonjourブックマークが削除されたため）。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [nodeScratchpad](https://github.com/vsaravind007/nodeScratchpad) - メニューバーからNode.js/JSコードスニペットを評価します

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Requestly](https://github.com/requestly/requestly) - 軽量なオープンソースAPI開発・テスト・モックプラットフォーム

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://requestly.com](https://requestly.com)
...
- [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) - ソフトウェアプロジェクトにおけるi18nキーを管理するオープンソースツール

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://simplelocalize.io](https://simplelocalize.io)

- [stts](https://github.com/inket/stts) - クラウドサービスのステータスをモニタリングするmacOSアプリ
...
#### 📱 iOS／macOS (44) <a id="ios--macos"></a>
- [AppBox](https://github.com/getappbox/AppBox-iOSAppsWirelessInstallation) - iOS開発者向けに、Dropboxアカウントからデバイスに開発・アドホック・インハウス（エンタープライズ）アプリを構築・デプロイできるツール
...
- [AppIcons](https://github.com/kuyawa/AppIcons) - macOSおよびiOSアプリが要するすべてのサイズのアイコンを生成するツール
...
- [AppStoreReviewTimes](https://github.com/arbel03/AppStoreReviewTimes) - iOS / macOSアプリストアのレビュー期間の平均値を示すツール
...
- [Asset Catalog Tinkerer](https://github.com/insidegui/AssetCatalogTinkerer) - .carファイルを開き、その中身の画像をブラウズ・抽出できるアプリ
...
- [Assets](https://github.com/e7711bbear/Assets) - Assetsは、開発プロジェクト（Xcode、ウェブなど）のアセットを管理するmacOSアプリです

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Attabench](https://github.com/attaswift/Attabench) - Attabenchは、Swiftコードのパフォーマンスを測定・可視化するmac及のマイクロベンチマークアプリです
...
- [AVXCAssets Generator](https://github.com/angelvasa/AVXCAssets-Generator) - あなたの資産画像のパスを指定して、ワンクリックでアプリアイコンセットとイメージセットを作成します

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Board For GitHub](https://github.com/JustinFincher/BoardForGitHub) - GitHubプロジェクトのウェブページをナチュラルなmacOSアプリで監視する小さなアプリ :octocat:!
...
- [Brisk](https://github.com/br1sk/brisk) - レーダーを提出するためのmacOSアプリ
...
- [calabash-launcher](https://github.com/xing/calabash-launcher) - iOS Calabash Launcherは、Mac上でCalab及テストを実行・管理できるmacOSアプリです
...
- [Cleaner for Xcode](https://github.com/waylybaye/XcodeCleaner) - React Native macOSで構築されたXcode.appのクリーンアップツール

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Clendar](https://github.com/vinhnx/Clendar) - Clendarはスウィフティで書かれたユニバーサルカレンダーアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apps.apple.com/us/app/clendar-a-calendar-app/id1548102041](https://apps.apple.com/us/app/clendar-a-calendar-app/id1548102041)
...
- [CocoaRestClient](https://github.com/mmattozzi/cocoa-rest-client) - HTTP/RESTエンドポイントのテスト用のネイティブApple macOSアプリ
...
- [Corona Tracker](https://github.com/MhdHejazi/CoronaTracker) - iOSおよびmacOS向けのコロナウイルストラッカーアプリ（地図とチャート付き）

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://coronatracker.samabox.com/](https://coronatracker.samabox.com/)
...
- [FilterShop](https://github.com/KrisYu/FilterShop) - CoreImageフィルタを探索するmacOSアプリ
...
- [IconGenerator](https://github.com/onmyway133/IconGenerator) - アプリアイコンを生成するmacOSアプリ
...
- [Iconizer](https://github.com/raphaelhanneken/iconizer) - 即座にXcodeのイメージカタログ（xcassets）を作成します
...
- [Iconology](https://github.com/liamrosenfeld/Iconology) - アイコンを編集し、Xcode、icns、ico、favicon、macOSアイコンセット、またはカスタムコレクションにエクスポート

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apps.apple.com/us/app/iconology/id1463452867](https://apps.apple.com/us/app/iconology/id1463452867)
...
- [Icons.app](https://github.com/SAP/macos-icon-generator) - 既存アプリのさまざまな状態（揺れなど）で一貫したサイズのアイコンを生成するmacOSアプリ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [InjectionIII](https://github.com/johnno1962/InjectionIII) - Injectionの遅延Swiftリライト

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Input Source Pro](https://github.com/runjuu/InputSourcePro/) - マルチ言語ユーザー向けに、入力ソースを頻繁に切り替えるために設計されたmacOSユーティリティです

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://inputsource.pro](https://inputsource.pro)

- [iOS Images Extractor](https://github.com/devcxm/iOS-Images-Extractor) - iOSアプリから画像を正規化・解読・抽出するMacアプリiOS Images Extractor
...
- [iSimulator](https://github.com/wigl/iSimulator) - シミュレーターを制御し、シミュレーターにインストールされたアプリを管理するGUIユーティリティiSimulator
...
- [LayerX](https://github.com/yuhua-chen/LayerX) - 画面に透過画像を表示する直感的なアプリ
...
- [Localizable.strings](https://github.com/cristibaluta/Localizable.strings) - MacアプリでiOSおよびmacOSプロジェクトのローカライズを実現します

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Localization Editor](https://github.com/igorkulman/iOSLocalizationEditor) - シンプルなmacOSエディタアプリで、iOSアプリのローカライズを一括編集できるように、すべての翻訳を並列で編集できます

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Localizations](https://github.com/e7711bbear/Localizations) - LocalizationsはmacOSアプリでXcodeプロジェクトのローカライズファイル（.strings）を管理します
...
- [Menubar Colors](https://github.com/nvzqz/Menubar-Colors) - macOSアプリでシステムカラーパネルに簡単にアクセスできます
...
- [Notarize](https://github.com/macmade/Notarize) - macOS用の署名確認ツール、複数開発者アカウントに対応
...
- [PodsUpdater](https://github.com/kizitonwose/PodsUpdater) - Podfileにおける依存関係リリースを管理するmacOSアプリ
...
- [ProfilesManager](https://github.com/shaojiankui/ProfilesManager) - Apple iOS/macOS Provisioning Profilesの管理ツール、.provisionprofile、.mobileprovisionファイル管理ツール
...
- [PushNotifications](https://github.com/onmyway133/PushNotifications) - iOSおよびAndroid向けのプッシュ通知をテストできるmacOSアプリ
...
- [ResignTool](https://github.com/InjoyDeng/ResignTool) - macOSアプリでアプリを（再）署名し、iOSデバイスにインストールできるIPAファイルにまとめるアプリ
...
- [Resizr](https://github.com/onurgenes/Resizr) - iOSおよびAndroidアプリ用のAppIconを作成するmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [SmartPush](https://github.com/shaojiankui/SmartPush) - iOSプッシュ通知デバッグアプリ
...
- [TransporterPad](https://github.com/iseebi/TransporterPad) - iOSおよびAndroidアプリのデプロイツール（macOS用）

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [WWDC](https://github.com/insidegui/WWDC) - macOS用の非公式WWDCアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [WWDC.srt](https://github.com/ssamadgh/WWDCsrt) - 2013年以降のWWDCセッション動画それぞれに、(srt)形式で字幕をダウンロードできる強力なアプリ。
...
### ⬇️ ダウンローダー (10) <a id="downloader"></a>
- [App Downloader](https://github.com/yep/app-downloader) - 大きなアプリカタログからmacOSアプリを簡単に検索・ダウンロードできるツール。 `homebrew cask`

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [App Fair](https://github.com/App-Fair/App) - Homebrew CaskおよびFairground AppカタログからmacOSアプリを検索・インストール。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://appfair.app](https://appfair.app)
...
- [Applite](https://github.com/milanvarady/Applite) - Homebrew Casks向けの使いやすいGUIアプリ。1クリックでアプリのインストール、更新、削除が可能です

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://aerolite.dev/applite](https://aerolite.dev/applite)
...
- [Extream Download Manager](https://github.com/subhra74/xdm) - ダウンロード速度を最大500％まで向上させる強力なツール。

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://subhra74.github.io/xdm/](https://subhra74.github.io/xdm/)

- [FileZilla](https://sourceforge.net/projects/filezilla/) - 無料のオープンソースFTP、FTPS、およびSFTPクライアント

  **Languages:** <code>c++</code> 

  **Webサイト:** [https://filezilla-project.org](https://filezilla-project.org)

- [Get It](https://github.com/Kevin-De-Koninck/Get-It) - 本家macOS用の動画・音声ダウンローダー。多くのサイトで動作するYouTubeダウンローダーのように思えます。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Motrix](https://github.com/agalwood/Motrix) - フル機能のダウンロードマネージャー。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://motrix.app/](https://motrix.app/)
...
- [Pillager](https://github.com/Pjirlip/Pillager) - SwiftとObjective-Cで書かれたmacOS用の動画ダウンローダー。
...
- [udemy-downloader-gui](https://github.com/FaisalUmair/udemy-downloader-gui) - Udemyコースをダウンロードするためのデスクトップアプリ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [YouTube Downloader for macOS](https://github.com/DenBeke/YouTube-Downloader-for-macOS) - MacでYouTubeの映画をダウンロードするためのシンプルなメニューバーアプリ。これは、macOS上のアプリ開発について学ぶためのテストプロジェクトとして書かれたものです。
...
### 📝 エディター (7) <a id="editors"></a>
- [AuroraEditor](https://github.com/AuroraEditor/AuroraEditor) - macOS用の軽量コードエディタ（IDE）です

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://auroraeditor.com](https://auroraeditor.com)
...
- [Chime](https://github.com/ChimeHQ/Chime) - macOS用のエディタ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.chimehq.com/](https://www.chimehq.com/)
...
- [CodeEdit](https://github.com/CodeEditApp/CodeEdit) - CodeEdit App for macOS – エディタ体験を向上させるオープンソース・無料アプリです

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.codeedit.app/](https://www.codeedit.app/)
...
- [Geany](https://github.com/geany/geany) - Geanyは、強力で安定し、軽量なプログラマー向けテキストエディタで、ワークフローを妨げずに多くの便利な機能を提供します

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <code>c++</code> 

  **Webサイト:** [https://www.geany.org/](https://www.geany.org/)
...
- [mxMarkEdit](https://github.com/maxnd/mxMarkEdit) - マーカードドキュメント、タスク、テーブルの視覚的なエディタ

  **Languages:** <code>free-pascal</code> 

  **Webサイト:** [https://github.com/maxnd/mxMarkEdit](https://github.com/maxnd/mxMarkEdit)
...
- [Zed](https://github.com/zed-industries/zed) - Zedは、オープンソースであり、高性能かつマルチプレイヤー対応のコードエディタ

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://zed.dev](https://zed.dev)

#### 📊 CSV (1) <a id="csv"></a>
- [TableTool](https://github.com/jakob/TableTool) - macOS用のシンプルなCSVエディタ。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://apps.apple.com/app/table-tool/id1122008420](https://apps.apple.com/app/table-tool/id1122008420)

#### 📋 JSON (2) <a id="json"></a>
- [JSON Editor](https://github.com/fand/json-editor-app) - josdejong/jsoneditorを使用したシンプルなJSONエディタ。
...
- [JSON-Splora](https://github.com/wellsjo/JSON-Splora) - JSONデータの編集、可視化、操作を行うためのGUI。
...
#### 📝 Markdown (11) <a id="markdown"></a>
- [Gingko](https://github.com/gingko/client) - macOS、Windows、Linux用のツリー構造のMarkdownエディタ。
...
- [linked](https://github.com/lostdesign/linked) - 🧾 あなたの毎日の日記アプリ、日記、あるいは心を整理するための何でもよい。リンク機能により、毎日頭の中にあることを書き出して、集中力を高める
  ...
  **Webサイト:** [https://uselinked.com](https://uselinked.com)
...
- [MacDown](https://github.com/MacDownApp/macdown) - macOS用のMarkdownエディ及。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Mark Text](https://github.com/marktext/marktext/) - macOS、Windows、Linux用のリアルタイムプレビューMarkdownエディタ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [MarkEdit](https://github.com/MarkEdit-app/MarkEdit) - MarkEditはmacOS用の無料かつオープンソースのMarkdownエディタです。MacのTextEditに似ていますが、Markdown専用です。
  ...
  **Webサイト:** [https://markedit.app/](https://markedit.app/)
...
- [Notenik](https://github.com/hbowie/notenik-swift) - 多くの組織化オプションを備えたノート作成アプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://notenik.app](https://notenik.app)
...
- [Obsidian plugins & themes](https://github.com/obsidianmd/obsidian-releases) - Obsidianのコミュニティプラグイン一覧、テーマ一覧、リリース情報

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://obsidian.md/](https://obsidian.md/)

- [Pine](https://github.com/lukakerr/Pine) - 現代的なmacOS用マーカードエディタ
...
- [QOwnNotes](https://github.com/pbek/QOwnNotes) - マークダウン対応で、OwnCloud／Nextcloudとの統合を可能にするシンプルなテキストファイルノートとタスク管理アプリ

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://www.qownnotes.org/](https://www.qownnotes.org/)
...
- [Zettlr](https://github.com/Zettlr/Zettlr) - 21世紀のマーカードエディタ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://www.zettlr.com/](https://www.zettlr.com/)
...
#### 📐 TeX (2) <a id="tex"></a>
- [BibDesk](https://sourceforge.net/projects/bibdesk/) - BibDeskを使って bibliographyの編集と管理を行う。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://bibdesk.sourceforge.io](https://bibdesk.sourceforge.io)
...
- [Qilin Editor](https://github.com/qilin-editor/qilin-app) - 正確科学に特化したテキストエディタ（内蔵KaTeX／AsciiMathサポート）
...
- [CotEditor](https://github.com/coteditor/CotEditor) - macOS用軽量シンプルテキストエディタ
...
- [MacVim](https://github.com/macvim-dev/macvim) - macOS用テキストエディタ

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [micro](https://github.com/zyedidia/micro) - ターミナルベースのテキストエディタで、使いやすさと直感性を重視しつつ、現代のターミナルの機能を活かす

  **Languages:** <img src='./icons/golang-64.png' alt='Go icon' title='Go' height='16'/> Go 

  **Webサイト:** [https://micro-editor.github.io](https://micro-editor.github.io)
...
- [Notesnook](https://github.com/streetwriters/notesnook) - Evernoteとの代替として、完全にオープンソースかつ端末間暗号化されたノート作成アプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://notesnook.com](https://notesnook.com)
...
- [Noto](https://github.com/brunophilipe/noto) - macOS用カスタマイズ可能なテーマを備えたシンプルテキストエディ及
...
- [SubEthaEdit](https://github.com/subethaedit/SubEthaEdit) - macOS用汎用シンプルテキストエディタ。ライブコラボレーション機能で広く知られている
...
- [TextMate](https://github.com/textmate/textmate) - macOS用グラフィカルテキストエディタ
...
- [Tincta](https://github.com/CodingFriends/Tincta) - シンタックスハイライト付きのワンウィンドウテキストエディタ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://codingfriends.github.io/Tincta/](https://codingfriends.github.io/Tincta/)

- [VimR](https://github.com/qvacua/vimr) - macOS用のNeovim体験を精緻化したエディタ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

### 🧩 拡張機能 (14) <a id="extensions"></a>
- [AdGuard for Safari](https://github.com/adguardteam/adguardforsafari) - Safari向け最も先進的なアドブロッキング拡張機能

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://adguard.com/en/welcome.html](https://adguard.com/en/welcome.html)
...
- [BetterPiP](https://github.com/Capevace/BetterPiP) - Google ChromeなどのブラウザでHTML5動画をNative Picture-in-Pictureで使用
...
- [Is It Private?](https://github.com/ffittschen/IsItPrivate) - プライベートブラウジングが有効になっている場合、ツールバーのアイコンの視覚的な表示を変更するSafari拡張機能

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://florian.codes/projects/is-it-private/](https://florian.codes/projects/is-it-private/)
...
- [Middleclick](https://github.com/artginzburg/MiddleClick-Ventura) - MacBookのトラックパッドやMagic Mouseで3本指でクリックまたはタップでスクロールホイールのクリックをシミュレート
...
- [nef](https://github.com/bow-swift/nef-plugin) - このXcode拡張機能により、コードの選択を実行し、スニペットとしてエクスポートできます。Mac AppStoreにて入手可能です。
  ...
  **Webサイト:** [https://nef.bow-swift.io/](https://nef.bow-swift.io/)
...
- [PageExtender](https://github.com/fphilipe/PageExtender.app) - 自作のCSSおよびJSファイルをページに追加
...
- [PiPifier](https://github.com/arnoappenzeller/PiPifier) - PiPifierは、macOS 10.12のSafariに内蔵された拡張機能で、すべてのHTML5動画をピクチャインピクチャモードで利用可能にします。
...
- [PiPTool](https://github.com/bfmatei/PiPTool) - macOSにおけるYouTube、Netflix、Plexなどの動画配信サービスにPicture-in-Picture機能を追加
...
- [Sessions](https://github.com/AlexPerathoner/Sessions) - Safari拡張機能で、あなたの作業セッションを保存します。
...
- [Swimat](https://github.com/Jintin/Swimat) - SwimatはSwiftコードのフォーマットを行うXcodeプラグインです。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://jintin.github.io/Swimat/](https://jintin.github.io/Swimat/)
...
- [ThenGenerator](https://github.com/87kangsw/ThenGenerator) - Xcodeのソースエディタ拡張機能「Then」
...
- [Ultra TabSaver](https://github.com/Swift-open-source/UltraTabSaver) - Safari用のオープンソースタブマネージャー「Ultra TabSaver」
...
- [Yape](https://github.com/leonspok/Yape) - もう一つのPiP拡張機能。ウェブページ上のすべてのHTML5動画を検出し、Safariのツールバーからピクチャーインピクチャーモードで再生できるようにする。
...
### 🔍 Finder (13) <a id="finder"></a>
- [cd to... ](https://github.com/jbtule/cdto) - Finderツールバーアプリで現在のディレクトリを開く

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Clipy](https://github.com/Clipy/Clipy) - ClipyはmacOS向けのクリップボード拡張アプリです。
...
- [CopyQ](https://github.com/hluk/CopyQ) - 高度な機能を備えたクリップボードマネージャー

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [dupeGuru](https://github.com/arsenetar/dupeguru/) - dupeGuruは、コンピュータ上の重複ファイルを検出するツール。ファイル名やファイル内容を用いてスキャン可能です

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://dupeguru.voltaicideas.net/](https://dupeguru.voltaicideas.net/)

- [Duplicate Finder](https://github.com/powerwolf543/DuplicateFinder) - 特定フォルダ内のファイル名が同じものすべてを検出するための便利なツール
...
- [Finder Go](https://github.com/onmyway133/FinderGo) - macOSアプリおよびFinderの同期拡張機能で、Terminal、iTerm、HyperをFinderから開く

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [FiScript](https://github.com/Mortennn/FiScript) - Finderでのマウス右クリック（CTRL+クリック）からカスタムスクリプトを実行
...
- [muCommander](https://github.com/mucommander/mucommander) - 軽量で、プラットフォームを問わず使えるファイルマネージャー。ダブルパネルインターフェースを備えている。

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://www.mucommander.com/](https://www.mucommander.com/)

- [OpenInCode](https://github.com/sozercan/OpenInCode) - Visual Studio Codeに現在のフォルダを開くためのFinderツールバーアプリ。
...
- [OpenInTerminal](https://github.com/Ji4n1ng/OpenInTerminal) - macOS向けFinderツールバーアプリで、現在のディレクトリをTerminal、iTerm、HyperまたはAlacrittyで開く
...
- [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) - 開発者向けに便利なQuick Lookプラグインのリスト。
...
- [SaneClick](https://github.com/sane-apps/SaneClick) - ファイル管理、画像変換、開発ツール向けの51以上の右クリックアクションを提供するFinder拡張機能

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://saneclick.com](https://saneclick.com)
...
- [zoxide](https://github.com/ajeetdsouza/zoxide) - zoxideは、あなたのターミナルにスマートなcdコマンドを提供します
...
### 🎮 ゲーム (13) <a id="games"></a>
- [0 A.D.](https://svn.wildfiregames.com/public/ps/trunk/) - 古代戦争をテーマにしたリアルタイム戦略ゲーム

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://play0ad.com](https://play0ad.com)
...
- [Amazing Tic Tac Toe](https://github.com/Aries-Sciences-LLC/Tic-Tac-Toe) - App Storeに登場する、マルチプレイヤー（局内およびオンライン）とレベル別シングルプレイヤーが可能な楽しいTic Tac Toeゲーム。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://ariessciences.com/highlight?product=tic-tac-toe](https://ariessciences.com/highlight?product=tic-tac-toe)
...
- [Battle for Wesnoth](https://github.com/wesnoth/wesnoth) - ターン制戦略ゲーム。シングルプレイヤーやオンラインマルチプレイヤーの戦闘が可能。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [Boxer](https://github.com/alunbestor/Boxer) - Macに最適化されたDOSゲームエミュレーター。
...
- [Chess](https://opensource.apple.com/source/Chess/Chess-410.4.1/) - macOSに付属するチェスアプリ。

  **Languages:** <code>objective-c</code> 

  **Webサイト:** [https://www.apple.com/](https://www.apple.com/)
...
- [Dolphin](https://github.com/dolphin-emu/dolphin) - Nintendo GameCubeおよびWiiゲームをエミュレートする強力なエミュレーター。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [Dynamic Dark Mode](https://github.com/ApolloZhu/Dynamic-Dark-Mode) - Dynamic Dark Modeは、macOS Mojave以降のダークモードを強化するアプリです。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apollozhu.github.io/Dynamic-Dark-Mode/](https://apollozhu.github.io/Dynamic-Dark-Mode/)
...
- [OpenEmu](https://github.com/OpenEmu/OpenEmu) - macOS向けのレトロビデオゲームエミュレーター。
...
- [OpenRCT2](https://github.com/OpenRCT2/OpenRCT2) - RollerCoaster Tycoon 2の再実装。
...
- [Sabaki](https://github.com/SabakiHQ/Sabaki) - より文明的な時代にふさわしい、ゴーバッドク・ウェイキの盤とSGFエディタ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [http://sabaki.yichuanshen.de](http://sabaki.yichuanshen.de)

- [Screentendo](https://github.com/AaronRandall/Screentendo) - あなたの画面をマリオのプレイ可能なレベルに変える。
...
- [Stockfish](https://github.com/daylen/stockfish-mac) - 美しく、強力なチェスアプリ。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Widelands](https://github.com/widelands/widelands) - Widelandsは、無料でオープンソースのリアルタイム戦略ゲームで、シングルプレイヤーキャンペーンとマルチプレイヤーモードを備えている。このゲームはSettlers II™（© Bluebyte）にインスピレーションを受けているが、そのバリエーションと深さは著しく大きい。
  ...
  **Webサイト:** [https://www.widelands.org](https://www.widelands.org)
...
### 🎨 グラフィックス (17) <a id="graphics"></a>
- [Aseprite](https://github.com/aseprite/aseprite) - アニメーションされたスプライトエディタおよびピクセルアートツール（Windows、macOS、Linux）。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [Blender](https://projects.blender.org/) - Blenderは、無料でオープンソースの3D作成ソフトウェアで、3Dパイプラインのすべてのプロセスをサポートしている。モデリング、リグ、アニメーション、シミュレーション、レンダリング、合成、動き追跡、動画編集を含む。
  ...
  **Webサイト:** [https://www.blender.org](https://www.blender.org)
...
- [CaptuocrToy](https://github.com/sfragrance/CaptuocrToy) - オンラインOCRAPIを用いてスクリーンショットをキャプチャし、テキストを認識するツール。
...
- [FreeCAD](https://github.com/FreeCAD/FreeCAD) - FreeCADはオープンソース3Dパラメトリックモデラーです

  **Languages:** <code>c++</code> <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://www.freecad.org/](https://www.freecad.org/)
...
- [Gaphor](https://github.com/gaphor/gaphor) - GaphorはUMLおよびSysML用のシンプルなモデリングツールです

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://gaphor.org](https://gaphor.org)

- [GifCapture](https://github.com/onmyway133/GifCapture) - macOS用のGIFキャプチャアプリです
...
- [Gifcurry](https://github.com/lettier/gifcurry) - クリップ、テキストの追加、シーク、トリミングを可能にするグラフィカルインターフェースを持つ動画からGIFへ変換ツールです
...
- [Gifski](https://github.com/sindresorhus/Gifski) - 動画を高品質のGIFに変換します
...
- [InfiniteCanvas](https://github.com/CleanCocoa/InfiniteCanvas) - Mac用のドラッグ＆ドロップ型描画アプリの概念実証です
...
- [Krita](https://invent.kde.org/graphics/krita) - Kritaは、イラスト、コンセプトアート、マットペインティング、テクスチャ、コミックやアニメーションなど、デジタルアートファイルを完全にゼロから作成できるマルチプラットフォームアプリケーションです。
  ...
  **Webサイト:** [https://krita.org/en/](https://krita.org/en/)
...
- [LibreCAD](https://github.com/LibreCAD/LibreCAD) - LibreCADは、Windows、Apple、Linux用の無料オープンソースCADアプリケーションです。サポートとドキュメンテーションは、多くのユーザー、貢献者、開発者による大きなコミュニティから無料で提供されています

  **Languages:** <code>c++</code> <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://librecad.org](https://librecad.org)
...
- [macSVG](https://github.com/dsward2/macSVG) - HTML5 SVG（スケーラブルベクターグラフィックス）アートおよびアニメーションをWebKitウェブビューで設計できるmacOSアプリです
...
- [Material Colors Native](https://github.com/BafS/Material-Colors-native) - 選択したマテリアルカラーをコピーし、ヘックスコードを取得します
...
- [Nugget](https://github.com/cartesiancs/nugget-app) - 動き効果と柔軟性を重視した動画編集ソフトウェアです
...
- [Pencil2D Animation](https://github.com/pencil2d/pencil) - Pencil2Dは、macOS、Windows、Linux用のアニメーション／描画ソフトウェアです。ビットマップおよびベクターグラフィックスを使用して、伝統的な手描きアニメーション（クレヨンアニメ）を作成できます

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [ScreenToLayers for macOS](https://github.com/duyquoc/ScreenToLayers) - ScreenToLayersは、スクリーンをレイヤー付きPSDファイルとして簡単にキャプチャできるmacOSアプリです
...
- [IntelliJ IDEA Community Edition](https://github.com/JetBrains/intellij-community) - IntelliJ IDEAは、コンピュータソフトウェア開発用にJavaで書かれた統合開発環境

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://www.jetbrains.com/idea/](https://www.jetbrains.com/idea/)
...
- [LiveCode](https://github.com/livecode/livecode) - クロスプラットフォーム開発用IDE

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://livecode.org/](https://livecode.org/)

- [Oni](https://github.com/onivim/oni) - Oniは、開発者の生産性を重視したモーダル編集をテーマとした現代的なコードエディタ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

- [Vim](https://github.com/vim/vim) - どこでも使えるテキストエディタ

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <code>Vim script</code> 

  **Webサイト:** [https://www.vim.org/](https://www.vim.org/)
...
- [Visual Studio Code](https://github.com/Microsoft/vscode) - マイクロソフトが開発したコードエディタ
...
- [VSCodium](https://github.com/VSCodium/vscodium) - VSCodiumは、マイクロソフトのVS Codeのコミュニティが運営する、すべてのテレメトリを削除した無料ライセンスのバイナリ配布版

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://vscodium.com/](https://vscodium.com/)
...
- [ZeroBraneStudio](https://github.com/pkulchenko/ZeroBraneStudio) - ZeroBrane Studioは、軽量かつクロスプラットオーラーのLua IDEで、コード補完、文法ハイライト、リモートデバッガ、コード分析、ライブコーディング、およびさまざまなLuaエンジン向けのデバッギングをサポート
...
### 🖼️ 画像 (17) <a id="images"></a>
- [APNGb](https://github.com/shgodoroja/APNGb) - macOS用のアニメーションPNGファイルをアセンブルおよびディアセンブルするアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Crunch](https://github.com/chrissimpkins/Crunch) - インサイン（驚くほど遅いが、非常に優れた）PNG画像最適化

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [ExifCleaner](https://github.com/szTheory/exifcleaner) - ドラッグアンドドロップで画像メタデータを削除し、マルチコア並列処理とダークモードをサポート

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://exifcleaner.com](https://exifcleaner.com)
...
- [Flameshot](https://github.com/flameshot-org/flameshot) - 強力でありながら使いやすいスクリーンショットソフトウェア

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://flameshot.org](https://flameshot.org)
...
- [Freehand](https://github.com/wddwycc/Freehand) - macOSステータスバー用のスケッチアプリ
...
- [Gimp](https://github.com/GNOME/gimp) - GimpはGNU画像編集プログラム
...
- [ImageAlpha](https://github.com/kornelski/ImageAlpha) - pngquant、pngnqおよびposterizerのMacGUI
...
- [Imagine](https://github.com/meowtec/Imagine) - Imagineは、PNGおよびJPEGの圧縮を行うデスクトップアプリで、現代的で親しみやすいUIを備えている

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

- [Inkscape](https://gitlab.com/inkscape/inkscape) - インクスケープは、無料かつオープンソースのベクターグラフィックスエディタ

  **Languages:** <code>c++</code> 

  **Webサイト:** [https://inkscape.org/](https://inkscape.org/)
...
- [InVesalius](https://github.com/invesalius/invesalius3/) - 3D医療画像再構成ソフトウェア
...
- [Katana](https://github.com/bluegill/katana) - Katanaは、macOS向けのシンプルなスクリーンショットツールで、メニューバーに存在する
...
- [PhotoMiner](https://github.com/gergelysanta/photominer) - macOS用のディスク上の写真を検索・見つけるためのアプリです。
...
- [Screenbar](https://github.com/crilleengvall/Screenbar) - macOSのメニューバーに表示されるスクリーンショット自動化用アプリです。
...
- [Seashore](https://github.com/robaho/seashore) - 一般ユーザー向けに使いやすいmacOS画像編集アプリです。
...
- [WebPonize](https://github.com/1000ch/WebPonize) - WebPonizeは、PNG、JPEG、アニメーション（または非アニメーション）GIF画像をWebPに変換できるmacOSアプリです。
...
### ⌨️ キーボード (10) <a id="keyboard"></a>
- [AnnePro-mac](https://github.com/msvisser/AnnePro-mac) - BluetoothでAnneProキーボードを制御できるmacOSアプリです。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Fluor](https://github.com/Pyroh/Fluor) - アクティブなアプリに応じてFnキーのモードを切り替えるためのmacOS用便利ツールです。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [GokuRakuJoudo](https://github.com/yqrashawn/GokuRakuJoudo) - Karabiner-Elementsの設定管理ツール、karabiner.jsonが膨らんでいる場合のリカバリー
...
- [Karabiner](https://github.com/tekezo/Karabiner) - Karabiner（KeyRemap4MacBook）は、キーボードカスタマイズに非常に強力なユーティリティです。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Karabiner-Elements](https://github.com/pqrs-org/Karabiner-Elements) - Karabiner-Elementsは、macOS Sierra（10.12）以降でのキーボードカスタマイズに最適な強力なツールです。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Kawa](https://github.com/hatashiro/kawa) - macOS向けのより良い入力ソース切り替えツールです。
...
- [Keycastr](https://github.com/keycastr/keycastr) - キーストロークの可視化ツールです。
...
- [Thor](https://github.com/gbammc/Thor) - すぐに正しいアプリを切り替えること。
...
- [Unshaky](https://github.com/aahung/Unshaky) - Appleのバタフライキーボードにおける「ダブルキー押下」問題を解決しようとするソフトウェアです。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://unshaky.nestederror.com/](https://unshaky.nestederror.com/)
...
### 📧 メール (7) <a id="mail"></a>
- [Correo](https://github.com/amitmerchant1990/correo) - WindowsおよびmacOS向けのメニューバー／タスクバーに表示されるGmailアプリです。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [dejalu](https://github.com/dinhvh/dejalu) - 高速かつシンプルなメールクライアントです。
...
- [ElectronMail](https://github.com/vladimiry/ElectronMail) - ProtonMailおよびTutanotaといった端末暗号化メールサービスの非公式デスクトップアプリです。
...
- [Mailspring](https://github.com/Foundry376/Mailspring) - 💌 元作者の一人が開発した、@nylas Mailの美しい、高速かつメンテナンスされたフォークです。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://getmailspring.com/](https://getmailspring.com/)

- [Rambox](https://github.com/ramboxapp/community-edition) - ウェブアプリケーションを統合した、クロスプラットフォームのメッセージングおよびメールアプリです。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

- [SimpleLogin](https://github.com/simple-login/mac-app) - メールアリアソリューション：あなたの本物のメールアドレスを保護します。
...
### 📊 メニューバー (52) <a id="menubar"></a>
- [Airpass](https://github.com/alvesjtiago/airpass) - 時間制限のあるWiFiネットワークを克服するためのマックアプリケーション（ステータスバー）。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Akku](https://github.com/jariz/Akku) - macOSのBluetoothヘッドフォンのバッテリー表示アプリが不足しています。
...
- [AnyBar](https://github.com/tonsky/AnyBar) - macOSのメニューバーに表示するステータスインジケーター。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [app-menu](https://github.com/barseghyanartur/app-menu) - macOSにおけるアプリケーションメニューが不足しています。
...
- [baRSS – Menu Bar RSS Reader](https://github.com/relikd/barss) - システムステータスバーに表示されるRSSおよびAtomフィードリーダー。
...
- [BarTranslate](https://github.com/ThijmenDam/BarTranslate) - 便利な（ネイティブ）メニューバー翻訳アプリ（Google翻訳をサポート）。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://thijmendam.github.io/BarTranslate/](https://thijmendam.github.io/BarTranslate/)
...
- [Bye-AppQuit](https://github.com/designsbymuzeer/Bye-Mac-App) - 最小限のネイティブmacOSアプリで、実行中のプロセスを一時的に表示および大量削除

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://github.com/designsbymuzeer/Bye-Mac-App](https://github.com/designsbymuzeer/Bye-Mac-App)
...
- [ClipFlow](https://github.com/praneeth552/clipflow) - macOS用クリップボード履歴マネージャー。ターミナル風のナビゲーション、画像プレビュー、カーソル追従ポップアップを備えている

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://github.com/praneeth552/clipflow](https://github.com/praneeth552/clipflow)
...
- [CloudyTabs](https://github.com/josh-/CloudyTabs) - iCloudのタブと読み込みリストを表示するシンプルなメニューバーのmacOSアプリ。
...
- [DatWeatherDoe](https://github.com/inderdhir/DatWeatherDoe) - Swiftで書かれたシンプルなmacOSメニューバー天気アプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [DisplayMenu](https://github.com/Kwpolska/DisplayMenu) - シンプル（骨格的な）macOSメニューバー拡張機能でディスプレイプリセットを適用。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Dozer](https://github.com/Mortennn/Dozer) - macOSのメニューバー項目を非表示にする。
...
- [eul](https://github.com/gao-sun/eul) - SwiftUIで書かれたmacOS用ステータスモニタリングアプリ
...
- [Grayscale Mode](https://github.com/rkbhochalya/grayscale-mode) - メニューバーからグレースケールモードを管理できます
...
- [gSwitch](https://github.com/CodySchrank/gSwitch) - 2つのGPU搭載macBook向けにGPUの制御を可能にするmacOSステータスバーアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Hidden Bar](https://github.com/dwarvesf/hidden) - 極めて軽量なmacOSユーティリティで、メニューバーのアイコンを非表示にします。
...
- [Ice](https://github.com/jordanbaird/Ice) - 強力なmacOSメニューバー管理者。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://icemenubar.app/](https://icemenubar.app/)
...
- [iGlance](https://github.com/iglance/iGlance) - macOSのステータスバーに表示されるシステムモニタ（CPU、メモリ、ネットワーク、ファン、バッテリー）。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Itsycal](https://github.com/sfsam/Itsycal) - Macのメニューバーに存在する、シンプルなカレンダー

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://www.mowglii.com/itsycal/](https://www.mowglii.com/itsycal/)
...
- [KubeContext](https://github.com/turkenh/KubeContext) - MacでKubernetesのコンテキストをインポート・管理・切り替えする
...
- [LinkLiar](https://github.com/halo/LinkLiar) - プライバシーを守るためにMACアドレスをランダムに保持（ifconfig用の直感的なGUI）

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://halo.github.io/LinkLiar/](https://halo.github.io/LinkLiar/)
...
- [MacNTop](https://github.com/CorvidLabs/MacNTop) - macOSメニューバーにレトロCRT風のデザインを備えたシステムモニタリングアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://github.com/CorvidLabs/MacNTop](https://github.com/CorvidLabs/MacNTop)

- [Market Bar](https://github.com/mnndnl/market-bar ) - メニューバーに表示されるミニストックウォッチャー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [MeetingBar](https://github.com/leits/MeetingBar) - カレンダーの会議に使えるメニューバーアプリ
...
- [Menubar Brightness](https://github.com/lucasbento/menubar-brightness) - macOSで画面の明るさをメニューバーから調整できるアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [MenuMeters](https://github.com/yujitach/MenuMeters) - macOS用のCPU、メモリ、ディスク、ネットワークモニタリングツール

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [MiniSim](https://github.com/okwasniewski/MiniSim) - iOS  およびAndroid 🤖 エミュレーターを起動するためのmacOSメニューバー用アプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.minisim.app/](https://www.minisim.app/)
...
- [Monitor Bar](https://github.com/tidiemme/monitorbar) - Monitor Barアプリは、コンパクト、通常、追加の3種類のモードをサポートしており、バッテリー、ディスク、メモリ、CPU、ネットワーク帯域幅、Wi-Fiをモニタリング

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Night Shift Control](https://github.com/isaiasmatewos/night-shift-control) - Night Shift Controlは、Night Shiftの機能を補完するシンプルなmacOSメニューバーアプリで、f.luxに含まれるNight Shiftにない機能（特定アプリでNight Shiftを無効にするなど）を提供
...
- [Nocturnal](https://github.com/joshjon/nocturnal) - メニューバーに設置されたアプリで、ダークディム、ナイトシフトの調整、MacBook ProのTouchBarをオフにする機能を備える
...
- [OnlySwitch](https://github.com/jacklandrin/OnlySwitch) - すべての機能を1つのステータスバーボタンにまとめ、MacBook Proのノッチを隠し、ダークモード、AirPods、Shortcutsを表示

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.jacklandrin.com/2021/12/01/onlyswitch/](https://www.jacklandrin.com/2021/12/01/onlyswitch/)
...
- [Pareto Security](https://github.com/paretoSecurity/pareto-mac/) - マニューバーに表示されるアプリで、Macの基本的なセキュリティ衛生を自動的にチェックします

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://paretosecurity.com/](https://paretosecurity.com/)
...
- [Pi Stats](https://github.com/Bunn/PiStats) - Pi-holeの情報を可視化するmacOSアプリ
...
- [Pika](https://github.com/superhighfives/pika) - macOS用の使いやすい、オープンソース、ネイティブカラー選択ツール

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift <code>metal</code> 

  **Webサイト:** [https://superhighfives.com/pika](https://superhighfives.com/pika)
...
- [PSIBar](https://github.com/nikhilsh/PSIBar) - 簡単に作成されたPSI macOSステータスバーアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Quick Weather](https://github.com/Aries-Sciences-LLC/Quick-Weather) - App Storeに登場するシンプルでエレガントなメニューバー用天気アプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://ariessciences.com/highlight?product=quick-weather](https://ariessciences.com/highlight?product=quick-weather)
...
- [Quickeys](https://github.com/alexrosenfeld10/Quickeys) - ノートを取る機能を、簡単なドロップダウンメニューで提供するmacメニューバーアプリ
...
- [RustCast](https://github.com/unsecretised/rustcast) - 驚くほど速く、カスタマイズ可能なマルチツールアプリランチャー

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://rustcast.umangsurana.com](https://rustcast.umangsurana.com)
...
- [SaneBar](https://github.com/sane-apps/SaneBar) - プライバシーを最優先としたメニューバー管理ツール。Touch IDによるロック、常に非表示ゾーン、自動化トリガーを備えています

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://sanebar.com](https://sanebar.com)
...
- [ScreenHint](https://github.com/salemhilal/ScreenHint) - 明確に考えるためのシンプルなスクリーンショットツール

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://screenhint.com](https://screenhint.com)
...
- [SensibleSideButtons](https://github.com/archagon/sensible-side-buttons) - 小さなメニューバーユーティリティ。第三者のマウスのサイドボタンを使って、さまざまなアプリ間をナビゲートできます。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [Shifty](https://github.com/thompsonate/Shifty) - macOSのメニューバーに搭載された、夜間モードの制御を強化するアプリ。
...
- [SlimHUD - Cyanocitta](https://github.com/AlexPerathoner/SlimHUD) - macOSのボリューム、明るさ、キーボードバックライトのHUDを置き換える
...
- [Stats](https://github.com/exelban/stats) - マーカスのシステムモニタがメニューバーに表示されます
...
- [SwiftBar](https://github.com/swiftbar/SwiftBar) - 強力なmacOSメニューバーカスタマイズツール。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://swiftbar.app](https://swiftbar.app)

- [TimeScribe](https://github.com/WINBIGFOX/timescribe) - シンプルで無料の業務時間記録ツ術。
  ...
  **Webサイト:** [https://timescribe.app](https://timescribe.app)
...
- [Vercel Deployment Menu Bar](https://github.com/andrewk17/vercel-deployment-menu-bar) - Vercelのデプロイ状態をリアルタイムで監視できるオープンソースのmacOSメニューバーアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://vercel-deployment-menu-bar.vercel.app/](https://vercel-deployment-menu-bar.vercel.app/)
...
- [VPN Bypass](https://github.com/GeiserX/VPN-Bypass) - 企業のVPN経由で特定のドメインやサービスをルートし、他のトラフィックは保護を維持します

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://github.com/GeiserX/VPN-Bypass](https://github.com/GeiserX/VPN-Bypass)
...
- [xbar](https://github.com/matryer/xbar) - 任意のスクリプトやプログラムの出力をmacOSのメニューバーに表示します。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

### 🎧 音楽 (16) <a id="music"></a>
- [Carol](https://github.com/AnaghSharma/Carol) - シンプルで美しい歌詞アプリ。macOSのメニューバーに常に表示されます。

  **Languages:** <img src='./icons/csharp-64.png' alt='C# icon' title='C#' height='16'/> C# 

- [ChordDetector](https://github.com/cemolcay/ChordDetector) - 小さなメニューバーアプリ。iTunesとSpotifyを監視し、音楽のコードを検出します！

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [DeezPlayer](https://github.com/imanel/deezplayer) - Deezer Desktopアプリ（Windows、Linux、macOS用）。

  **Languages:** <img src='./icons/coffeescript-64.png' alt='CoffeeScript icon' title='CoffeeScript' height='16'/> CoffeeScript 

- [iTunes Graphs](https://github.com/Zac-Garby/iTunes-Graphs) - iTunesのライブラリをグラフで可視化するmacOSアプリ。
...
- [Lilypond UI](https://github.com/doches/lilypond-ui) - LilyPondを使って美しい楽譜を作成できます。
...
- [lyricsify](https://github.com/mamal72/lyricsify-mac) - Swiftで開発されたシンプルなSpotifyの歌詞閲覧用メニューバーアプリ（macOS用）。
...
- [SoundCleod](https://github.com/salomvary/soundcleod) - SoundCloud for macOSおよびWindows
...
- [spicetify-cli](https://github.com/spicetify/spicetify-cli) - 公式Spotifyクライアントをカスタマイズするコマンドラインツール。Windows、macOSおよびLinuxに対応

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://spicetify.app/](https://spicetify.app/)
...
- [Spotify-Cli-Mac](https://github.com/ersel/spotify-cli-mac) - ターミナルから離れないでSpotifyを制御できます。:notes:
...
- [YouTube-Music](https://github.com/steve228uk/YouTube-Music) - music.youtube.com用のmacOS用ラッパー
...
- [Diurna](https://github.com/ngquerol/Diurna) - 基本版／クラシック版Hacker Newsアプリ、CocoaおよびSwiftの学習プラットフォームとして使用
...
- [hacker-menu](https://github.com/owenthereal/hacker-menu) - Hacker Newsがデスクトップに届けられます
...
- [NetNewsWire](https://github.com/Ranchero-Software/NetNewsWire) - macOS用のフィードリーダー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Vienna](https://github.com/ViennaRSS/vienna-rss) - ViennaはmacOS用のRSS/Atomニュースリーダー

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Winds](https://github.com/GetStream/Winds) - Getstream.ioを活用した美しいオープンソースRSS・ポッドキャストアプリ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://getstream.io/winds/](https://getstream.io/winds/)
...
- [Boostnote](https://github.com/BoostIO/BoostNote-Legacy) - プログラマー向けのノートアプリ
...
- [Dnote](https://github.com/dnote/dnote) - マルチデバイス同期とウェブインターフェースを備えたシンプルなコマンドラインノートブック
  ...
  **Webサイト:** [https://www.getdnote.com/](https://www.getdnote.com/)
...
- [FromScratch](https://github.com/Kilian/fromscratch) - 一時的なノートやタスク管理に使える小さなアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

- [FSNotes](https://github.com/glushchenko/fsnotes) - macOS/iOS用のノートマネージャー：現代的なノート作成速度（nvALT）を強化
...
- [joplin](https://github.com/laurent22/joplin) - ノート作成とToDoアプリで、Windows、macOS、Linux、Android、iOSに対応した同期機能付きアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Jupyter Notebook Viewer](https://github.com/tuxu/nbviewer-app) - macOS用のノート閲覧アプリ
...
- [notable](https://github.com/jmcfarlane/notable) - シンプルなノート作成アプリ
...
- [Notes](https://github.com/SauvageP/Notes) - Notesは、テキストなど他のフォーマット（画像、動画、連絡先など）を用いてノートを作成するためのmacOS用アプリ
...
- [NoteTaker](https://github.com/insidegui/NoteTaker) - macOSおよびiOS向けのシンプルなノートアプリ。RealmとCloudKitを使用して同期を実現
...
- [Simplenote](https://github.com/Automattic/simplenote-macos) - 最もシンプルなノート管理方法
...
- [Standard Notes](https://github.com/standardnotes/app) - あなたのノート、考え、人生の成果を安全に保管する場所

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

- [Stik](https://github.com/0xMassi/stik_app) - macOS用の即時思考記録アプリ。グローバルショートカットでポストイットノートを呼び出し、入力して閉じます。ノートはシンプルなマーカー形式のファイルとして保存されます

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://stik.ink](https://stik.ink)

- [tmpNote](https://github.com/buddax2/tmpNote) - 非常にシンプルなmacOS用の一時的なノート作成アプリ
...
- [Tusk](https://github.com/klaudiosinani/tusk) - 公式ではない、第三者、コミュニティが運営するEvernoteアプリ。いくつかの便利な機能を備えています

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

### 📦 その他 (25) <a id="other"></a>
- [Betaflight Configurator](https://github.com/betaflight/betaflight-configurator) - Betaflightファームウェア向けのクロスプラットフォーム設定ツール。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://betaflight.com/](https://betaflight.com/)
...
- [Cakebrew](https://github.com/brunophilipe/Cakebrew) - Cakebrewを使って、Homebrewのフォーマルをスタイルに沿って管理
...
- [ChipMunk](https://github.com/esrlabs/chipmunk) - ログ分析ツール
...
- [DevDocs for macOS](https://github.com/dteoh/devdocs-macos) - 非公式なDevDocs APIドキュメント閲覧ツール
...
- [Gas Mask](https://github.com/2ndalpha/gasmask) - macOS用のホストファイルマネージャー

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Gramps](https://github.com/gramps-project/gramps) - 初心者にも使いやすく、プロの遺伝学研究者にも完全な機能を備えた遺伝学プログラム

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://gramps-project.org](https://gramps-project.org)

- [Hosts](https://github.com/specialunderwear/Hosts.prefpane) - /etc/hosts向けのCocoa GUI。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [ImageOptim](https://github.com/ImageOptim/ImageOptim) - Mac用のGUI画像最適化ツール

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Keyframes Player](https://github.com/insidegui/KeyframesPlayer) - Facebookのキーフレームフレームワークで作成されたアニメーションをプレビューできるシンプルなmacOSアプリ。
...
- [Lepton](https://github.com/hackjutsu/Lepton) - コードスニペット管理の民主化（macOS/Win/Linux）

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Letters](https://github.com/klaaspieter/letters) - 子どもたちにアルファベットとタイピングの仕方を教える。
...
- [macGist](https://github.com/Bunn/macGist) - GitHubのGistにペーストボードの項目を送信するためのシンプルなアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Numi](https://github.com/nikolaeu/numi) - macOS用の美しい電卓アプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://numi.app/](https://numi.app/)
...
- [Platypus](https://github.com/sveinbjornt/Platypus) - Mac用開発ツールで、コマンドラインスクリプトからアプリケーションバンドルを作成します。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [QorumLogs](https://github.com/Esqarrouth/QorumLogs) - XcodeおよびGoogle Docs用のSwiftログユーティリティ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [React Native Debugger](https://github.com/jhen0409/react-native-debugger) - React Nativeプロジェクトの確認に使えるデスクトップアプリ。macOS、Linux、およびWindows。
...
- [Reactotron](https://github.com/infinitered/reactotron) - React JSおよびReact Nativeプロジェクトの確認に使えるデスクトップアプリ。macOS、Linux、Windows。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [RktMachine](https://github.com/woofwoofinc/rktmachine) - macOS用メニューバーアプリで、CoreOS VM内のmacOS仮想化環境でrktを実行します。
...
- [Ruby.app](https://github.com/gosu/ruby-app) - Ruby/Gosu用の完全なRubyインストールが含まれるmacOSアプリ

  **Languages:** <img src='./icons/ruby-64.png' alt='Ruby icon' title='Ruby' height='16'/> Ruby 

- [Shuttle](https://github.com/fitztrev/shuttle) - macOS用シンプルなSSHショートカットメニュー。
...
- [SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) - Swiftでの開発およびリリース時の便利なログ記録。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [SwitchShuttle](https://github.com/s00d/switchshuttle) - macOS用の簡単なコマンドショートカットメニュー
...
- [syncthing-macosx](https://github.com/syncthing/syncthing-macos) - 節約型 nativemacOS macOS Syncthing アプリケーションバンドル。
...
- [Unused](https://github.com/jeffhodnett/Unused) - Xcodeプロジェクト内の未使用リソースを確認するMacアプリ。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Vagrant Manager](https://github.com/lanayotech/vagrant-manager) - macOSでVagrantマネージャーで一か所にVagrantマシンを管理します。
...
### ▶️ プレーヤー (6) <a id="player"></a>
- [IINA](https://github.com/iina/iina) - macOS用の現代的なビデオプレイヤー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://iina.io](https://iina.io)

- [MacMorpheus](https://github.com/emoRaivis/MacMorpheus) - PSVR用のヘッドトラッキング対応3D 180/360動画プレイヤー（macOS用）。
...
- [Movie Monad](https://github.com/lettier/movie-monad) - Haskellで構築されたデスクトップビデオプレイヤー。GStreamerとGTK+を使用。
...
- [MPlayerX](https://github.com/niltsh/MPlayerX) - macOS用のメディアプレイヤー。
...
### 🎙️ ポッドキャスト (7) <a id="podcast"></a>
- [Cumulonimbus](https://github.com/z-------------/CPod) - シンプルで美しいポッドキャストアプリ。
...
- [Doughnut](https://github.com/dyerc/Doughnut) - mac用のポッドキャストプレイヤーとライブラリ。
...
- [gPodder](https://github.com/gpodder/gpodder) - gPodderはシンプルでオープンソースのポッドキャストクライアント。

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://gpodder.github.io/](https://gpodder.github.io/)
...
- [mkchromecast](https://github.com/muammar/mkchromecast) - macOSおよびLinuxの音声・動画をGoogle CastおよびSonosデバイスにキャスト。

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [PodcastMenu](https://github.com/insidegui/PodcastMenu) - PodcastMenuは、あなたの好きなポッドキャストを仕事中に聴けるように、Macのメニューバーにを表示するシンプルなアプリです。 [Overcast](https://overcast.fm/)

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Podlive for macOS](https://github.com/Podlive/podlive-macos) - ライブストリーミングポッドキャストを聴くためのmacOSクライアント（ライブストリーミングのみ）。現在はUltraschallによるすべてのライブストリーミングを支援しています。 [Studio Link On Air](https://studio-link.de)
...
### ⏱️ 生産性 (78) <a id="productivity"></a>
- [ActivityWatch](https://github.com/ActivityWatch/activitywatch) - オープンソースの自動時間トラッカーで、デバイス上で過ごす時間を追跡。
  ...
  **Webサイト:** [https://activitywatch.net](https://activitywatch.net)

- [Ao](https://github.com/klaudiosinani/ao) - エレガントなMicrosoft To-Doデスクトップアプリ。
...
- [Blink Eye](https://github.com/nomandhoni-cs/blink-eye) - Windows、macOS、Linux向けのオープンソースミニマリズムの眼ケアリマインダーおよびブレイクタイマーアプリ。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://blinkeye.vercel.app/](https://blinkeye.vercel.app/)
...
- [Calculeta](https://github.com/varol/Calculeta) - macOS用ステータスバーに表示される電卓アプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Cerebro](https://github.com/cerebroapp/cerebro) - マルチプラットフォーム対応のスタートアップアプリ。
...
- [ClipMenu](https://github.com/naotaka/ClipMenu) - macOS用のクリップボードマネージャー。
...
- [Clocker](https://github.com/n0shake/Clocker) - macOSアプリでタイムゾーンを活用した計画と整理を行う

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Condution](https://github.com/Shabang-Systems/Condution) - タスクを作成し、期限管理・フィルタリングを強力な視点で行う

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://www.condution.com](https://www.condution.com)
...
- [ControlPlane](https://github.com/dustinrue/ControlPlane) - あなたの場所や行動に応じて、自動で実行されるタスクを設定

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [DevUtils.app](https://github.com/DevUtilsApp/DevUtils-app) - macOS向け開発者ツール。小さな日常タスクをワンクリックで実行可能！例：JSONフォーマッター、UUID生成ツール...

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://devutils.com](https://devutils.com)
...
- [Dockit](https://github.com/xicheng148/Dockit) - ウィンドウを画面の端にドックできるアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [[official site](https://dockit-docs.pages.dev/?s=open-sourse-mac-os-apps)]([official site](https://dockit-docs.pages.dev/?s=open-sourse-mac-os-apps))
...
- [DropPoint](https://github.com/GameGodS3/DropPoint) - DropPointを使ってドラッグ＆ドロップを簡単にする。並べて開く必要のないウィンドウでコンテンツをドラッグできるようにする
...
- [espanso](https://github.com/espanso/espanso) - クロスプラットフォームテキストエキパンド、Alfred Snippetsの強力な代替品

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://espanso.org](https://espanso.org)
...
- [far2l](https://github.com/elfmz/far2l) - Linux/Mac向けのFAR Manager v2のフォーク

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [File Architect](https://github.com/filearchitect/app) - シンプルなテキスト記述からファイルとフォルダ構造を作成

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://filearchitect.com](https://filearchitect.com)
...
- [Flycut](https://github.com/TermiT/flycut) - 開発者向けシンプルでクリーンなクリップボードマネージャー

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Freeter](https://github.com/FreeterApp/Freeter) - 仕事に必要なすべての情報をプロジェクトやワークフローで整理し、一か所に集約して、すぐにアクセスできるアプリ

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://freeter.io/](https://freeter.io/)
...
- [Ice](https://github.com/jordanbaird/Ice) - Iceは、項目の非表示・表示を越えて、豊かな生産性機能を提供する、柔軟なメニューバー管理ツール
...
- [KeyHolder](https://github.com/Clipy/KeyHolder) - macOSでショートカットを記録できる、Alfred.appと同様の機能

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Kiwix](https://github.com/kiwix/apple) - iOSおよびmacOS向けKiwix、Swiftで構築
...
- [Linked Ideas](https://github.com/fespinoza/LinkedIdeas) - アイデアを書き留め、つなげられるmacOSアプリ
...
- [Mac Screenshot Tracker](https://github.com/instance01/mac-screenshot-tracker) - オープンソース・無料・カスタマイズ可能なスクリーンショットトラッカー。これまでの作業を再確認できる！
...
- [Maccy](https://github.com/p0deje/Maccy) - タイプしながら検索できる軽量クリップボードマネージャー
...
- [macOrganizer](https://github.com/shubhambatra3019/macOrganizer) - macOS向けファイルの整理や不要ファイルの削除に使えるアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Manta](https://github.com/hql287/Manta) - 柔軟な請求書作成用デスクトップアプリで、美しいかつカスタマイズ可能なテンプレートを提供
...
- [OmniPrompt](https://github.com/nsmet/omniprompt-gpt-mac-app) - あなたのMac上でスムーズにアクセスできるGPTの最強のパートナー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://omniprompt.app/](https://omniprompt.app/)

- [Paperless Desktop](https://github.com/thomasbrueggemann/paperless-desktop) - 紙のないAPIを活用してドキュメントスキャンを管理するデスクトップアプリ
...
- [PDF Archiver](https://github.com/PDF-Archiver/PDF-Archiver) - タスクのタグ付けとアーカイブに使える便利なツール
...
- [Pomodoro Cycle](https://github.com/ziulev/pomodoro-cycle-app) - macOS向けのポモドーロサイクルアプリ

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://github.com/ziulev/pomodoro-cycle-app/releases](https://github.com/ziulev/pomodoro-cycle-app/releases)
...
- [Quicksilver](https://github.com/quicksilver/Quicksilver) - Quicksilverは、Macの操作を迅速かつ美しく制御できる高速なmacOSプロダクティビティアプリです。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Quickwords](https://github.com/quickwords/quickwords) - 数秒で何でも書ける。テキストの置き換えや、面倒なタスクの自動実行など、スニペットを作成できます。
...
- [Readest](https://github.com/readest/readest) - Readestは、愛読者向けの現代的で機能豊かな電子書籍リーダーです。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://readest.com](https://readest.com)
...
- [SaneClip](https://github.com/sane-apps/SaneClip) - タッチIDによる保護、AES-256-GCM暗号化、センシティブデータ検出を備えたクリップボードマネージャー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://saneclip.com](https://saneclip.com)
...
- [SaneSales](https://github.com/sane-apps/SaneSales) - LemonSqueezy、Gumroad、Stripeのインディー販売を追跡するユニバーサルツール。デバイス上でプライバシーを確保

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://sanesales.com](https://sanesales.com)
...
- [Screenpipe](https://github.com/screenpipe/screenpipe) - 24時間365日、AIによる検索を備えたスクリーンとオーディオ記録。プライバシーを重視したローカル第一のリワード代替アプリ

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://screenpi.pe](https://screenpi.pe)
...
- [SelfControl](https://github.com/SelfControlApp/selfcontrol) - 自分のアクセスを一定期間、分散サイトなどにブロックするmacOSアプリ。アプリや再起動で解除することはできません。タイマーが終了するまで待つ必要があります。
...
- [Slime](https://github.com/Mas0nSun/Slime) - SwiftUIで書かれたアプリアイコンアセット生成ツール
...
- [Speed Reader](https://github.com/LumingYin/SpeedReader) - SpeedReaderで声を無効にし、読む速度を速くする

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apps.apple.com/app/speed-reader/id1258448209](https://apps.apple.com/app/speed-reader/id1258448209)
...
- [Spotter](https://github.com/spotter-application/spotter) - 生産性ツール。主な機能は、外部アプリケーションのアクションやアプリ自体を検索・起動し、現在のタスクに集中できるようにする。スポットライトやアルフレッドの代替ツール
...
- [status-bar-todo](https://github.com/Onix-Systems/osx-status-bar-todo) - シンプルなmacOSアプリでステータスバーにTODOリストを保持。
...
- [StickyNotes](https://github.com/LumingYin/StickyNotes) - Windows 10風のステッキノートアプリをAppKitで実装したアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://github.com/LumingYin/StickyNotes/releases](https://github.com/LumingYin/StickyNotes/releases)
...
- [Strategr](https://github.com/khrykin/StrategrDesktop) - 手間なく時間管理。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://khrykin.github.io/StrategrDesktop/](https://khrykin.github.io/StrategrDesktop/)
...
- [stretchly](https://github.com/hovancik/stretchly) - コンピュータ作業時に休憩を取るよう、クロスプラットフォームのElectronアプリで通知。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Super Productivity](https://github.com/johannesjo/super-productivity) - Jira統合を備えたプログラマー・デザイナー向け無料のToDoリストと時間トラッカー
  ...
  **Webサイト:** [https://super-productivity.com](https://super-productivity.com)
...
- [Thyme](https://github.com/joaomoreno/thyme) - OS X用のタスクタイマー。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Time to Leave](https://github.com/thamara/time-to-leave) - 業務時間の記録と、退勤時を通知するツール。
  ...
  **Webサイト:** [https://timetoleave.app/](https://timetoleave.app/)
...
- [Timer](https://github.com/michaelvillar/timer-app) - Mac用のシンプルなタイマーアプリ。
...
- [Toggl Desktop](https://github.com/toggl-open-source/toggldesktop) - Windows、Mac、Linux対応のTogglデスクトップアプリ。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [TomatoBar](https://github.com/ivoronin/TomatoBar) - Touch Bar対応のmacOS用のポモドーロ技術タイマー。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [TrelloApp](https://github.com/jlong/TrelloApp) - Swiftで書かれたTrello.com用の非公式ラッパーアプリ。これはサイト特定ブラウザのほぼ「Hello World」です。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Ueli](https://github.com/oliverschwendener/ueli) - macOS（およびWindows）向けのキーボードショートカットによるアプリ起動ツール（SpotlightやAlfredに似たもの）。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://ueli.app/](https://ueli.app/)
...
- [Watson](https://github.com/TailorDev/Watson) - 時間記録用のCLIアプリ。
...
- [Whale](https://github.com/1000ch/whale) - 非公式Trelloアプリ
...
- [Xournal++](https://github.com/xournalpp/xournalpp/) - 手書きノートを簡単に記録できます
...
- [Yippy](https://github.com/mattDavo/Yippy) - macOS用オープンソースクリップボードマネージャ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://yippy.mattdavo.com](https://yippy.mattdavo.com)
...
- [Yomu](https://github.com/sendyhalim/Yomu) - macOS用マンガ読み上げアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

### 🌙 スクリーンセーバー (10) <a id="screensaver"></a>
- [Aerial](https://github.com/JohnCoates/Aerial) - Apple TV用エアリアルスクリーンセーバー
...
- [Brooklyn](https://github.com/pedrommcarrasco/Brooklyn) - 2018年10月30日にAppleが公開したイベントをインスピレーションにしたスクリーンセーバー
...
- [Epoch Flip Clock Screensaver](https://github.com/chrstphrknwtn/epoch-flip-clock-screensaver) - Unixエポックタイムスタンプの反転時計スクリーンセーバー
...
- [Image-As-Wallpaper](https://github.com/ved62/Image-As-Wallpaper) - 画像の選択を簡単に行い、Macのデスクトップワールパーまたはスクリーンセーバーとして使用できるユーティリティアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Irvue](https://github.com/leonspok/Irvue-Screensaver) - macOS用スクリーンセーバー
...
- [Life Saver](https://github.com/amiantos/lifesaver) - コンウェイのゲームオブライフをSpriteKitで実装した抽象的なスクリーンセーバー
...
- [MinimalClock](https://github.com/mattiarossini/MinimalClock) - シンプルで洗練された時計を表示するスクリーンセーバー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://mattiarossini.github.io/MinimalClock/](https://mattiarossini.github.io/MinimalClock/)
...
- [MusaicFM](https://github.com/obrhoff/MusaicFM) - SpotifyおよびLast.fm用のiTunesスクリーンセーバーのクローン
...
- [Predator](https://github.com/vpeschenkov/Predator) - マニアックな時計スクリーンセーバー（macOS用）
...
- [The GitHub Matrix Screensaver](https://github.com/winterbe/github-matrix-screensaver) - GitHubマトリクススクリーンセーバー（macOS用）
...
### 🔒 セキュリティ (11) <a id="security"></a>
- [Cloaker](https://github.com/spieglt/cloaker) - シンプルなドラッグアンドドロップ、パスワードベースのファイル暗号化

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

  **Webサイト:** [https://adequate.systems/](https://adequate.systems/)
...
- [Cryptomator](https://github.com/cryptomator/cryptomator) - マルチプラットフォームでのクラウドファイルのクライアントサイド透明暗号化
  ...
  **Webサイト:** [https://cryptomator.org/](https://cryptomator.org/)

- [LuLu](https://github.com/objective-see/LuLu) - LuLuはmacOS用のファイアウォールアプリで、無許可（送信）ネットワークトラフィックをブロックする目的を持つ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [macOS GateKeeper Helper](https://github.com/wynioux/macOS-GateKeeper-Helper) - シンプルなmacOS GateKeeperスクリプト。GateKeeperの制御を助けるものです
...
- [SaneHosts](https://github.com/sane-apps/SaneHosts) - /etc/hostsを用いたシステムレベルの広告およびトラッカーブロッカー。200以上のカスタムブロッキングリストとタッチID保護を備えたアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://sanehosts.com](https://sanehosts.com)
...
- [Swifty](https://github.com/swiftyapp/swifty) - 無料かつオフラインのパスワードマネージャー

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

  **Webサイト:** [https://getswifty.pro](https://getswifty.pro)
...
- [VeraCrypt](https://github.com/veracrypt/VeraCrypt) - TrueCryptに基づく強力なディスク暗号化

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://www.veracrypt.fr](https://www.veracrypt.fr)

### 📤 ファイル共有 (11) <a id="sharing-files"></a>
- [Cyberduck](https://github.com/iterate-ch/cyberduck) - Cyberduckは、MacおよびWindows向けのオープンソースサーバーおよびクラウドストレージブラウザで、FTP、SFTP、WebDAV、Amazon S3、OpenStack Swift、Backblaze B2、Microsoft AzureおよびOneDrive、Google DriveおよびDropboxに対応

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://cyberduck.io](https://cyberduck.io)
...
- [Deluge](https://github.com/deluge-torrent/deluge) - 軽量かつプラットフォームを問わず動作するBitTorrentクライアント

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [Easy Share Uploader](https://github.com/Aries-Sciences-LLC/Easy-Share-Uploader) - 複数のサービスを通じて、ユーザーがローカルの画像をインターネットに簡単に公開できるアプリで、App Storeに登載

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://ariessciences.com/highlight?product=easy-share-uploader](https://ariessciences.com/highlight?product=easy-share-uploader)
...
- [mac2imgur](https://github.com/mileswd/mac2imgur) - 画像やスクリーンショットをImgurにアップロードするためのシンプルなMacアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [NitroShare](https://github.com/nitroshare/nitroshare-desktop) - デバイス間のファイルの転送

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://nitroshare.net](https://nitroshare.net)

- [qBittorrent](https://github.com/qbittorrent/qBittorrent) - QtベースのBitTorrentクライアント

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [Rhea](https://github.com/timonus/Rhea) - macOSのステータスバーに表示されるファイルやURLの共有アプリ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Soduto](https://github.com/soduto/Soduto) - SodutoはmacOS向けのKDEConnectに対応したアプリで、AirDropのような統合を提供し、スマートフォン、デスクトップ、タブレット間でファイルやクリップボードの共有を可能にする

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://soduto.com/](https://soduto.com/)

- [Transmission](https://github.com/transmission/transmission) - 公式Transmission BitTorrentクライアドリポジトリ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

- [Tribler](https://github.com/Tribler/tribler) - プライバシーを強化したBitTorrentクライアントで、P2Pコンテンツ発見に対応

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

### 👥 ソーシャルネットワーク (9) <a id="social-networking"></a>
- [Caprine](https://github.com/sindresorhus/caprine#features) - 美しく設計されたFacebook Messengerのデスクトップアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

- [Goofy](https://github.com/danielbuechele/goofy) - 非公式Facebook Messengerクライアント

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Leviathan](https://github.com/Swiftodon/Leviathan) - LeviathanはMastodonというソーシャルネットワーク向けのiOSおよびmacOS用クライアントアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Messenger](https://github.com/rsms/fb-mac-messenger) - FacebookのMessengerをデスクトップ向けにラップしたmacOSアプリ
...
- [Product Hunt](https://github.com/producthunt/producthunt-osx) - お気に入りの新製品やアプリを共有し、発見できる

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Quail](https://github.com/1000ch/quail) - 公式ではない [esa](https://esa.io)アプリ
...
- [Ramme](https://github.com/terkelg/ramme) - 非公式Instagramデスクトップアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript <img src='./icons/css-64.png' alt='CSS icon' title='CSS' height='16'/> CSS 

- [RedditOS](https://github.com/Dimillian/RedditOS) - macOS向けのSwiftUIベースのRedditクライアント
...
- [Simpo](https://github.com/KeliCheng/Simpo) - macOS メニューバーアプリでステータスを迅速に投稿
...
### 📡 ストリーミング (3) <a id="streaming"></a>
- [Galeri](https://github.com/michealparks/galeri) - 永遠に再生されるアートワークアプリ

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [OBS Studio](https://github.com/obsproject/obs-studio) - ライブストリーミングとスクリーン録画に使える無料かつオープンソースソフトウェア

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://obsproject.com/](https://obsproject.com/)
...
### ⚙️ システム (24) <a id="system"></a>
- [Apple Juice](https://github.com/raphaelhanneken/apple-juice) - macOS用の高度なバッテリー表示アプリ
...
- [AppPolice](https://github.com/AppPolice/AppPolice) - シンプルなUIを持つmacOSアプリで、実行中のプロセスのCPU使用量を迅速に制御可能
...
- [Clean-Me](https://github.com/Kevin-De-Koninck/Clean-Me) - 小さなmacOSアプリでシステムクリーンアップ（ログ、キャッシュなど）を行う
...
- [Diagnostics](https://github.com/macmade/Diagnostics) - DiagnosticsはmacOS上のアプリケーションの診断レポートを表示するアプリケーション
...
- [DisableMonitor](https://github.com/Eun/DisableMonitor) - Macのモニタを簡単に無効または有効にするアプリ
...
- [Fanny](https://github.com/DanielStormApps/Fanny) - 通知センターからMacのファン速度とCPU温度を確認
...
- [HoRNDIS](https://github.com/jwise/HoRNDIS) - Android USBターティングドライバー（macOS用）

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [Juice](https://github.com/brianmichel/Juice) - バッテリー情報の表示を少し面白くする
...
- [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) - Macが睡眠状態に移行しないように防ぐ
...
- [Latest](https://github.com/mangerlahn/Latest) - あなたが使うアプリの最新アップデートをすべて知らせるための小さなユーティリティアプリ
...
- [Loading](https://github.com/BonzaiThePenguin/Loading) - シンプルなネットワーク活動モニタリングアプリ（macOS用）
...
- [macOSLucidaGrande](https://github.com/LumingYin/macOSLucidaGrande) - Lucida GrandeをMacのシステムUIフォントに設定するための小さなユーティリティ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://github.com/LumingYin/macOSLucidaGrande/releases](https://github.com/LumingYin/macOSLucidaGrande/releases)
...
- [ProfileCreator](https://github.com/ProfileCreator/ProfileCreator) - macOSアプリで標準またはカスタマイズされた設定プロファイルを作成
...
- [Sloth](https://github.com/sveinbjornt/Sloth) - SlothはmacOSアプリで、システム上に実行中のすべてのアプリケーションが使用しているすべてのファイルとソケットの一覧を表示
...
- [Turbo Boost Switcher](https://github.com/rugarciap/Turbo-Boost-Switcher) - Turbo Boost Switcherは、Macコンピュータ向けの小さなアプリで、Turbo Boost機能を有効または無効にできる。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [VerticalBar](https://github.com/DeromirNeves/DockSeparator) - macOSアプリでドックに垂直バーを追加
...
- [Wireshark](https://gitlab.com/wireshark/wireshark/-/tree/master) - Wiresharkは世界で最も普及し、ネットワークプロトコルアナライザとして広く使われているツールです。ネットワークの細部まで確認できるだけでなく、多くの商業・非営利組織、政府機関、教育機関で実際の標準として採用されています

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C <code>c++</code> 

  **Webサイト:** [https://www.wireshark.org/](https://www.wireshark.org/)

### 📺 ターミナル (15) <a id="terminal"></a>
- [Alacritty](https://github.com/alacritty/alacritty) - マルチプラットフォーム対応、GPU加速されたターミナルエミュレーター
...
- [Bifrost](https://github.com/ishuah/bifrost) - シリアルポート通信用の小さなターミナルエミュレーター（macOS/Linux）。
...
- [Console](https://github.com/macmade/Console) - macOS用コンソールアプリ
...
- [Hyper](https://github.com/vercel/hyper) - ウェブ技術に基づいたターミナル。
...
- [iTerm 2](https://github.com/gnachman/iTerm2) - macOS用ターミナルエミュレーターで驚異的なことができる。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Kitty](https://github.com/kovidgoyal/kitty) - マルチプラットオーラ、高速、機能豊富、GPUベースのターミナルエミュレーター
...
- [OpenTerminal](https://github.com/es-kumagai/OpenTerminal) - macOSアプリで新しいFinderウィンドウを開き、アプリが起動したフォルダに現在のディレクトリを変更する。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Tabby](https://github.com/Eugeny/tabby) - 強力なクロスプラットフォームターミナルエミュレーターで、現代的なGUIを備え、SSH、シリアル、Telnet、SCPクライアントをサポート。
...
- [wallpapper](https://github.com/mczachurski/wallpapper) - wallpapperは、Mojave向けの動的ウォールパペを生成するコンソールアプリケーション。
...
### 🎚️ Touch Bar (6) <a id="touch-bar"></a>
- [Muse](https://github.com/xzzz9097/Muse) - Spotify制御機能にTouchBar対応。
...
- [MyTouchbarMyRules](https://github.com/toxblh/MTMR) - Touch Barを任意にカスタマイズできるアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Pock](https://github.com/pock/pock) - macOSのドックをTouch Barに表示。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://pock.app/](https://pock.app/)
...
- [Touch Bar Preview](https://github.com/touchbar/Touch-Bar-Preview) - 新しいMacBook ProのTouch Barにデザインを表示する小さなアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Touch Bar Simulator](https://github.com/sindresorhus/touch-bar-simulator) - 任意のMacでTouch Barを使用。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Touch Emoji](https://github.com/ilyalesik/touch-emoji) - MacBook ProのTouch Bar用のエモジ選択アプリ。
...
### 🛠️ ユーティリティ (112) <a id="utilities"></a>
- [ActivityWatch](https://github.com/ActivityWatch/activitywatch) - オープンソースの自動時間トラッカーで、デバイス上で過ごす時間を追跡。
...
- [Android tool for Mac](https://github.com/mortenjust/androidtool-mac) - iOSおよびAndroid向けのワンクリックスクリーンショット、動画録画、アプリインストール。
...
- [ArchiveMounter](https://github.com/ivoronin/ArchiveMounter) - ディスクイメージのようなアーカイブをマウント。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Balena Etcher](https://github.com/balena-io/etcher) - SDカードおよびUSBドライブにOSイメージを安全かつ簡単にフラッシュ。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://www.balena.io/etcher](https://www.balena.io/etcher)
...
- [BeardedSpice](https://github.com/beardedspice/beardedspice) - Macキーボードにあるメディアキーでウェブベースのメディアプレイヤーを制御。
...
- [Bitwarden](https://github.com/bitwarden/desktop) - 個人、チーム、ビジネス組織向けのクロスプラットフォームパスワード管理ソリューション。

  **Languages:** <img src='./icons/typescript-64.png' alt='TypeScript icon' title='TypeScript' height='16'/> TypeScript 

  **Webサイト:** [https://bitwarden.com/](https://bitwarden.com/)
...
- [Bitwarden Menu](https://github.com/jnsdrtlf/bitwarden-menubar) - メニューバーにBitwardenパスワードマネージャーを表示。
...
- [Buttercup Desktop](https://github.com/buttercup/buttercup-desktop) - macおよびその他のプラットフォーム向けのセキュアパスワードマネージャー
...
- [calibre](https://github.com/kovidgoyal/calibre) - クロスプラットフォーム対応の電子書籍マネージャー

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://calibre-ebook.com](https://calibre-ebook.com)

- [Catch](https://github.com/mipstian/catch/) - Catch: ブロードキャッチを簡単に行う

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Clear Clipboard Text Format](https://github.com/LumingYin/ClipboardClear) - クリップボードのテキストのフォーマットを簡単にクリアする「Clear Clipboard Text Format」

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://apps.apple.com/app/clear-clipboard-text-format/id1322855232](https://apps.apple.com/app/clear-clipboard-text-format/id1322855232)
...
- [CoreLocationCLI](https://github.com/fulldecent/corelocationcli) - デバイスの物理位置を取得し、標準出力に表示
...
- [CornerCal](https://github.com/ekreutz/CornerCal) - シンプルで洗練されたカレンダーと時計アプリ（macOS用）
...
- [Crypter](https://github.com/HR/Crypter) - Crypterは、革新的で便利かつ安全なクロスプラットオーネスの暗号アプリであり、パスワードの生成と管理を簡便にし、あなたが記憶する必要があるのは1つのビット、つまりマスターパスワードだけです
...
- [ECheck](https://github.com/josejuanqm/ECheck) - macOS用のEPUBファイルの妥当性を検証する小さなツール
...
- [Flying Carpet](https://github.com/spieglt/flyingcarpet) - ad-hoc WiFiを介したクロスプラットフォームファイル転送（AirDropに似たMac/Windows/Linux対応）
...
- [fselect](https://github.com/jhspetersson/fselect) - SQL構文を用いたファイル検索用コマンドラインツール

  **Languages:** <img src='./icons/rust-64.png' alt='Rust icon' title='Rust' height='16'/> Rust 

- [Funky](https://github.com/thecatalinstan/Funky) - Macのアプリごとに機能キーを簡単に切り替えることができます

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [GrandPerspective](https://git.code.sf.net/p/grandperspectiv/source) - ディスク使用量をツリーマップで可視化するための小型ユーティリティ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://grandperspectiv.sourceforge.net](https://grandperspectiv.sourceforge.net)
...
- [Gray](https://github.com/zenangst/Gray) - アプリごとに、ボタン一つで明るい表示と暗い表示のどちらかを選択できます
...
- [homebrew-cask](https://github.com/Homebrew/homebrew-cask) - macOSアプリケーション（バイナリ形式）の管理用CLIワークフロー

  **Languages:** <img src='./icons/ruby-64.png' alt='Ruby icon' title='Ruby' height='16'/> Ruby 

  **Webサイト:** [https://brew.sh/](https://brew.sh/)
...
- [iOScanX](https://github.com/alessiomaffeis/iOScanX) - 半自動化されたiOSアプリの分析および評価を行うCocoaアプリケーションです
...
- [Kap](https://github.com/wulkano/kap) - ウェブ技術で構築されたスクリーンレコーダーアプリケーションです

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [KeePassXC](https://github.com/keepassxreboot/keepassxc) - Windowsアプリケーション『Keepass Password Safe』のクロスプラットフォームコミュニティによるポートです

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [KeeWeb](https://github.com/keeweb/keeweb) - KeePassと互換性のあるクロスプラットオールパスワードマネージャーです

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [Keka](https://github.com/aonez/Keka) - Kekaは、機能が豊富なファイルアーカイブツールで、使いやすさの最高峰です

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.keka.io/en/](https://www.keka.io/en/)
...
- [Kyapchar](https://github.com/vishaltelangre/Kyapchar) - macOS用のシンプルなスクリーンおよびマイク音声レコーダーです
...
- [Lunar](https://github.com/alin23/lunar) - 外部ディスプレイ向けの知能型適応式明るさです
...
- [MacPacker](https://github.com/sarensw/MacPacker/) - macOS用のアーカイブマネージャー。抽出せずに（ネストされた）アーカイブをプレビューできます。単一ファイルを抽出できます。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://macpacker.app/](https://macpacker.app/)
...
- [MacPass](https://github.com/MacPass/MacPass) - ネイティブなmacOS用KeePassクライアント
...
- [Maria](https://github.com/shincurry/Maria) - macOS用aria2ダウンロードツールのネイティブアプリ／ウィジェット
...
- [Meme Maker](https://github.com/MemeMaker/Meme-Maker-Mac) - memeを作成するためのmacOS用Meme Makerアプリ
...
- [MiddleDrag](https://github.com/NullPointerDepressiveDisorder/MiddleDrag) - トラックパッドの3本指ジェスチャーによる中央クリックと中央ドラッグ
...
- [Monolingual](https://github.com/IngmarStein/Monolingual) - macOSから不要な言語リソースを削除
...
- [Mos](https://github.com/Caldis/Mos) - マウスのスクロールをスムーズにし、マウススクロールの方向を逆にする
...
- [nix-package-manager](https://github.com/NixOS/nix) - NixはHomebrewへの代替となる再現性のあるパッケージマネージャーで、8万以上のパッケージを提供

  **Languages:** <code>c++</code> <img src='./icons/shell-64.png' alt='Shell icon' title='Shell' height='16'/> Shell <code>nix</code> 

  **Webサイト:** [https://nixos.org/explore.html](https://nixos.org/explore.html)

- [Nmap](https://github.com/nmap/nmap) - Nmap - ネットワークマッパー

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://nmap.org](https://nmap.org)
...
- [Noti](https://github.com/jariz/Noti/) - macにAndroidの通知を受信（PushBulletで）
...
- [NVM](https://github.com/nvm-sh/nvm) - Nodeバージョンマネージャー
...
- [OpenCore Legacy Patcher](https://github.com/dortania/OpenCore-Legacy-Patcher) - OpenCore Legacy Patcherは、古いmacで新しいmacOSバージョンをインストールするためのツール

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

  **Webサイト:** [https://dortania.github.io/OpenCore-Legacy-Patcher/](https://dortania.github.io/OpenCore-Legacy-Patcher/)

- [OpenRocket](https://github.com/openrocket/openrocket) - OpenRocketは、モデルロケットとその飛行特性をモデル化・シミュレーションするためのクロスプラットフォームのユーティリティツール

  **Languages:** <img src='./icons/java-64.png' alt='Java icon' title='Java' height='16'/> Java 

  **Webサイト:** [https://openrocket.info/](https://openrocket.info/)

- [Padlock](https://github.com/padloc/padloc) - macOS用のシンプルでオープンソースのパスワードマネージャー

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

- [PB for Desktop](https://github.com/sidneys/pb-for-desktop) - macOS、WindowsおよびLinuxでネイティブなプッシュ通知を受信
...
- [PeaZip](https://github.com/peazip/PeaZip) - 200以上のフォーマットをサポートする無料ファイルアーカイブツールおよびオープンソースファイル圧縮・暗号化ツール

  **Languages:** <code>pascal</code> 

  **Webサイト:** [https://peazip.github.io/](https://peazip.github.io/)

- [PercentCalculator](https://github.com/cemolcay/PercentCalculator) - メニューバーに表示されるパーセンテージ計算アプリ
...
- [Plain Pasta](https://github.com/hisaac/PlainPasta) - クリップボードのテキストをプレーンテキストに変換
...
- [PlugNPlayMac](https://github.com/Piero24/PlugNPlayMac) - Macにデバイスを接続した際に自動化できるスクリプト

  **Languages:** <img src='./icons/shell-64.png' alt='Shell icon' title='Shell' height='16'/> Shell 

- [PowerShell](https://github.com/powershell/powershell) - PowerShellは、既存のツールと良好に連携するクロスプラットフォームの自動化および設定ツール／フレームワーク

  **Languages:** <img src='./icons/csharp-64.png' alt='C# icon' title='C#' height='16'/> C# 

- [Rugby](https://github.com/swiftyfinch/Rugby) - 🏈 CocoaPodsをキャッシュして、Xcodeプロジェクトの再構築とインデックス作成を速く

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://swiftyfinch.github.io/en/2021-03-09-rugby-story/](https://swiftyfinch.github.io/en/2021-03-09-rugby-story/)
...
- [ScreenCat](https://github.com/maxogden/screencat) - ScreenCatはスクリーン共有＋リモートコラボレーションアプリ
...
- [SlowQuitApps](https://github.com/dteoh/SlowQuitApps) - Command-Qにグローバルな遅延を追加して、誤ったアプリ終了を防ぐ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Smotrite](https://github.com/Lukentui/smotrite-app) - SmotriteはmacOS用のシステムモニタリングツールで、シンプルに動作します
...
- [Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - ローカルホストされたウェブアプリケーションで、PDFファイルに対してさまざまな操作を実行できます
  ...
  **Webサイト:** [stirlingpdf.com](https://github.com/serhii-londar/open-source-mac-os-apps/blob/7efc7fe4098982ef69accbe8d6e48601c6062357/stirlingpdf.com)
...
- [Telephone](https://github.com/64characters/Telephone) - macOS用のSIPソフトフォン

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [The Blockstack Browser](https://github.com/stacks-network/blockstack-browser) - Blockstackは、ユーザーが自らデータを所有できる分散型アプリ向けのインターネットです。Blockstackブラウザは、Blockstackインターネットを探索するためのツールです
...
- [ToTheTop](https://github.com/zenangst/ToTheTop) - スクリーンの上部へスクロールするための小さなmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [TRex](https://github.com/amebalabs/TRex) - TRexは、画像、YouTube動画、Zoom会議など、コピーできないテキストを簡単にコピーできる最も簡単なツールです。見られるなら、コピーできるのです。TRexは、OCRの魔法により、すべてのテキストをあなたのクリップボードに即座にコピーします

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://trex.ameba.co/](https://trex.ameba.co/)
...
- [wechsel](https://github.com/friedrichweise/wechsel) - キーボードでBluetooth接続を管理できます

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://wechsel.weise.io](https://wechsel.weise.io)
...
- [Wireshark](https://github.com/wireshark/wireshark) - Wiresharkは世界で最も普及し、ネットワークプロトコルアナライザとして広く使われているツールです。ネットワークの細部まで確認できるだけでなく、多くの商業・非営利組織、政府機関、教育機関で実際の標準として採用されています
...
- [Übersicht](https://github.com/felixhageloh/uebersicht) - あなたのマシンや世界の状況を常に監視できます

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

### 🔐 VPN／プロキシ (8) <a id="vpn--proxy"></a>
- [clashX](https://github.com/yichengchen/clashX) - Mac向けのClashベースのルールベースのカスタムプロキシ（GUI付き）

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [rvc-mac](https://github.com/riboseinc/cryptode-mac) - Ribose VPNクライアント macOS メニューアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) - 次世代のShadowsocksX

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Specht](https://github.com/zhuhaow/Specht) - macOS用のネットワーク拡張機能で構築されたルールベースのプロキシアプリ
...
- [SpechtLite](https://github.com/zhuhaow/SpechtLite) - macOS用ルールベースのプロキシアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick) - TunnelblickはmacOS向けOpenVPNのグラフィカルユーザーインターフェースです
...
- [WireGuard](https://git.zx2c4.com/wireguard-apple/) - 高速・現代的・安全なVPNトンネル

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://www.wireguard.com/](https://www.wireguard.com/)

### 🎬 動画 (20) <a id="video"></a>
- [Acid.Cam.v2.OSX](https://github.com/lostjared/Acid.Cam.v2.OSX) - Acid Cam v2 for macOSは動画を歪ませてアートを作成します

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [AppleEvents](https://github.com/insidegui/AppleEvents) - macOS用の非公式Apple Eventsアプリ

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Conferences.digital](https://github.com/zagahr/Conferences.digital) - 無料で、あなたの好きな開発者会議の最新・最強の動画をMacで視聴できる最適な方法
...
- [Datamosh](https://github.com/maelswarm/Datamosh) - macOSで動画をDatamoshします
...
- [Face Data](https://github.com/xiaohk/FaceData) - 動画からランドマークを自動でアノテーションするmacOSアプリ
...
- [Gifted](https://github.com/vdel26/gifted) - 短い動画を簡単にアニメーションGIFに変換します

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [GNU Gatekeeper](https://github.com/willamowius/gnugk) - H.323端末向けのビデオ会議サーバー

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

  **Webサイト:** [https://www.gnugk.org](https://www.gnugk.org)

- [HandBrake](https://github.com/HandBrake/HandBrake) - HandBrakeはLinux、Mac、Windowsで利用可能な動画変換ソフトです
...
- [MenuTube](https://github.com/edanchenkov/MenuTube) - YouTubeをmacOSのメニューバーに表示！
...
- [OpenShot](https://github.com/OpenShot/openshot-qt) - 使いやすく、学習しやすく、驚くほど強力な動画編集ソフト

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [Quick Caption](https://github.com/LumingYin/Caption) - 時間コードを手動で入力せずに、字幕ファイル（SRT、ASS、FCPXML）を生成できます

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://apps.apple.com/app/quick-caption/id1363610340](https://apps.apple.com/app/quick-caption/id1363610340)
...
- [QuickLook Video](https://github.com/Marginal/QLVideo) - このパッケージにより、macOSのFinderがほとんどの動画ファイルのサムネイル、静的QuickLookプレビュー、カバー画像、メタデータを表示できます

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Subler](https://bitbucket.org/galad87/subler/src) - Sublerはmp4ファイルをマージし、タグ付けするmacOSアプリです

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

  **Webサイト:** [https://subler.org](https://subler.org)

- [Vid Quiz Creator](https://github.com/sahil-a/vidquizcreator) - 動画再生中にクイズを挿入し、LISNR APIを使って受信デバイスに動画を再生するmacOSアプリ

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [VLC](https://github.com/videolan/vlc) - VLCは無料かつオープンソースのマルチプラットフォームマルチメディアプレイヤーです

  **Languages:** <img src='./icons/c-64.png' alt='C icon' title='C' height='16'/> C 

  **Webサイト:** [https://www.videolan.org/vlc/](https://www.videolan.org/vlc/)

- [WebTorrent Desktop](https://github.com/webtorrent/webtorrent-desktop) - ストリーミングトランツアプリ。Mac、Windows、Linuxに対応。
...
- [Yoda](https://github.com/whoisandy/yoda) - YouTubeから動画をブラウズ・ダウンロードできる、便利なmacOSアプリ。

  **Languages:** <img src='./icons/javascript-64.png' alt='JavaScript icon' title='JavaScript' height='16'/> JavaScript 

### 🖥️ 壁紙 (12) <a id="wallpaper"></a>
- [500-mac-wallpaper](https://github.com/markcheeky/500-mac-wallpaper) - 500px.comから写真を自動ダウンロードする、シンプルなmacOSステータスバー用アプリ。ダウンロード先フォルダは、デスクトップの壁紙として設定可能。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

- [Artify](https://github.com/NghiaTranUIT/artify-macos) - 18世紀の芸術を誰にでも届ける、macOS用アプリ。
...
- [ArtWall](https://github.com/JustinFincher/ASWP-for-macOS) - artwork.rssからArtStationを壁紙として設定。

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [BingPaper](https://github.com/pengsrc/BingPaper) - macOSで毎日ビングの写真を壁紙として表示。
...
- [Desktop Wallpaper Switcher](https://github.com/VioletGiraffe/desktop-wallpaper-switcher) - Windows／Linux／macOS用のデスクトップ壁紙管理・切り替えツール。

  **Languages:** <img src='./icons/cpp-64.png' alt='C++ icon' title='C++' height='16'/> C++ 

- [Equinox](https://github.com/rlxone/Equinox) - Equinoxは、macOS用の動的壁紙を作成できるアプリ。

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://equinoxmac.com](https://equinoxmac.com)
...
- [Muzei](https://github.com/naman14/Muzei-macOS) - macOS用のMuzei壁紙アプリ。
...
- [pyDailyChanger](https://github.com/IngoMeyer441/pyDailyChanger) - pyDailyChangerは、毎日壁紙を変更するプログラム。

  **Languages:** <img src='./icons/python-64.png' alt='Python icon' title='Python' height='16'/> Python 

- [Satellite Eyes](https://github.com/tomtaylor/satellite-eyes) - macOSで、衛星画像をデスクトップ壁紙として自動設定できるアプリ。
...
- [Sunscreen](https://github.com/davidcelis/Sunscreen) - Sunscreenは、日出・日没に応じてデスクトップ壁紙を変更する、楽しい軽量アプリ。
...
- [WallpaperMenu](https://github.com/diogosantos/WallpaperMenu) - ウェブ上の美しい画像をナビゲートし、デスクトップ画像として設定できるmacOSメニューバーアプリ。

  **Languages:** <img src='./icons/ruby-64.png' alt='Ruby icon' title='Ruby' height='16'/> Ruby 

### 🪟 ウィンドウ管理 (16) <a id="window-management"></a>
- [AltTab](https://github.com/lwouis/alt-tab-macos) - AltTabは、WindowsのAlt+Tabの力をmacOSに導入する。
  ...
  **Webサイト:** [https://alt-tab-macos.netlify.app/](https://alt-tab-macos.netlify.app/)
...
- [AltTab](https://github.com/lwouis/alt-tab-macos) - macOSで、Windows風のAlt+Tabによるアプリ間切り替えを実現。
...
- [Amethyst](https://github.com/ianyh/Amethyst) - macOS用の自動タイルウィンドウマネージャー。
...
- [AppGrid](https://github.com/mjolnirapp/AppGrid) - macOS用のグリッドベースキーボードウィンドウマネージャー。
...
- [Desktop Profiles](https://github.com/mamiksik/Desktop-Profiles) - macOS用の革新的なデスクトップ／ウィンドウマネージャー。
...
- [Hammerspoon](https://github.com/Hammerspoon/hammerspoon) - Luaで構成された驚異的なmacOSデスクトップ自動化
...
- [Loop](https://github.com/MrKai77/Loop) - ウィンドウ管理を美しく実現
...
- [Phoenix](https://github.com/kasper/phoenix) - JavaScriptでスクリプト可能な軽量macOSウィンドウとアプリ管理ツール
...
- [Rectangle](https://github.com/rxhanson/Rectangle) - Swiftで書かれたSpectacleをベースにしたウィンドウマネージャー

  **Languages:** <img src='./icons/swift-64.png' alt='Swift icon' title='Swift' height='16'/> Swift 

  **Webサイト:** [https://rectangleapp.com](https://rectangleapp.com)

- [ShiftIt](https://github.com/fikovnik/ShiftIt) - ウィンドウのサイズと位置の管理
...
- [Slate](https://github.com/jigish/slate) - DivvyやSizeUpに類似したウィンドウ管理アプリSlate

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Spectacle](https://github.com/eczarny/spectacle) - マウスを使わずにウィンドウを整理できるSpectacle

  **Languages:** <img src='./icons/objective-c-64.png' alt='Objective-C icon' title='Objective-C' height='16'/> Objective-C 

- [Window Glue](https://github.com/Conxt/WindowGlue) - 2つのウィンドウを結合させ、それらが（ほとんど）1つのウィンドウのように動作するシンプルなmacOSメニューバーツール
...
- [Yabai](https://github.com/koekeishiya/yabai) - 二分空間分割をベースにしたmacOS用タイルウィンドウマネージャー
