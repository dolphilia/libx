...
- [Carbon Engineering](https://carbonengineering.com/) | Canada | 2009
  ...
  Direct Air Capture 技術で既存の CO<sub>2</sub> を空気から直接回収し、そのガスを航空機、トラック、船舶向けのカーボンニュートラルな合成燃料に使うことを目指します。Carbon Engineering は、複数の政府・持続可能性重視の機関と、Bill Gates、オイルサンド業界の Norman Murray Edwards を含む民間投資家から資金提供を受けています。
...
- [ClimateTechList](https://www.climatetechlist.com/) - ソフトウェアエンジニア向けの、約 50 社のクライメートテック企業を集めたリスト。各企業、ソフトウェア上の影響、気候への影響を説明します。
- [Breakthrough Energy Ventures](https://www.b-t.energy/) - Bill Gates と民間投資家グループの支援を受け、10 億ドル超のコミット済み資本で気候変動の阻止に役立つ企業を構築するベンチャーファンド。
- [Carbon Badge](https://carbon-badge.com) - Sustainable Web Design Model v4 に基づくウェブサイトのカーボンフットプリント計算機。
- [Clean Tech Finland](http://www.cleantechfinland.com/web/cleantech) - フィンランドのクリーンテック企業ハブ。
- [Clean Tech Sweden](https://swedishcleantech.com/) - スウェーデンのクリーンテック企業ハブ。
- [r/ClimateActionPlan](https://www.reddit.com/r/ClimateActionPlan/) - 気候変動に直面する人々に希望を与えるサブレディット。
- [Climate Choice](https://climatechoice.co/) - 気候変動に関する教育情報と、削減のために実行可能なガイドを含む非営利プロジェクト。
- [DPP Tool](https://dpp-tool.com) - EU ESPR 規制への準拠に向けたデジタル製品パスポート生成ツール。
- [Greenwashing Checker](https://greenwashing-checker.com) - 企業のサステナビリティ主張におけるグリーンウォッシングを検出するツール。
- [Mattermore.io](https://www.mattermore.io/) - AI・データサイエンスで気候変動の逆転を目指す企業を紹介するニュースレター。新しい取り組み・就業機会の発見に役立ち、毎週配信されます。
- [Norrsken Foundation](https://www.norrsken.org/) - 社会に前向きな影響を与える組織を支援・投資するスウェーデンの財団。

## 研究

- [Environmental Protection Agency](https://www.epa.gov/climate-research) - 気候変動の影響と解決策に関する研究。
- [Intergovernmental Panel on Climate Change](https://www.ipcc.ch/library/) - 気候変動に関連する科学を評価する国際連合の機関。
- [Mercator Research Institute on Global Commons and Climate Change](https://www.mcc-berlin.net/en.html) - 持続可能な開発と人間の福祉を高めるため、グローバル・コモンズを統治する解決策志向の政策経路を提供。
- [NASA climate](http://climate.nasa.gov/) - 地球の重要な兆候、事実、解決策。
- [U.N Climate Change National Inventory Submissions](https://unfccc.int/process-and-meetings/transparency-and-reporting/reporting-and-review-under-the-convention/greenhouse-gas-inventories-annex-i-parties/national-inventory-submissions-2019) - 複数の国連加盟国の国別気候報告書を含みます。2003 年以降のデータがあります。

## ライセンス

この作品とすべての貢献は、[CC0 1.0](https://github.com/nglgzz/awesome-clean-tech/blob/763f76ede222c7e9c652d57a3085a5e802e9ed31/LICENSE) の条件に基づきパブリックドメインへ提供されます。
