...
- [Awesome DeepSeek Agent](https://github.com/deepseek-ai/awesome-deepseek-agent): DeepSeek's official setup guides for integrating its models with coding agents including Claude Code, Codex, Cline, OpenCode, and Pi.
...
Suggestions are welcome, but this list is intentionally selective. Read [the contribution guide](https://github.com/owainlewis/awesome-artificial-intelligence/blob/ab1c3cceef8ab906586505a7a7a293f434280862/CONTRIBUTING.md) and [the curation policy](https://github.com/owainlewis/awesome-artificial-intelligence/blob/ab1c3cceef8ab906586505a7a7a293f434280862/CURATION.md) before opening an issue or pull request.
