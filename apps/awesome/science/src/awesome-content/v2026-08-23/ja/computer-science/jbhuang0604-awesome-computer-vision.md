...
#### コンピュータービジョン
* [Computer Vision:  Models, Learning, and Inference](http://www.computervisionmodels.com/) - シモン・J・D・プリンス 2012
* [Computer Vision: Theory and Application](http://szeliski.org/Book/) - リック・ゼリスキー 2010
* [Computer Vision: A Modern Approach (2nd edition)](http://www.amazon.com/Computer-Vision-Modern-Approach-2nd/dp/013608592X/ref=dp_ob_title_bk) - デイビッド・フォースティとジャン・ポンス 2011
* [Multiple View Geometry in Computer Vision](http://www.robots.ox.ac.uk/~vgg/hzbook/) - リチャード・ハーレティとアンデュー・ジッザーマン 2004
* [Computer Vision](http://www.amazon.com/Computer-Vision-Linda-G-Shapiro/dp/0130307963) - リンダ・G・シャピロ 2001
* [Vision Science: Photons to Phenomenology](http://www.amazon.com/Vision-Science-Phenomenology-Stephen-Palmer/dp/0262161834/) - ステファン・E・パルマー 1999
* [Visual Object Recognition synthesis lecture](http://www.morganclaypool.com/doi/abs/10.2200/S00332ED1V01Y201103AIM011) - クリスティン・グラウマンとバスタイン・リーブ 2011
* [Computer Vision for Visual Effects](http://cvfxbook.com/) - リチャード・J・ラドケ 2012
* [High dynamic range imaging: acquisition, display, and image-based lighting](http://www.amazon.com/High-Dynamic-Range-Imaging-Second/dp/012374914X) - レインハート、E．、ハイドリッヒ、W．、デベック、P．、パットナイク、S．、ワード、G．、ミスコフスキ、K． 2010
* [Numerical Algorithms: Methods for Computer Vision, Machine Learning, and Graphics](https://people.csail.mit.edu/jsolomon/share/book/numerical_book.pdf) - ジューストイン・ソロモン 2015
* [Image Processing and Analysis](https://www.amazon.com/Processing-Analysis-Activate-Learning-Engineering/dp/1285179528) - スタン・ビッチフィールド 2018
* [Computer Vision, From 3D Reconstruction to Recognition](http://web.stanford.edu/class/cs231a/) - シルビオ・サバレセ 2018

<a id="opencv-programming"></a>
#### OpenCVプログラミング
* [Learning OpenCV: Computer Vision with the OpenCV Library](http://www.amazon.com/Learning-OpenCV-Computer-Vision-Library/dp/0596516134) - ギャリー・ブラドスキーとアデリアン・カーラー
* [Practical Python and OpenCV](https://www.pyimagesearch.com/practical-python-opencv/) - アデリアン・ローズブロック
* [OpenCV Essentials](http://www.amazon.com/OpenCV-Essentials-Oscar-Deniz-Suarez/dp/1783984244/ref=sr_1_1?s=books&ie=UTF8&qid=1424594237&sr=1-1&keywords=opencv+essentials#) - オスカル・デニス・スウアレス、マリア・デル・ミラゴロ・フェルナンデス・カルロブレス、ノエリア・ヴァレス・エンアノ、グロリア・ブエノ・ガルシア、イスマエル・セラノ・グラシア

<a id="machine-learning"></a>
#### 機械学習
* [Pattern Recognition and Machine Learning](http://research.microsoft.com/en-us/um/people/cmbishop/prml/index.htm) - クリストファー・M・バイシップ 2007
* [Neural Networks for Pattern Recognition](http://www.engineering.upm.ro/master-ie/sacpi/mat_did/info068/docum/Neural%20Networks%20for%20Pattern%20Recognition.pdf) - クリストファー・M・バイシップ 1995
* [Probabilistic Graphical Models: Principles and Techniques](http://pgm.stanford.edu/) - ダフネ・コラーとニル・フリードマン 2009
* [Pattern Classification](http://www.amazon.com/Pattern-Classification-2nd-Richard-Duda/dp/0471056693) - ペーター・E・ハート、デイビッド・G・ストーク、リチャード・O・ダダ 2000
* [Machine Learning](http://www.amazon.com/Machine-Learning-Tom-M-Mitchell/dp/0070428077/) - トム・M・ミッチェル 1997
* [Gaussian processes for machine learning](http://www.gaussianprocess.org/gpml/) - カル・エドワード・ラスマンとクリス・K・I・ウィルズ 2005
* [Learning From Data](https://work.caltech.edu/telecourse.html)- ヤサーサ・アブ・モスファ、マリク・マグドン・イズマイルおよびハスアン・ティエン・リン 2012
* [Neural Networks and Deep Learning](http://neuralnetworksanddeeplearning.com/) - マイケル・ニールセン 2014
* [Bayesian Reasoning and Machine Learning](http://www.cs.ucl.ac.uk/staff/d.barber/brml/) - ダビッド・バーバー、カミブリッジ大学出版、2012

<a id="fundamentals"></a>
#### 基礎
 * [Linear Algebra and Its Applications](http://www.amazon.com/Linear-Algebra-Its-Applications-4th/dp/0030105676/ref=sr_1_4?ie=UTF8&qid=1421433773&sr=8-4&keywords=Linear+Algebra+and+Its+Applications) - ジルバート・ストラング 1995

<a id="courses"></a>
## 講座

<a id="computer-vision-1"></a>
#### コンピュータービジョン
 * [EENG 512 / CSCI 512 - Computer Vision](http://inside.mines.edu/~whoff/courses/EENG512/) - ウィリアム・ホフ（コロラド工科大学）
 * [Visual Object and Activity Recognition](https://sites.google.com/site/ucbcs29443/) - アレクセイ・A・エフロスおよびテイバー・ダレル（カリフォルニア大学バークレー校）
 * [Computer Vision](http://courses.cs.washington.edu/courses/cse455/12wi/) - スティーブ・シッツ（ワシントン大学）
 * Visual Recognition [Spring 2016](http://vision.cs.utexas.edu/381V-spring2016/), [Fall 2016](http://vision.cs.utexas.edu/381V-fall2016/) - クリスティン・グラーマン（UTオースティン）
 * [Language and Vision](http://www.tamaraberg.com/teaching/Spring_15/) - タマラ・ベルグ（ノースカロライナ大学チャペルヒル）
 * [Convolutional Neural Networks for Visual Recognition](http://vision.stanford.edu/teaching/cs231n/) - フェイ・フェイ・リおよびアンデル・カーパティ（スタンフォード大学）
 * [Computer Vision](http://cs.nyu.edu/~fergus/teaching/vision/index.html) - ロブ・フェグルス（NYU）
 * [Computer Vision](https://courses.engr.illinois.edu/cs543/sp2015/) - デレク・ホイエム (UIUC)
 * [Computer Vision: Foundations and Applications](http://vision.stanford.edu/teaching/cs131_fall1415/index.html) - カランイット・グリル・スポクターおよびフェイ・フェイ・リ（スタンフォード大学）
 * [High-Level Vision: Behaviors, Neurons and Computational Models](http://vision.stanford.edu/teaching/cs431_spring1314/) - フェイ・フェイ・リ（スタンフォード大学）
 * [Advances in Computer Vision](http://6.869.csail.mit.edu/fa15/) - アントニオ・トゥラルバおよびビル・フリーマン（MIT）
 * [Computer Vision](http://www.vision.rwth-aachen.de/course/11/) - バスティアン・リーブ（RWTHアケン大学）
 * [Computer Vision 2](http://www.vision.rwth-aachen.de/course/9/) - バスティアン・リーブ（RWTHアケン大学）
 * [Computer Vision](http://klewel.com/conferences/epfl-computer-vision/) パスカル・フア（EPFL）:
 * [Computer Vision 1](http://cvlab-dresden.de/courses/computer-vision-1/) カルステン・ローテル（TU ドレスデン）
 * [Computer Vision 2](http://cvlab-dresden.de/courses/CV2/) カルステン・ローテル（TU ドレスデン）
 * [Multiple View Geometry](https://youtu.be/RDkwklFGMfo?list=PLTBdjV_4f-EJn6udZ34tht9EVIW7lbeo4) ダニエル・クレマース（TU ミュンヘン）




<a id="computational-photography"></a>
#### コンピュテーショナルフォトグラフィ
* [Image Manipulation and Computational Photography](http://inst.eecs.berkeley.edu/~cs194-26/fa14/) - アレクセイ・ア・エフロス（UC ベルシ）
* [Computational Photography](http://graphics.cs.cmu.edu/courses/15-463/2012_fall/463.html) - アレクセイ・ア・エフロス（CMU）
* [Computational Photography](https://courses.engr.illinois.edu/cs498dh3/) - デレク・ホイエム (UIUC)
* [Computational Photography](http://cs.brown.edu/courses/csci1290/) - ジェームズ・ハース（ブロウン大学）
* [Digital & Computational Photography](http://stellar.mit.edu/S/course/6/sp12/6.815/) - フロド・ドゥラン（MIT）
* [Computational Camera and Photography](http://ocw.mit.edu/courses/media-arts-and-sciences/mas-531-computational-camera-and-photography-fall-2009/) - ラメシュ・ラスカー（MIT メディアラボ）
* [Computational Photography](https://www.udacity.com/course/computational-photography--ud955) - イーファン・エッサ（ジョージア・テック）
* [Courses in Graphics](http://graphics.stanford.edu/courses/) - スタンフォード大学
* [Computational Photography](http://cs.nyu.edu/~fergus/teaching/comp_photo/index.html) - ロブ・フェグルス（NYU）
* [Introduction to Visual Computing](http://www.cs.toronto.edu/~kyros/courses/320/) - キロス・クトゥラコス（トロント大学）
* [Computational Photography](http://www.cs.toronto.edu/~kyros/courses/2530/) - キロス・クトゥラコス（トロント大学）
* [Computer Vision for Visual Effects](https://www.ecse.rpi.edu/~rjradke/cvfxcourse.html) - リッチ・ラドケ（レンセラーラー工科大学院）
* [Introduction to Image Processing](https://www.ecse.rpi.edu/~rjradke/improccourse.html) - リッチ・ラドケ（レンセラーラー工科大学院）

<a id="machine-learning-and-statistical-learning"></a>
#### 機械学習と統計学習
 * [Machine Learning](https://www.coursera.org/learn/machine-learning) - アンダーウィン・ング（スタンフォード大学）
 * [Learning from Data](https://work.caltech.edu/telecourse.html) - ヤーザー・S・アブ・モスファ（カーティン）
 * [Statistical Learning](https://class.stanford.edu/courses/HumanitiesandScience/StatLearning/Winter2015/about) - トレバー・ハスティとロブ・ティブシラニ（スタンフォード大学）
 * [Statistical Learning Theory and Applications](http://www.mit.edu/~9.520/fall14/) - トマソ・ポッジョ、ロレンツォ・ロスアッソ、カルロ・シリベート、チャーリー・フログナー、ジオルギオス・エヴァンゲロポロス、ベン・ディーン（MIT）
 * [Statistical Learning](http://www.stat.rice.edu/~gallen/stat640.html) - ジェネーバ・アレン（ライス大学）
 * [Practical Machine Learning](http://www.cs.berkeley.edu/~jordan/courses/294-fall09/) - マイケル・ジョーダン (UC ベルシーバ)
 * [Course on Information Theory, Pattern Recognition, and Neural Networks](http://videolectures.net/course_information_theory_pattern_recognition/) - デイビッド・マッキ（カミブリッジ大学）
 * [Methods for Applied Statistics: Unsupervised Learning](http://web.stanford.edu/~lmackey/stats306b/) - レスター・マッキー（スタンフォード）
 * [Machine Learning](http://www.robots.ox.ac.uk/~az/lectures/ml/index.html) - アンデュー・ジッザーマン（オックスフォード大学）
 * [Intro to Machine Learning](https://www.udacity.com/course/intro-to-machine-learning--ud120) - セバスティアン・トゥーン（スタンフォード大学）
 * [Machine Learning](https://www.udacity.com/course/machine-learning--ud262) - チャールズ・イズベル、マイケル・リットマン（ジョージアテック）
 * [(Convolutional) Neural Networks for Visual Recognition](https://cs231n.github.io/) - フェイ・フィー・リ、アンデル・カーファティ、ジューストイン・ジョンソン（スタンフォード大学）
 * [Machine Learning for Computer Vision](https://youtu.be/QZmZFeZxEKI?list=PLTBdjV_4f-EIiongKlS9OKrBEp8QR47Wl) - ルドルフ・トライベル（ミュンヘン工科大学）



<a id="optimization"></a>
#### 最適化
 * [Convex Optimization I](http://stanford.edu/class/ee364a/) - ステファン・ボード（スタンフォード大学）
 * [Convex Optimization II](http://stanford.edu/class/ee364b/) - ステファン・ボード（スタンフォード大学）
 * [Convex Optimization](https://class.stanford.edu/courses/Engineering/CVX101/Winter2014/about) - ステファン・ボード（スタンフォード大学）
 * [Optimization at MIT](http://optimization.mit.edu/classes.php) - （MIT）
 * [Convex Optimization](http://www.stat.cmu.edu/~ryantibs/convexopt/) - ライアン・ティブシラン（CMU）

<a id="papers"></a>
## 論文

<a id="conference-papers-on-the-web"></a>
#### ウェブ上のカンファレンス論文
 * [CVPapers](http://www.cvpapers.com/) - ウェブ上のコンピュータビジョン論文
 * [SIGGRAPH Paper on the web](http://kesen.realtimerendering.com/) - ウェブ上のグラフィックス論文
 * [NIPS Proceedings](http://papers.nips.cc/) - ウェブ上のNIPS論文
 * [Computer Vision Foundation open access](http://www.cv-foundation.org/openaccess/menu.py)
 * [Annotated Computer Vision Bibliography](http://iris.usc.edu/Vision-Notes/bibliography/contents.html) - ケイフ・プライス（USC）
 ...
 * [List of Computer Vision models](https://github.com/shubham-shahh/Open-Source-Models) これらのモデルはカスタムオブジェクトで訓練されている

<a id="tutorials-and-talks"></a>
## チュートリアルと講演

<a id="computer-vision-2"></a>
#### コンピュータービジョン
 * [Computer Vision Talks](http://www.computervisiontalks.com/) - コンピュータビジョンに関する講義、キーノーティ、パネルディスカッション
 * [The Three R's of Computer Vision](https://www.youtube.com/watch?v=Mqg6eorYRIQ) - ジテンダ・マリク（カリフォルニア大学バークレー校）2013
 * [Applications to Machine Vision](http://videolectures.net/epsrcws08_blake_amv/) - アンダーウィ・ブレック（マイクロソフト研究センター）2008
 * [The Future of Image Search](http://videolectures.net/kdd08_malik_fis/?q=image) - ジテンダ・マリク（カリフォルニア大学バークレー校）2008
 * [Should I do a PhD in Computer Vision?](https://www.youtube.com/watch?v=M17oGxh3Ny8) - ファティ・ポリクリ（オーストラリア国立大学）
...
<a id="recent-conference-talks"></a>
#### 最近のカンファレンス講演
- [CVPR 2015](http://www.pamitc.org/cvpr15/) - 2015年6月
- [ECCV 2014](http://videolectures.net/eccv2014_zurich/) - 2014年9月
- [CVPR 2014](http://techtalks.tv/cvpr-2014-oral-talks/) - 2014年6月
- [ICCV 2013](http://techtalks.tv/iccv2013/) - 2013年12月
- [ICML 2013](http://techtalks.tv/icml/2013/) - 2013年7月
- [CVPR 2013](http://techtalks.tv/cvpr2013/) - 2013年6月
- [ECCV 2012](http://videolectures.net/eccv2012_firenze/) - 2012年10月
- [ICML 2012](http://techtalks.tv/icml/2012/orals/) - 2012年6月
- [CVPR 2012](http://techtalks.tv/cvpr2012webcast/) - 2012年6月

<a id="3d-computer-vision"></a>
#### 3Dコンピュータービジョン
 * [3D Computer Vision: Past, Present, and Future](https://www.youtube.com/watch?v=kyIzMr917Rc) - スティーブ・シッツ（ワシントン大学）2011
 * [Reconstructing the World from Photos on the Internet](https://www.youtube.com/watch?v=04Kgg3QEXFI) - スティーブ・シッツ（ワシントン大学）2013

<a id="internet-vision"></a>
#### インターネットビジョン
 * [The Distributed Camera](http://www.technologyreview.com/video/426265/meet-2011-tr35-winner-noah-snavely/) - ノア・スナヴェリ（コロンビア大学）2011
 * [Planet-Scale Visual Understanding](https://www.youtube.com/watch?v=UHkCa9-Z1Ps) - ノア・スナヴェリ（コロンビア大学）2014
 * [A Trillion Photos](https://www.youtube.com/watch?v=6MWEfpKUfRc) - スティーブ・シッツ（ワシントン大学）2013

<a id="computational-photography-1"></a>
#### コンピュテーショナルフォトグラフィ
 * [Reflections on Image-Based Modeling and Rendering](https://www.youtube.com/watch?v=j90_0Ndk7XM) - リチャード・セルイスキ（マイクロソフト研究センター）2013
 * [Photographing Events over Time](https://www.youtube.com/watch?v=ZvPaHZZVPRk) - ウィリアム・T・フリーマン（MIT）2011
 * [Old and New algorithm for Blind Deconvolution](http://videolectures.net/nipsworkshops2011_weiss_deconvolution/) -  ヤイール・ウェイス（エルサレムのヘブライ大学）2011
 * [A Tour of Modern "Image Processing"](http://videolectures.net/nipsworkshops2010_milanfar_tmi/) -  ペイマン・ミランファール（カリフォルニア大学サンタクララ校／グーグル）2010
 * [Topics in image and video processing](http://videolectures.net/mlss07_blake_tiivp/) アンダーウィン・ブレック（マイクロソフト・リサーチ）2007
 * [Computational Photography](https://www.youtube.com/watch?v=HJVNI0mkmqk) - ウィリアム・T・フリーマン（MIT）2012
 * [Revealing the Invisible](https://www.youtube.com/watch?v=_BWnIQY_X98) - フリド・ドゥラン（MIT）2012
 * [Overview of Computer Vision and Visual Effects](https://www.youtube.com/watch?v=rE-hVtytT-I) - リッチ・ラドケ（レンセラーラ大学）2014

<a id="learning-and-vision"></a>
#### 学習とビジョン
 * [Where machine vision needs help from machine learning](http://videolectures.net/colt2011_freeman_help/?q=computer%20vision) - ウィリアム・T・フリーマン（MIT）2011
 * [Learning in Computer Vision](http://videolectures.net/mlss08au_lucey_linv/) - シモン・ルシー（CMU）2008
 * [Learning and Inference in Low-Level Vision](http://videolectures.net/nips09_weiss_lil/?q=computer%20vision) - ヤイール・ウェイス（エルサレムのヘブライ大学）2009

<a id="object-recognition"></a>
#### 物体認識
 * [Object Recognition](http://research.microsoft.com/apps/video/dl.aspx?id=231358) - ラリー・ジンク（マイクロソフト・リサーチ）
 * [Generative Models for Visual Objects and Object Recognition via Bayesian Inference](http://videolectures.net/mlas06_li_gmvoo/?q=Fei-Fei%20Li) - フェイ・フェイ・リ（スタンフォード大学）

<a id="graphical-models"></a>
#### グラフィカルモデル
 * [Graphical Models for Computer Vision](http://videolectures.net/uai2012_felzenszwalb_computer_vision/?q=computer%20vision) - ペドロ・フェルツンズワルブ（ブロウン大学）2012
 * [Graphical Models](http://videolectures.net/mlss09uk_ghahramani_gm/) - ズービン・ガハラマニ（カムブリッジ大学）2009
 * [Machine Learning, Probability and Graphical Models](http://videolectures.net/mlss06tw_roweis_mlpgm/) - サム・ロービス（NYU）2006
 * [Graphical Models and Applications](http://videolectures.net/mlss09us_weiss_gma/?q=Graphical%20Models) -  ヤイール・ウェイス（エルサレムのヘブライ大学）2009

<a id="machine-learning-1"></a>
#### 機械学習
 * [A Gentle Tutorial of the EM Algorithm](https://nikola-rt.ee.washington.edu/people/bulyko/papers/em.pdf) - ジェフ・A・ビルメス（カリフォルニア大学バークレー校）1998
 * [Introduction To Bayesian Inference](http://videolectures.net/mlss09uk_bishop_ibi/) - クリスティアン・ビショップ（マイクロソフト・リサーチ）2009
 * [Support Vector Machines](http://videolectures.net/mlss06tw_lin_svm/) - チョン・ジェン・リン（台湾国立大学）2006
 * [Bayesian or Frequentist, Which Are You? ](http://videolectures.net/mlss09uk_jordan_bfway/) - マイケル・I・ジョーダン（カリフォルニア大学バークレー校）

<a id="optimization-1"></a>
#### 最適化
 * [Optimization Algorithms in Machine Learning](http://videolectures.net/nips2010_wright_oaml/) - ステファン・J・ライト（ウィスコンシン大学マディソン校）
 * [Convex Optimization](http://videolectures.net/mlss07_vandenberghe_copt/?q=convex%20optimization) - ライヴン・バンデンヘー（カリフォルニア大学ロサンゼルス校）
 * [Continuous Optimization in Computer Vision](https://www.youtube.com/watch?v=oZqoWozVDVg) - アンディー・フィッツギブン（マイクロソフト研究）
 * [Beyond stochastic gradient descent for large-scale machine learning](http://videolectures.net/sahd2014_bach_stochastic_gradient/) - フランシス・バチ（INRIA）
 * [Variational Methods for Computer Vision](https://www.youtube.com/playlist?list=PLTBdjV_4f-EJ7A2iIH5L5ztqqrWYjP2RI) - ダニエル・クレーマース（ミュンヘン工科大学）（[lecture 18 missing from playlist](https://www.youtube.com/watch?v=GgcbVPNd3SI)）

<a id="deep-learning"></a>
#### 深層学習
 * [A tutorial on Deep Learning](http://videolectures.net/jul09_hinton_deeplearn/) - ジョージ・E・ヒントン（トロント大学）
 * [Deep Learning](http://videolectures.net/kdd2014_salakhutdinov_deep_learning/?q=Hidden%20Markov%20model#) -  ルスラン・サラクゥティンオフ（トロント大学）
 * [Scaling up Deep Learning](http://videolectures.net/kdd2014_bengio_deep_learning/) - ヨシュア・ベンジオ（モンテルオ大学）
 * [ImageNet Classification with Deep Convolutional Neural Networks](http://videolectures.net/machine_krizhevsky_imagenet_classification/?q=deep%20learning) -  アレクサンダー・クレジヴスキー（トロント大学）
 * [The Unreasonable Effectivness Of Deep Learning](http://videolectures.net/sahd2014_lecun_deep_learning/) アン・レ・クン（NYU/フェイスブック研究）2014
 * [Deep Learning for Computer Vision](https://www.youtube.com/watch?v=qgx57X0fBdA) - ロブ・フェルグス（NYU/フェイスブック研究）
 * [High-dimensional learning with deep network contractions](http://videolectures.net/sahd2014_mallat_dimensional_learning/) - ステファネ・マラト（ノルマール高等学院）
 ...
 * [Machine Learning Summer School](https://www.youtube.com/channel/UC3ywjSv5OsDiDAnOP8C1NiQ) - レイクジャヴィク、アイスランド 2014
	* [Deep Learning Session 1](https://www.youtube.com/watch?v=JuimBuvEWBg) - ヨシュア・ベンジオ（モンテルオ大学）
	* [Deep Learning Session 2](https://www.youtube.com/watch?v=Fl-W7_z3w3o) - ヨシュア・ベンジオ（モンテルオ大学）
	* [Deep Learning Session 3](https://www.youtube.com/watch?v=_cohR7LAgWA) - ヨシュア・ベンジオ（モンテルオ大学）

<a id="software"></a>
## ソフトウェア

<a id="annotation-tools"></a>
#### アノテーションツール
...
<a id="external-resource-links"></a>
#### 外部リソースリンク
 * [Computer Vision Resources](https://sites.google.com/site/jbhuang0604/resources/vision) - ジャイ・ビン・ホウ（UIUC）
 * [Computer Vision Algorithm Implementations](http://www.cvpapers.com/rr.html) - CVPapers
 * [Source Code Collection for Reproducible Research](http://www.csee.wvu.edu/~xinl/reproducible_research.html) - シン・リ（ウェストバージニア大学)
 * [CMU Computer Vision Page](http://www.cs.cmu.edu/afs/cs/project/cil/ftp/html/v-source.html)

<a id="general-purpose-computer-vision-library"></a>
#### 汎用コンピュータービジョンライブラリ
...
<a id="multiple-view-computer-vision"></a>
#### 多視点コンピュータービジョン
...
* [OpenGV ](http://laurentkneip.github.io/opengv/) - 幾何学的コンピュータビジョンアルゴリズム
* [MinimalSolvers](http://cmp.felk.cvut.cz/mini/) - 最小問題解決器
...
* [openMVG: open Multiple View Geometry](http://imagine.enpc.fr/~moulonp/openMVG/) - 複数視点幾何学；構造から運動ライブラリおよびソフトウェア
...
<a id="feature-detection-and-extraction"></a>
#### 特徴検出と抽出
* [VLFeat](http://www.vlfeat.org/)
...
<a id="high-dynamic-range-imaging"></a>
#### ハイダイナミックレンジ画像
...
<a id="low-level-vision"></a>
#### 低レベルビジョン

<a id="stereo-vision"></a>
###### ステレオビジョン
...
<a id="contour-detection-and-image-segmentation"></a>
#### 輪郭検出と画像セグメンテーション
...
<a id="interactive-image-segmentation"></a>
#### インタラクティブ画像セグメンテーション
...
<a id="graph-optimization"></a>
###### グラフ最適化
 * [GTSAM: General smoothing and mapping library for Robotics and SFM](https://collab.cc.gatech.edu/borg/gtsam?destination=node%2F299) -- ジョージア工科大学
 * [G2O: General framework for graph optomization](https://github.com/RainerKuemmerle/g2o)

<a id="loop-closure"></a>
###### ループ閉じ込み
 * [FabMap: appearance-based loop closure system](http://www.robots.ox.ac.uk/~mjc/Software.htm) - また [OpenCV2.4.11](http://docs.opencv.org/2.4/modules/contrib/doc/openfabmap.html) にも利用可能
 * [DBoW2: binary bag-of-words loop detection system](http://webdiis.unizar.es/~dorian/index.php?p=32)

<a id="localization--mapping"></a>
###### 位置推定とマッピング
 * [RatSLAM](https://code.google.com/p/ratslam/)
 * [LSD-SLAM](https://github.com/tum-vision/lsd_slam)
 * [ORB-SLAM](https://github.com/raulmur/ORB_SLAM)

<a id="single-view-spatial-understanding"></a>
#### 単一視点の空間理解
...
<a id="nearest-neighbor-search"></a>
#### 最近傍探索

<a id="general-purpose-nearest-neighbor-search"></a>
###### 汎用最近傍探索
...
<a id="nearest-neighbor-field-estimation"></a>
###### 最近傍フィールド推定
...
<a id="saliency-detection"></a>
#### 顕著性検出

<a id="attributes"></a>
#### 属性

<a id="action-reconition"></a>
#### 行動認識

<a id="egocentric-cameras"></a>
#### 一人称視点カメラ

<a id="human-in-the-loop-systems"></a>
...
<a id="optimization-2"></a>
#### 最適化
 * [Ceres Solver](http://ceres-solver.org/) - 非線形最小二乗問題および制約なし最適化解決器
 * [NLopt](http://ab-initio.mit.edu/wiki/index.php/NLopt)- 非線形最小二乗問題および制約なし最適化解決器
 * [OpenGM](http://hci.iwr.uni-heidelberg.de/opengm2/) - 因子グラフに基づく離散最適化および推論解決器
 * [GTSAM](https://collab.cc.gatech.edu/borg/gtsam/) - 因子グラフに基づく最小二乗最適化解決器

<a id="deep-learning-1"></a>
#### 深層学習
 * [Awesome Deep Vision](https://github.com/kjw0612/awesome-deep-vision)

<a id="machine-learning-2"></a>
#### 機械学習
 * [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning)
...
<a id="external-dataset-link-collection"></a>
#### 外部データセットリンク集
 * [CV Datasets on the web](http://www.cvpapers.com/datasets.html) - CVPapers
 * [Are we there yet?](http://rodrigob.github.io/are_we_there_yet/build/) - 標準データセットXにおいて最も良い結果を提供する論文は？
...
<a id="low-level-vision-1"></a>
#### 低レベルビジョン

<a id="stereo-vision-1"></a>
###### ステレオビジョン
 * [Middlebury Stereo Vision](http://vision.middlebury.edu/stereo/)
 * [The KITTI Vision Benchmark Suite](http://www.cvlibs.net/datasets/kitti/eval_stereo_flow.php?benchmark=stero)
 * [LIBELAS: Library for Efficient Large-scale Stereo Matching](http://www.cvlibs.net/software/libelas/)
...
<a id="video-object-segmentation"></a>
###### 動画物体セグメンテーション
...
<a id="multi-view-reconsturction"></a>
#### 多視点再構成
* [Multi-View Stereo Reconstruction](http://vision.middlebury.edu/mview/)

<a id="saliency-detection-1"></a>
#### 顕著性検出

<a id="visual-tracking-1"></a>
#### ビジュアルトラッキング
 * [Visual Tracker Benchmark](https://sites.google.com/site/trackerbenchmark/benchmarks/v10)
...
<a id="visual-surveillance"></a>
#### 映像監視
 * [VIRAT](http://www.viratdata.org/)
 * [CAM2](https://cam2.ecn.purdue.edu/)

<a id="saliency-detection-2"></a>
#### 顕著性検出

<a id="change-detection-1"></a>
#### 変化検出
 * [ChangeDetection.net](http://changedetection.net/)

<a id="visual-recognition"></a>
#### 視覚認識
...
<a id="multi-view-object-detection"></a>
###### 多視点物体検出
...
<a id="fine-grained-visual-recognition"></a>
###### 詳細画像認識
...
<a id="resource-link-collection"></a>
#### リソースリンク集
 * [Resources for students](http://people.csail.mit.edu/fredo/student.html) - フリド ダュラン (MIT)
 * [Advice for Graduate Students](http://www.dgp.toronto.edu/~hertzman/advice/) - アーロン・ヘルツマン (アドビ・リサーチ)
 * [Graduate Skills Seminars](http://www.dgp.toronto.edu/~hertzman/courses/gradSkills/2010/) - Yashar Ganjali, Aaron Hertzmann (トロント大学)
 * [Research Skills](http://research.microsoft.com/en-us/um/people/simonpj/papers/giving-a-talk/giving-a-talk.htm) - シモン・ペイトン・ジョーンズ (マイクロソフト・リサーチ)
 * [Resource collection](http://web.engr.illinois.edu/~taoxie/advice.htm) - 徐 延 (UIUC) および 謝 健 (UCSB)

<a id="writing"></a>
#### 執筆
 * [Write Good Papers](http://people.csail.mit.edu/fredo/FredoGoodWriting.pdf) - フリド ダュラン (MIT)
 * [Notes on writing](http://people.csail.mit.edu/fredo/PUBLI/writing.pdf) - フリド ダュラン (MIT)
 * [How to Write a Bad Article](http://people.csail.mit.edu/fredo/FredoBadWriting.pdf) - フリド ダュラン (MIT)
 * [How to write a good CVPR submission](http://billf.mit.edu/sites/default/files/documents/cvprPapers.pdf) - ウィリアム・T・フリーマン (MIT)
 * [How to write a great research paper](https://www.youtube.com/watch?v=g3dkRsTqdDA) - シモン・ペイトン・ジョーンズ (マイクロソフト・リサーチ)
 * [How to write a SIGGRAPH paper](http://www.slideshare.net/jdily/how-to-write-a-siggraph-paper) - SIGGRAPH ASIA 2011 カース
 * [Writing Research Papers](http://www.dgp.toronto.edu/~hertzman/advice/writing-technical-papers.pdf) - アーロン・ヘルツマン (アドビ・リサーチ)
 * [How to Write a Paper for SIGGRAPH](http://www.computer.org/csdl/mags/cg/1987/12/mcg1987120062.pdf) - ジム・ブリーン
 * [How to Get Your SIGGRAPH Paper Rejected](http://www.siggraph.org/sites/default/files/kajiya.pdf) - ジム・カジヤ (マイクロソフト・リサーチ)
 * [How to write a SIGGRAPH paper](https://github.com/jbhuang0604/awesome-computer-vision/blob/9b82b1645aecdc9b895fc378d5209a9f6672bb15/www.liyiwei.org/courses/how-siga11/liyiwei.pptx) - 衛 李・イ (香港大学)
 * [How to Write a Great Paper](http://www-hagen.informatik.uni-kl.de/~bertram/talks/getpublished.pdf) - マーティン・マーティン・ヘーリング・ヘーリング--ベルトム (ブレメン大学工科大学院)
 * [How to have a paper get into SIGGRAPH?](http://www-ui.is.s.u-tokyo.ac.jp/~takeo/writings/siggraph.html) - 伊賀 健 (東京大学)
 * [Good Writing](http://www.cs.cmu.edu/~pausch/Randy/Randy/raibert.htm) - マーカス・H・レイベルト (ボストン・ダイナミクス)
 * [How to Write a Computer Vision Paper](http://web.engr.illinois.edu/~dhoiem/presentations/How%20to%20Write%20a%20Computer%20Vison%20Paper.ppt) - デレク・ホイエム (UIUC)
 * [Common mistakes in technical writing](http://www.cs.dartmouth.edu/~wjarosz/writing.html) - ウオジェチェ・ジャロズ (ダートマウス大学)


<a id="presentation"></a>
#### プレゼンテーション
 * [Giving a Research Talk](http://people.csail.mit.edu/fredo/TalkAdvice.pdf) - フリド ダュラン (MIT)
 * [How to give a good talk](http://www.dgp.toronto.edu/~hertzman/courses/gradSkills/2010/GivingGoodTalks.pdf) - デイビッド・フェリット (トロント大学) および アーロン・ヘルツマン (アドビ・リサーチ)
 * [Designing conference posters](http://colinpurrington.com/tips/poster-design) - コールin パーリングトン

<a id="research"></a>
#### 研究
 * [How to do research](http://people.csail.mit.edu/billf/www/papers/doresearch.pdf) - ウィリアム・T・フリーマン (MIT)
 * [You and Your Research](http://www.cs.virginia.edu/~robins/YouAndYourResearch.html) - リチャード・ハミング
 * [Warning Signs of Bogus Progress in Research in an Age of Rich Computation and Information](http://yima.csl.illinois.edu/psfile/bogus.pdf) - マ・イ（UIUC）
 * [Seven Warning Signs of Bogus Science](http://www.quackwatch.com/01QuackeryRelatedTopics/signs.html) - ロバート・L・パーク
 * [Five Principles for Choosing Research Problems in Computer Graphics](https://www.youtube.com/watch?v=v2Qaf8t8I6c) - トマス・フンクハウザー（コロンビア大学）
 * [How To Do Research In the MIT AI Lab](http://www.cs.indiana.edu/mit.research.how.to.html) - デイビッド・チャプマン（MIT）
 * [Recent Advances in Computer Vision](http://www.slideshare.net/antiw/recent-advances-in-computer-vision) - ミンホン・ヤン（UCメルセド）
 * [How to Come Up with Research Ideas in Computer Vision?](http://www.slideshare.net/jbhuang/how-to-come-up-with-new-research-ideas-4005840) - ジャイ・ビン・ホウ（UIUC）
 * [How to Read Academic Papers](http://www.slideshare.net/jbhuang/how-to-read-academic-papers) - ジャイ・ビン・ホウ（UIUC）

<a id="time-management"></a>
#### 時間管理
 * [Time Management](https://www.youtube.com/watch?v=oTugjssqOT0) - ランディ・パウシュ（CMU）

<a id="blogs"></a>
## ブログ
 * [Learn OpenCV](http://www.learnopencv.com/) - サティ・マリック
 * [Tombone's Computer Vision Blog](http://www.computervisionblog.com/) - トマス・マリシエフスキー
 * [Computer vision for dummies](http://www.visiondummy.com/) - ビンセント・スプライト
 * [Andrej Karpathy blog](http://karpathy.github.io/) - アンデル・カルパスキー
 * [AI Shack](http://aishack.in/) - ウトカーシ・シンハ
 * [Computer Vision Talks](http://computer-vision-talks.com/) - ユージン・クヴェデチェンヤ
 * [Computer Vision Basics with Python Keras and OpenCV](https://github.com/jrobchin/Computer-Vision-Basics-with-Python-Keras-and-OpenCV) - ジェイソン・チン（ウェストン・オンタリオ大学）


<a id="links"></a>
## リンク
* [The Computer Vision Industry](http://www.cs.ubc.ca/~lowe/vision.html) - デイビッド・ロウ
...
法的に可能である範囲内で、[Jia-Bin Huang](https://github.com/jbhuang0604/awesome-computer-vision/blob/9b82b1645aecdc9b895fc378d5209a9f6672bb15/www.jiabinhuang.com)はこの作品に関するすべての著作権および関連又は隣接する権利を放棄した。
