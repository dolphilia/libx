...
- [採用](#hiring)
- [信頼性](#reliability)
- [監視・可観測性・アラート](#monitoring--observability--alerting)
- [オンコール](#on-call)
- [事後分析](#post-mortem)
- [容量計画](#capacity-planning)
- [サービスレベル合意](#service-level-agreement)
- [パフォーマンス](#performance)
- [プログラミング](#programming)
- [その他の記事](#misc-articles)
- [リアルタイムメッセージング](#real-time-messaging)
- [ブログ](#blogs)
- [ニュースレター](#newsletters)
- [会議とミートアップ](#conferences-meetups)
- [Twitter](#twitter)
- [SREツール](#sre-tools)
- [SREポッドキャスト](#podcasts)
...
## 監視・可観測性・アラート <a id="monitoring--observability--alerting"></a>
...
## サービスレベル合意 <a id="service-level-agreement"></a>
...
* [Site Reliability Engineering for Native Mobile Apps - Abhijith Krishnappa](https://www.infoq.com/articles/site-reliability-engineering-mobile-apps/) - その他の記事に関するSREの講演、記事、ツール、またはコミュニティ資料です。
* [SRE Best Practices by InfraCloud](https://www.infracloud.io/blogs/sre-best-practices/)

## リアルタイムメッセージング <a id="real-time-messaging"></a>
* [#sre channel at Hangops Slack](https://hangops.slack.com/) - サイトリラビリティエンジニアリングに関する議論
* [#incident_response channel at Hangops Slack](https://hangops.slack.com/) - インシデント対応に関する議論
* [USENIX SREcon Slack](https://usenix-srecon.slack.com)

## ブログ <a id="blogs"></a>
* [Brendan Gregg's Blog](http://www.brendangregg.com/blog/index.html) - システムの内部構造・パフォーマンス・SREに関する高度な技術ブログ記事
* [Everything Sysadmin](http://everythingsysadmin.com/) - トム・リモンセルリによるシステム管理／DevOps／SREに関するブログ記事
* [High Scalability](http://highscalability.com/) - システムアーキテクチャに関する技術ブログ記事
* [rachelbythebay](https://rachelbythebay.com/w/) - 技術的なブログ記事
* [Susan J. Fowler](http://www.susanjfowler.com/blog/) - SRE、ソフトウェアエンジニアリングおよびマイクロサービスに関する多様なブログ記事
* [SysAdvent](https://sysadvent.blogspot.com) - each day of December, ending on the 25th article向けのOne article。
* [Stephen Thorne's Blog](https://medium.com/@jerub) - SREに関するブログ記事
* [Increment](https://increment.com/) - スケールしたソフトウェアシステムの構築と運用についてのデジタルマガジン
* [GopherSRE](http://www.gophersre.com/) - GoとSREに関するブログ記事
* [Cindy Sridharan](https://medium.com/@copyconstruct) - 分散システムおよびその管理に関するブログ記事
* [Blameless Blog](https://www.blameless.com/blog/) - SREの文化と実践に関するブログ記事
* [Resilience Roundup](https://ResilienceRoundup.com) - software systems向けのWeekly analysis of Resilience Engineering and Human Factors research designed。
* [Squadcast Blog](https://www.squadcast.com/blog) - SREのベストプラクティス、信頼性、オンカールおよびインシデント管理に関するブログ記事
* [FireHydrant Blog](https://www.firehydrant.io/blog) - 複雑なシステム、インシデント対応、SREベストプラクティスに関する記事
* [Rootly Blog](https://www.rootly.io/blog) - インシデント管理のベストプラクティスとガイド
* [incident.io Blog](https://www.incident.io/blog) - インシデント管理および対応に関するガイド、アドバイス、リソース
* [Logit.io Blog](https://logit.io/blog) - ログ管理、SREおよびDevOpsに関するリソース

## ニュースレター <a id="newsletters"></a>
* [DevOpsLinks](https://faun.dev) - SRE、システム管理者、DevOpsのニュース、ツール、チュートリアルおよび意見を週刊で配信
* [KubeWeekly](https://kubeweekly.io/) - all things Kubernetes. KubeWeekly is curated by Bob Killen, Chris Short, Craig Box, Kim McMahon and Michael Hausenblas向けのThe weekly newsletters。
* [SRE Weekly](https://sreweekly.com/) - 週刊サイトリリアビリティニュースレター
* [O’Reilly Systems Engineering and Operations Newsletter](http://www.oreilly.com/webops-perf/newsletter.html) - 業界の専門家が提供するシステムエンジニアリングおよび運用に関する週刊ニュースと洞察
* [ChaosEngineering.news](https://chaosengineering.news/) - カオスエンジニアリングニュースレター。すべてのカオスエンジニアリングに関する情報、あなたのメールに直接届きます！
* [Monitoring Weekly](https://monitoring.love/) - モニタリングの最新情報。週に1回、厳選されたモニタリング記事をあなたのメールに届けます
* [Observability news](https://o11y.news/) - 観測性（o11y）に関する最新情報（オープンソースに特に注目）

## 会議とミートアップ <a id="conferences-meetups"></a>
* [SRECon Conferences](https://www.usenix.org/conferences/byname/925) - 公式SREカンファレンス
* [LISA Conferences](https://www.usenix.org/conferences/byname/5) - システム運用・開発者・SREに関する主要なカンファレンス
* [SRE Tech Talks](https://developers.google.com/events/sre/) - グーグルが主催するSREトーク
* [South Bay Site Reliability Engineering (Sunnyvale, CA) Meetup](https://www.meetup.com/South-Bay-Site-Reliability-Engineering/) - Individuals Who Tackle Reliability Challenges For Web-Scale Systems向けのA Group。
* [San Francisco Reliability Engineering](https://www.meetup.com/San-Francisco-Reliability-Engineering/) - 信頼性とパフォーマンスの高いソフトウェアシステムに情熱をもつ人々のグループ
* [Site Reliability Engineering Munich, Germany](https://www.meetup.com/Site-Reliability-Engineering-Munich/) - オクトーバーフェスト都市圏におけるSREミートアップ
* [ADDO - All Day DevOps](https://www.alldaydevops.com/) - 完全オンラインかつ無料の24時間制カンファレンス
* [Site Reliability Engineering Paris, France](https://www.meetup.com/Site-Reliability-Engineering-Paris/) - 光の都市におけるSREミートアップ
* [Site Reliability Engineering India](https://www.meetup.com/site-reliability-enggineering/) - インドのSREミートアップ

## Twitter <a id="twitter"></a>
* [Google SRE Twitter Account](https://twitter.com/googlesre) - グーグルのSRE Twitterアカウント
* [SREBook](https://twitter.com/SREBook) - Site Reliability Engineering書の公式Twitterアカウント
* [SREcon](https://twitter.com/SREcon) - SREConの公式Twitterアカウント
* [SREWorkbook](https://twitter.com/SREWorkbook) - Site Reliability Workbook書の公式Twitterアカウント
* [The SRE Dev](https://twitter.com/The_SRE_Dev) - SRE-related Posts from [dev.to](https://dev.to).
* [Twitter SRE](https://twitter.com/TwitterSRE) - TwitterのSREチームの公式Twitterアカウント
* [Twitter SRE Weekly](https://twitter.com/SREWeekly) - SRE Weeklyニュースレターの公式Twitterアカのアカウント
* [USENIX Association](https://twitter.com/usenix) - USENIXの公式Twitterアカウント

## SREツール <a id="sre-tools"></a>
* [Awesome SRE Tools](https://github.com/SquadcastHub/awesome-sre-tools) - Site ReliabilityおよびProduction Engineeringツールの厳選リスト
* [List of Continuous Integration services](https://github.com/ligurio/awesome-ci)
* [SRE cheat sheet](https://github.com/shibumi/SRE-cheat-sheet) - Site Reliability Engineering principles and numbers向けのA cheat sheet。
