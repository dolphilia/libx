...
1. [**クリエイティブテクノロジー**](#creative-technology)
1. [**コレクティブ・制作活動**](#collectives--practices)
1. [**体験型空間・エクスペリエンス**](#experiential-spaces--experiences)
1. [**制作・施工会社**](#fabricators)
1. [**イベント制作**](#event-production)
1. [**建築**](#architecture)
1. [**クリエイティブエージェンシー**](#creative-agencies)
1. [**博物館・美術館**](#museums)
1. [**フェスティバル・カンファレンス**](#festivals--conferences)
1. [**教育**](#education)
1. [**活動終了グループ**](#closed-groups)

---

## クリエイティブテクノロジー <a id="creative-technology"></a>
...
## コレクティブ・制作活動 <a id="collectives--practices"></a>

クリエイティブテクノロジーに取り組む実績あるアーティスト集団・制作活動です。主に参照用で、必ずしも求人情報を目的としません。
...
## 体験型空間・エクスペリエンス <a id="experiential-spaces--experiences"></a>

クリエイティブテクノロジーを活用した体験型空間・エクスペリエンスを制作するグループです。
...
## 制作・施工会社 <a id="fabricators"></a>

クリエイティブテクノロジー企業向け作品の制作・施工を主に担うグループです。
...
## イベント制作 <a id="event-production"></a>

クリエイティブテクノロジーを取り入れたイベント制作を得意とするグループです。
...
クリエイティブテクノロジーを取り入れた建築を主に設計するグループです。
...
## クリエイティブエージェンシー <a id="creative-agencies"></a>

幅広い領域を扱いながら、クリエイティブテクノロジーを組み込むプロジェクトを得意とするグループです。
...
## 博物館・美術館 <a id="museums"></a>

クリエイティブテクノロジーを活用した博物館・美術館等の体験設計を主に行うグループです。
...
## フェスティバル・カンファレンス <a id="festivals--conferences"></a>

クリエイティブテクノロジスト向けの交流・発表イベントです。
...
## 活動終了グループ <a id="closed-groups"></a>

活動を終了したグループも参照・着想源として有用です。一覧は[こちら](https://github.com/j0hnm4r5/awesome-creative-technology/blob/0e7b20ec32b01a8bec718dc3a907d213d6a475e9/closed.md)です。
