...
<a id="startups-and-business"></a>
## スタートアップとビジネス
| 書名 | 著者 | Goodreads評価 | 出版年 |
|------|--------|------------------|----------------|
...
もしもあなたが頭を広げる本を好きなら、私の新しいプロジェクト http://diff.blog. をチェックしてください。それは開発者コミュニティに常に最新情報を得られるプラットフォームです。

<a href="#top"><img src="https://img.shields.io/badge/Back%20to%20Top-↑-blue"/></a>

<a id="philosophy-and-psychology"></a>
## 哲学と心理学
| 書名 | 著者 | Goodreads評価 | 出版年 |
|------|--------|------------------|----------------|
...
<a id="autobiographies-and-biographies"></a>
## 自伝と伝記
| 書名 | 著者 | Goodreads評価 | 出版年 |
|------|--------|------------------|----------------|
...
| Life at the Speed of Light: From the Double Helix to the Dawn of Digital Life | J. Craig Venter | [3.87](https://github.com/hackerkid/Mind-Expanding-Books/blob/2844c5ad5e1f4da8a637c74503763a2cb56f5550/www.goodreads.com/book/show/17674969-life-at-the-speed-of-light) | 2013 |
...
<a id="logic-and-problem-solving"></a>
## 論理と問題解決
| 書名 | 著者 | Goodreads評価 | 出版年 |
|------|--------|------------------|----------------|
...
<a id="credits"></a>
# クレジット
* [@hackerkid](https://github.com/hackerkid) リストの開始のために。
* [@geritol](https://github.com/geritol) リストの維持を目的としたフレームワークの構築のために。
* All the [contributors](https://github.com/hackerkid/Mind-Expanding-Books/graphs/contributors) 新しい本を追加してリストを最新に保つために。

<a id="license"></a>
# ライセンス
[![CC0](http://i.creativecommons.org/p/zero/1.0/88x31.png)](http://creativecommons.org/publicdomain/zero/1.0/)

法的に可能である範囲内で、[Vishnu Ks](https://github.com/hackerkid)はこの作品に関するすべての著作権および関連又は隣接する権利を放棄しました。
