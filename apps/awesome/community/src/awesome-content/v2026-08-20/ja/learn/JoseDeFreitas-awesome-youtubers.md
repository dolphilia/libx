...
-   [プログラミング全般](#programming-in-general)
...
-   [インターネット／ネットワーク](#internetnetworking)
-   [ソフトウェア全般](#software-in-general)
-   [オペレーティングシステム](#operating-systems)
-   [ハードウェア](#hardware)
-   [競技プログラミング](#competitive-programming)
-   [デジタルデザイン](#digital-design)
-   [音声・動画](#audio-and-video)
-   [生活スキル](#life-skills)

## プログラミング全般 <a id="programming-in-general"></a>

この節では各種プログラミング言語と、そのフレームワークを教えるチャンネルを紹介します。言語に限らない一般的なプログラミングや、実践・理論の両方のチュートリアルも含みます。
...
主なプレイリスト: `react js from scratch`, `Node.js Tutorials For Beginners`, `Data Structures in JavaScript`, `Interview Preparation`.
...
内容: Frontend, Backend \
主なプレイリスト: `JavaScript Tutorials`, `JavaScript frameworks videos`, `Python Tutorials`, `Node.js Tutorials`, `C#.NET Tutorials`.
...
内容: JavaScript, JavaScript frameworks \
主なプレイリスト: `Code Wars Code Katas`. \
<br />

[<img align="left" height="94px" width="94px" alt="Channel's avatar" src="https://yt3.googleusercontent.com/dSkEwiYrGlZPE6t9irfN8RlpDlaU_n7u3oEnHxJIY_knycUXPzEVlFKbYtwzkcysNDVZPn5zmHg=s160-c-k-c0x00ffffff-no-rj"/>](https://www.youtube.com/@takeUforward)

[**take U forward**](https://www.youtube.com/@takeUforward) \
内容: Data Structures, Algorithms, Dynamic Programming \
主なプレイリスト: `Striver's A2Z DSA Course`, `Dynamic Programming`, `Placement Series`. \
<br/>
...
内容: Mathematics, Programming languages \
主なプレイリスト: `Learn Algebra`, `C++ Tutorial`, `C# Tutorial`, `Java Video Tutorial`, `a lot of diverse topics`.
...
内容: PowerShell \
主なプレイリスト: `Learn Windows PowerShell in a Month of Lunches`, `SAPIEN PowerShell Training`, `PowerShell Tips, Tricks, and Snippets`.
...
内容: Python, Backend \
主なプレイリスト: `Python Tutorials`, `Django Tutorials`, `Flask Tutorials`, `Matplotlib Tutorials`, `SQL Tutorials`.
...
内容: C, C#, C++ \
主なプレイリスト: `Learn C Programming Language | Tutorial for Beginners`, `Learn C++ Programming | Video Tutorial for Beginners`, `C++ Object Oriented Programming`, `and many more`.
...
内容: Algorithms, Various programming languages \
主なプレイリスト: `The Nature of Code: Simulating Natural Systems with Processing`, `Learning Processing: A Beginner's Guide to Programming Images, Animation, and Interaction`.
...
内容: DevOps, Artificial intelligence \
主なプレイリスト: `DevOps Tutorial for Beginners`, `Artificial Intelligence Tutorial`, `Machine Learning Tutorial`, `Python Tutorial for Beginners`.
...
内容: Backend, APIs \
主なプレイリスト: `Node.js Tutorial for Beginners`, `Python 3 Tutorial for Beginners`, `C++ Programming Tutorial for Beginners`, `other videos about different programming languages`.
...
内容: Kotlin, Android, more programming languages \
主なプレイリスト: `a lot of Kotlin & Android videos`, `Ruby Tutorial for Beginners`, `Dart Tutorial for Beginners`, `Java Tutorial for Beginners`.
...
内容: Rust, Dart, Flutter \
主なプレイリスト: `Flutter Tutorials`, `Dart & Dart for Beginners`, `Intro to Rust & Rust Projects`. \
<br />
...
内容: General programming, Computer science, Web Dev, DevOps, etc. \
主なプレイリスト: `Python Tutorials`, `Machine Learning`, `Java Tutorials`. \
<br />
...
内容: Spring, Java \
主なプレイリスト: `Spring Framework Courses playlists`, `Spring Boot Microservices - Full Course playlists`, `Java EE Courses playlists`.
...
内容: C#, .NET \
主なプレイリスト: `Advanced Topics in C#`, `Getting Started with C#`, `C# User Interfaces`, `many other C# videos`, `.NET video tutorials`.
...
内容: Python, JavaScript, C, C#, C++ \
主なプレイリスト: `Python Programming`, `JavaScript playlist`, `C# Tutorials`, `C Programming Tutorials`, `C++ Tutorials`, `Java Tutorials`, `database tutorial videos`.
...
内容: Python \
主なプレイリスト: `30 Days of Python ~ Python 3.8+`, `Coding With Python`, `Python 3.8 and Django 3+`, `Install and setup on Windows and Mac`.
...
内容: C# \
主なプレイリスト: `C# Mastery Course (2020)`, `C# Programming (Beginners)`, `.NET Core and ASP.NET Server Development Tutorials`, `WPF UI Programming (C#)`.
...
内容: Data science, Python, R, Practical & theoretical \
主なプレイリスト: `Python for Data Analysis`, `Introduction to R`, `Python Programming Practice`, `Pandas`, `more playlists!`.
...
内容: MongoDB, SQL, C#, C++ \
主なプレイリスト: `MongoDB - NoSQL Database`, `PHP - Programming Language`, `C# - Programming Language`, `C++ - Programming Language`.
...
内容: Java \
主なプレイリスト: `Java Basics 1`, `Java Basics 2`, `Java Intermediate 1`. \
<br />
...
内容: Redis \
主なプレイリスト: `Redis Explained`, `Redis Chaching`, `Redis Data Types`, `and much more`. \
<br />
...
内容: Python, Data structures, Data science, Machine learning, Ethical hacking \
主なプレイリスト: `Algorithms & Data Structures`, `Python Machine Learning Tutorial`, `Python AI Projects`, `Python Hacking Projects`, `Python beginner/intermediate tutorials`.
...
内容: Python \
主なプレイリスト: `Python - Intermediate and Advanced Features`, `Functional Programming in Python`, `Tools for Effective Python Development`, `How to Build Your Python Career`.
...
内容: Python \
主なプレイリスト: `Algorithms (Python)`, `Data Structures (Python)`, `Technical Interview Preparation`, `Web Scraping and Automation (Python)`, `many more videos`.
...
内容: C#, .NET, Azure, AWS, General Programming \
主なプレイリスト: `ASP.NET Core REST API Tutorial`, `ASP.NET Core General Tutorials`, `Essential Nuget Packages in .NET`, `Software Engineering Fundamentals`.
...
内容: Python, Problem solving \
主なプレイリスト: `Hackerrank Problem Solving`, `Machone/Deep learning Projects Tutorials`. \
<br />
...
内容: Java, Python, C#/C++ \
主なプレイリスト: `playlists of these languages with a lot of videos`. \
<br />
...
内容: .NET, ASP.NET, C# \
主なプレイリスト: `Desktop and .NET Code 101`, `ASP.NET Core 101`, `DevOps for .NET`, `C# Language Highlights`, `C# Advanced`, `and more`.
...
内容: SQL Server, C#, ASP.NET, Design patterns \
主なプレイリスト: `Design Patterns tutorial for beginners`, `SQL Server tutorial for beginners`, `c# tutorial for beginners`, `ASP.NET tutorial for beginners`.
...
内容: C#, Swift, Kotlin \
主なプレイリスト: `C# Full Course Beginner to Advanced`, `Swift Course`, `Kotlin Course`, `Xamarin Forms Lists Course`, `and more`.
...
内容: C++, Theoretical, Game development \
主なプレイリスト: `NES Emulator From Scratch`, `Interesting Programming`, `Code-It-Yourself!`. \
<br />
...
内容: C#, WPF, .NET \
主なプレイリスト: `Full Stack WPF MVVM`, `WPF Navigation`, `WPF Responsive Design`, `WPF Custom Controls`, `Design Patterns`.
...
内容: Spring Boot, Kotlin \
主なプレイリスト: `Spring Boot`. \
<br/>
...
内容: Python, Software Design \
主なプレイリスト: `Software Design in Python`, `Code Roasts`. \
<br/>
...
内容: Java, Spring Boot, Python, Data Structures \
主なプレイリスト: `Java Tutorial For beginners`, `Data Structures and Algorithm`, `Microservice Tutorial using Java`, `Python for Beginners (Full Course) | Programming Tutorial`. \
...
内容: Golang \
主なプレイリスト: `Distributed CAS Storage In Golang`, `Crypto exchange from scratch in Golang`, `Actor engine in Golang (Hollywood)`. \
...
内容: C, Rust, OCaml, Python, Algorithms, Data Structure \
主なプレイリスト: `Machine Learning in C`, `Search Engine in Rust`, `Music Visualizer in C`, `Raylib.js`. \
<br/>
...
内容: Devoxx is a series of tech events organised by local community groups \
主なプレイリスト: `Devoxx UK`, `Devoxx Belgium`, `Devoxx Poland`, `Devoxx France`. \
<br/>
...
内容: Conference for senior software developers and architects interested in software design. \
主なプレイリスト: `DDD Foundations`, `Eventsourcing`.
...
内容: Brightest minds sharing their knowledge to create a better future \
主なプレイリスト: `Sustainable Software`, `Software Architecture`, `Recommendations`, `Greatest Hits`, and many more.
...
内容: Innovator and early adopter stage techniques and technologies with the wider industry \
主なプレイリスト: `InfoQ Trend Reports`, `Culture & Methods`, `DevOps`, `Emerging languages and development trends`.
...
内容: .NET & Agile development, evolved to encompass all technologies relevant to Software Developers. \
主なプレイリスト: `NDC Sydney`, `NDC Oslo`, `NDC London`, `NDC Minnesota`, `NDC Melbourne`, `NDC Copenhagen`, `DevOps`, `Security`.
...
内容: All things related to Java from the Dutch Java User Group \
主なプレイリスト: `J-Fall`, `J-Spring`. \
<br/>
...
内容: All things related to Programming, Hacking, Linux and much more \
主なプレイリスト: `Tech & Coding` \
<br/>
...
内容: Linux, Assembly, Encryption \
主なプレイリスト: `Linux x64 Assembly`, `AES Encryption`, `x64 Assembly Multithreading`, `CUDA Tutorials`, `C++ Tutorials`.
<br/>
...
内容: JavaScript Frameworks, Coding Tools and Technologies  \
主なプレイリスト: N/A \
<br/>
...
内容: Coding tools, Open-source app development, and programming life skills  \
主なプレイリスト: `Code with me`, `Tips & Inspiration`  \
<br/>

[🔼 Back to the top関連](#contents)
...
内容: React.js, JavaScript, TypeScript \
主なプレイリスト: `React.js Tutorial for Beginners`, `React.js Hooks Tutorial`, `React.js Redux Tutorial`, `React.js Storybook Tutorial`, `React.js Formik Tutorial`, `Practical React.js`.
...
内容: Web design, Design, Freelancing \
主なプレイリスト: `Free Web Design Course 2020`, `Portfolios: Case Studies & Reviews`, `How To Start Freelancing`, `FREELANCE TIPS: How to find clients & grow your business`.
...
内容: CSS \
主なプレイリスト: `Full Course: Level Up Your CSS Animation Skills`. \
<br />
...
内容: React.js, JavaScript \
主なプレイリスト: `Learn JavaScript`, `Master React.js by Building Real Projects`. \
<br />
...
内容: Web development, Design \
主なプレイリスト: `Live Omatum Bucks Software Project Streams`, `Software Project: OmatumBucks`, `Live Omatum.com Website Development Project Streams`, `Uncut Live Streams`.
...
内容: Web design, Adobe XD \
主なプレイリスト: `Design Weekly`, `Design Essentials`. \
<br />
...
内容: Web design, JavaScript, React.js \
主なプレイリスト: `Web Design Tutorial (UI & UX)`, `React.js Tutorial For Beginners`, `CSS Tutorials`, `JavaScript tutorials playlists`.
...
内容: Web design, Design, UI/UX, Adobe XD \
主なプレイリスト: `Illustrator Tutorials`, `Adobe XD Tutorials`, `Photoshop Tutorials`, `LATEST DEV TUTS`, `LATEST DESIGN TUTS`.
...
内容: JavaScript, CSS \
主なプレイリスト: `CSS Tips and Tricks`, `some playlists about JavaScript libraries`. \
<br />
...
内容: Frontend, React.js, Web design \
主なプレイリスト: `React.js Tutorials`, `HTML, CSS & JavaScript Tutorials`, `videos of web design (UI/UX)`.
...
内容: JavaScript, Flutter, Firebase \
主なプレイリスト: `100 Seconds of Code`, `Angular Essentials`, `Flutter`, `Frontend Mini Projects`. \
<br />
...
内容: Frontend, JavaScript, Web design \
主なプレイリスト: `React.js + Redux Basics`, `Vue.js 2 - Getting Started`, `Amazon Web Services Basics`.
...
内容: JavaScript, CSS \
主なプレイリスト: `Learn JavaScript`, `Learn React.js`, `Learn CSS`, `JavaScript Array Methods`. \
<br />
...
内容: Frontend, Web design, CMS \
主なプレイリスト: `Design Tutorials playlists`, `CMS Tutorials playlists`, `HTML & CSS Tutorials`, `React.js videos`, `and more!`.
...
内容: JavaScript, JavaScript frameworks \
主なプレイリスト: `JavaScript Tutorial for Beginners`, `React.js, Angular and Vue.js playlists`, `MEAN Stack Tutorials`, `jQuery Tutorial for Beginners`.
...
内容: ASP.NET, .NET \
主なプレイリスト: `Modern Web Development Series`, `Vue.js Beginner Guide with ASP.NET Core`, `ASP.NET Core Tutorials`, `a lot more .NET tutorials!`.
...
内容: CSS \
主なプレイリスト: `CSS theoretical and practical videos`. \
<br />
...
内容: Frontend, Frameworks \
主なプレイリスト: `Flutter Tutorial for Beginners`, `React.js and React Native playlists`, `a lot of JavaScript playlists, including JavaScript frameworks`, `GraphQL Tutorial`, `many, many more!`.
...
内容: CSS \
主なプレイリスト: `CSS Grid videos`, `Flexbox basics`, `Responsive CSS tutorials`, `CSS animation`, `many more CSS video tutorials!`.
...
内容: React.js, JavaScript \
主なプレイリスト: `React Tutorials`, `Building a React Native App`, `JavaScript Tutorials`, `TypeScript playlist`.
...
内容: Frontend \
主なプレイリスト: `JavaScript course`, `Docker for Beginners`, `MongoDB and Mocha`, `Vue JS Crash Course`, `a lot more of playlists and videos`.
<br />
...
内容: JavaScript, CSS and CSS Preprocessors, Next.js \
主なプレイリスト: `CSS Animations Series`, `Learn jQuery in 15 Minutes`, `Webflow From Scratch`, `Regular Expressions Series`.
...
内容: HTML, CSS, JS, Animations, Responsive Web Designs \
主なプレイリスト: `Css Animation Effects`, `Responsive Website Design from Scratch`, `Css Button Hover Effect`, `Parallax Effect`, `Css Tutorials` `and many more...`
<br />
...
内容: JavaScript, NextJs, NuxtJs, VueJs, ReactJs, SvelteJs, CSS and CSS Preprocessors, Laravel \
主なプレイリスト: `Vuejs`, `SvelteJs`, `Laravel Livewire Full Course`, `Learn to use Nuxt.js`, `ReactJS Basics`, `Laravel PHP Framework Tutorial - Full Course 6.5 Hours (2020)`.
...
内容: Web development in general, JavaScript, React, CSS \
主なプレイリスト: `Small projects`, `Who Wants To Be A Megabit (Trivia Game)`, `CSS Tutorials`, `Web App Security/Authentication`.
...
内容: HTML, CSS, JavaScript, Firebase, FastAPI, TypeScript \
主なプレイリスト: `Getting started with Web development`, `Version control`, `Frontend database management`.
...
内容: JavaScript, TypeScript, HTML, CSS \
主なプレイリスト: `DevLogs`, `How to JavaScript #shorts`, `Code Reviews`. \
<br />
...
内容: JavaScript, React, React-Native, Next.js, Node.js, Express, GraphQL \
主なプレイリスト: `JavaScript Game Walkthroughs`, `Clones`, `Blockchain`, `JavaScript inbuilt methods`.
...
内容: CSS, JavaScript, WordPress, Web Development \
主なプレイリスト: `Wordpress theme development`, `Learn CSS`. \
<br />
...
内容: Javascript, CSS, HTML, Vue.js, React.js, Tailwind CSS, MongoDB, Express.js, Web development \
主なプレイリスト: `Vue.js crash course`, `React.js crash course`, `Semantic UI in 60 minutes`, `Full Stack Vue.js, Express and MongoDB`, `Async JS crash course`.
...
内容: CSS, HTML, JavaScript \
主なプレイリスト: `JavaScript Game Development Masterclass 2023`, `Particle Effects Masterclass`, `CSS3 Experiments`, `Game Development with Vanilla JavaScript`.
...
内容: Nuxt, Vue, TypeScript \
主なプレイリスト: `Nuxt Performance In Depth`, `Vue 3`, `Nuxt 3`. \
<br/>

### バックエンド <a id="backend"></a>
...
内容: Web development in general, serverless \
主なプレイリスト: `AWS Amplify`. \
<br />
...
内容: Databases, Networking, Backend Development, Security, Protocols, Concepts \
主なプレイリスト: `High Availability`, `Python by Example`, `HTTP/2`, `Message Queues & PubSub Systems`, `Proxies`, `many more video tutorials`.
<br />
...
内容: Backend Development, Concepts, Optimization techniques, Tools, Languages, Microservices \
主なプレイリスト: `Rust For TypeScript Devs`, `Performance`, `Vim As Your Editor`, `Building Great Tools`.
...
内容: Productivity tools \
主なプレイリスト: `Neovim`, `Rust`, `Node.js`. \
<br />

[🔼 Back to the top関連](#contents)

## コンピューターサイエンス <a id="computer-science"></a>
...
内容: Math \
主なプレイリスト: `Applied Math`, `Math Major`, `Computer Science/Computer Engineering`, `Electrical Engineering`, `Mechanical Engineering`.
...
内容: Math, Quantum Physics \
主なプレイリスト: `Mathematics Videos - Domain of Science`, `The Map of Quantum Physics Expanded`, `Videos I made for D-Wave Systems`.
...
内容: Electronics, Networking, Theoretical classes \
主なプレイリスト: `Network Theory`, `Computer Networks`, `Digital Electronics`, `Signals and Systems`, `Programming languages playlists`.
...
内容: Software, Hardware \
主なプレイリスト: `How Computer Memory Works`, `Data Analysis with Dr Mike Pound`, `Artificial Intelligence with Rob Miles`, `Remote Working Technologies`.
...
内容: Theoretical classes, Lectures \
主なプレイリスト: `Computer Science and Security`, `Engineering`, `Energy Technologies`, `Leadership and Management`, `Natural Language Processing with Deep Learning`.
...
内容: Math, Data science \
主なプレイリスト: `Data Science, Data Visualization playlists`, `Mathematics and Statistics playlists`, `more videos related`.
...
内容: Math, Computer science, Engineering \
主なプレイリスト: `Mathematics playlists`, `Computer science playlists`, `Engineering playlists`. \
<br />
...
内容: Computer science and General Programming \
主なプレイリスト: `CS50's Introduction to Artificial Intelligence with Python 2020`, `CS50's Web Programming with Python and JavaScript 2020`, `CS50's Introduction to Game Development 2018`.
...
内容: Maths and visualization of various mathematical concepts \
主なプレイリスト: `Essence Of Calculus`, `Essence Of linear Algebra`, `Neural Networks`. \
<br />
...
内容: Math, Computing, General science \
主なプレイリスト: `Abstract Algebra`, `Learn Python playlist`, `videos about studying`, `many more science topics`.
...
内容: C/C++ language, Data structures, Algorithm \
主なプレイリスト: `Sorting Algorithms`, `Data structures`, `Pointers in C/C++`, `Introduction to Programming through 'C'`.
...
内容: Concepts, Theory \
主なプレイリスト: `Raspberry Pi`, `Microcontrollers`, `Programming`, `Linux`, `more!`. \
<br />
...
内容: Data visualization, Machine learning, Data manipulation, Neural networks \
主なプレイリスト: `Linear Regression and Linear Models`, `Machine Learning`, `High Throughput Sequencing`, `Statistics Fundamentals`, `and more!`.
...
内容: Mathematics \
主なプレイリスト: `Binomial theory`, `Calculus`, `Algebra`, `Complex numbers`. \
<br />
...
内容: Mathematics \
主なプレイリスト: `Algebra`, `Statastics`, `Calculus`. \
<br />
...
内容: Java OOP, Oracle database, Datastructure (IN Hindi Lang) \
主なプレイリスト: `Java OOP`, `Oracle database`, `C Programs`. \
<br />
...
内容: Backend, Rendering, Theoretical classes \
主なプレイリスト: `OpenGL`, `the Clojure language`, `Python playlists`, `Pigeon, an educational programming language`, `many more interesting playlists!`.
...
内容: Assembly language, Hardware, Computer sciences \
主なプレイリスト: `Building an 8-bit breadboard computer!`, `Network tutorial`, `Digital electronics tutorials`, `a lot of videos related`.
...
内容: Python, Math, Numpy \
主なプレイリスト: `Mastering Python Libraries`, `Essential Python Functions`, `GPU Accelerated Python`.
...
内容: Fundamental math, Calculus, Tensors \
主なプレイリスト: `Tensors for Beginners`, `Tensor Calculus`, `Spinors for Beginners`, `Error Correcting Codes (ECCs)`.
...
内容: Fundamental math, Physics \
主なプレイリスト: `Fractals`, `Collision Detection`, `3D`, `Physics`, `Application - Ballistics`, `Trigonometry`.
...
内容: Computer science, Low Level Programming. \
...
内容: Practical videos, Talks \
主なプレイリスト: `Applied Machine Learning Framework`, `Tips & Tricks of machine learning`, `more videos!`.
...
内容: Deep learning, Theoretical \
主なプレイリスト: `Deep Learning`, `Convolutional Neural Network`, `Neural Networks playlists`, `many more playlists!`.
...
内容: PyTorch, TensorFlow \
主なプレイリスト: `PyTorch Tutorials`, `TensorFlow 2.0 Beginner Tutorials`, `Machine Learning Algorithms`.
...
内容: Machine learning \
主なプレイリスト: `Applied Machine Learning 2020`. \
<br />
...
内容: Python, Machine learning, Theoretical \
主なプレイリスト: `Introduction to Machine Learning playlists`, `Data analysis in Python with Pandas`, `other talks videos and Python videos`.
...
内容: Theoretical \
主なプレイリスト: `Deep Learning Paper Summaries`, `Reinforcement Learning`, `Generative Adversarial Networks`, `Neural Network Design`.
...
内容: Deep learning, Theoretical \
主なプレイリスト: `Deep Learning from the Foundations`, `Introduction to Machine Learning for Coders`, `Practical Deep Learning for Coders (2018, 2019, 2020)`.
...
内容: Rasa, AI, NLP \
主なプレイリスト: `NLP for Developers`, `Developing Contextual AI assistants with Rasa tools`, `Algorithm Whiteboard`, `Live Coding`.
...
内容: NLP, Machine learning, Deep learning, Theoretical \
主なプレイリスト: `Natural Language Processing`, `General Machine Learning`, `Deep Learning Architectures`, `Computer Vision`, `Applications of Machine Learning`, `more!`.
...
内容: NLP, Machine learning, AI \
主なプレイリスト: `Events and Talks`, `Research Releases`, `Robotics`. \
<br />
...
内容: Machine Learning and AI Research, Scientific Papers \
主なプレイリスト: `Two Minute Papers`, `AlphaGo`, `Fluid, Cloth and Hair Simulations`, `AI and Deep Learning`, `Light Transport, Ray Tracing and Global Illumination`.
...
内容: Machine Learning Engineering, Practical videos, Books review \
主なプレイリスト: `Machine Learning Systems`, `Graph Neural Networks`, `more videos!`. \
<br />
...
内容: Python for AI and Finance \
主なプレイリスト: `Python Programming for Finance`, `Machine Learning with Python`, `Neural Networks from Scratch in Python`.
...
内容: AI / LLM news, tips, and tricks. \
主なプレイリスト: `ChatGPT Beginner Course`. \
<br />
...
内容: GitOps, Continuous Integration, Continuous Delivery, IaC, Kubernetes, Docker \
主なプレイリスト: `DevOps Concepts explained`, `Infrastructure as Code (IaC) Tutorials`, `DevOps Bootcamp`.
...
内容: Kubernetes, Docker, Terraform \
主なプレイリスト: `DevOps Pre-requisites`, `Docker for the Absolute Beginners`, `Kubernetes for the Absolute Beginners`.
...
内容: DevOps, Docker, Kubernetes, Ansible \
主なプレイリスト: `Complete Docker Course`, `Complete Ansible Course`, `Complete Vagrant Course`. \
<br />
...
内容: GitOps, Docker, Kubernetes, Rancher, AWS \
主なプレイリスト: `Kubernetes`, `CI/CD`, `This vs. that`. \
<br />
...
内容: Kubernetes, AWS, Google Cloud Platform, Docker, Linux containers, Jenkins, Databases (MySQL/MongoDB/Postgres), Elasticsearch Stack, Red Hat, Devops \
主なプレイリスト: `Kubernetes Provisioning`, `Learn AWS`, `Google Cloud Platform for Beginners`.
...
内容: DevOps Cloud, Architecture, Tips & tricks \
主なプレイリスト: `System Design Primer`, `AWS primer`, `Google Cloud Primer`, `Sprint Cloud Primer`. \
<br />
...
内容: Java concurrency, Distributed systems, System design, Microservice etc. \
主なプレイリスト: `Microservices`, `Distributed Systems`. \
<br />
...
内容: Software Architecture & Design, Messaging, CQRS, Event Sourcing and HTTP APIs \
主なプレイリスト: `Architecture`, `Software Design`. \
<br />
...
内容: High-Quality DevOps Tutorials \
主なプレイリスト: `Terraform Tutorial for Beginners`, `Prometheus (Thanos) Tutorials`, `Amazon EKS`, `100 Seconds of Code`. \
<br />
...
内容: Unity, C# \
主なプレイリスト: `Create a 2D Game In Unity`, `Unity for Beginners!`, `Learn Unity Basics!`, `C# Tutorials`.
...
内容: JavaScript, HTML5 \
主なプレイリスト: `How to Make HTML5 Games: JavaScript Tutorial for Beginners JS Guide`, `a lot more videos`.
...
内容: Unity, C#, Game design \
主なプレイリスト: `How to make a 2D Platformer - Unity Course`, `Making a Multiplayer FPS in Unity`, `How to program in C# - Beginner Course`, `Unity 2D Tutorials`.
...
内容: GameMaker Studio, Tips and planning playlists \
主なプレイリスト: `Will You Snail? - Full Development.`, `Game Dev Tips`, `How To Get Started With Game Development.`.
...
内容: Java, GameMaker Studio \
主なプレイリスト: `Java Basic Programming`, `Cool Game Maker Tutorials`, `Beginner Java Game Development`, `Java Platform Game Programming`.
...
内容: Game design, Animation \
主なプレイリスト: `Geometric design playlists`, `Video Game Character Animation Course`, `After Effects Animation Tutorials`.
...
内容: HTML5 Canvas, JavaScript \
主なプレイリスト: `HTML5 Canvas Tutorials for Beginners | Become a Canvas Pro`, `other JavaScript-related videos`.
...
内容: Unity, Unreal Engine, Godot \
主なプレイリスト: `Master Unity Game Development`, `Unreal Game Development Mini-Degree`, `Godot Game Development Mini-Degree`, `a very lot more playlists about game development and design!`.
...
内容: Unity \
主なプレイリスト: `Mix and Jam Recreations`, `Game Jams`, `RE Mix and Jam`. \
<br />
...
内容: Pygame \
主なプレイリスト: `Pygame Tutorial Series (beginner)`, `Pygame Tutorial Series (amateur)`, `Pygame Tutorial Series (advanced)`, `more Pygame videos!`.
...
内容: C++, DirextX, 3D \
主なプレイリスト: `Beginner C++ Game Programming`, `Intermediate C++ Game Programming`, `Advanced C++ Game Programming`, `3D Programming Fundamentals`, `C++ 3D DirextX Programming`.
...
内容: GODOT \
主なプレイリスト: `Godot 3 tutorials`, `3d Maze Game in Godot`, `Make Your First 2D Game with Godot`, `Godot - Beginner Game Creation Tutorials`.
...
内容: GODOT, 2D, GameMaker \
主なプレイリスト: `Godot Engine Tutorials`, `Resource Based Inventory Tutorial in Godot`, `2D Hack-n-Slash Course (Complete Course)`, `GameMaker Platform Tutorials`.
...
内容: JavaScript \
主なプレイリスト: `Super Mario Bros in JavaScript`, `Creating a Tetris Online Multiplayer in Javascript`.
...
内容: Python \
主なプレイリスト: `Pygame Fundamentals`, `Creating Pong in Pygame`, `Learning pygame by making Flappy Bird`, `Google dinosaur runner in Godot`.
...
内容: game development, Robolox scripting \
主なプレイリスト: `Robolox scripting`. \
<br />
...
内容: C++, Game development \
主なプレイリスト: `Game Engine`, `C++`, `OpenGL`, `3D game programming in java`. \
<br />
...
内容: Math & Game Development \
主なプレイリスト: `Math For Game Devs (2020)`, `Visual Explanations`, `Math For Game Devs (2022)`. \
<br />
...
内容: Game Development with real projects \
主なプレイリスト: `4D Golf`, `Hyperbolica`, `Fractals & Math`. \
<br />
...
内容: Game Graphics, Shaders, Rays \
主なプレイリスト: `Shader Coding`, `Fractals`, `Ray Marching`, `Unity Tutorials`. \
<br />
...
内容: Conferences about inner functionality of top videogames \
主なプレイリスト: `Narrative Talks`, `Design Talks`, `Programming Talks`, `Art and Graphic Design Talks`, `Game Music Talks`, `Animation Talks`.
...
内容: Meta Game Development \
主なプレイリスト: `Game Engine Programminmg`, `A Programming Language for Games`. \
<br />
...
内容: Minecraft commands, Minecraft datapacks \
主なプレイリスト: `[Adventure Map Building]`, `[Minecraft 1.21 Datapack]`. \
<br />

[🔼 Back to the top関連](#contents)

## モバイル開発 <a id="mobile-development"></a>
...
内容: Android, Kotlin, Jetpack Compose \
主なプレイリスト: `ANDROID FUNDAMENTALS FOR BEGINNERS`, `KOTLIN NEWBIE TO PRO`, `Jetpack Compose`. \
<br />
...
内容: Android, Backend \
主なプレイリスト: `PHP, MySQL and Firebase videos`, `Kotlin Programming Tutorial`, `more videos and playlists`.

[🔼 Back to the top関連](#contents)

## サイバーセキュリティ <a id="cybersecurity"></a>
...
内容: Ethical hacking, Linux \
主なプレイリスト: `CCNA Exam: 200-125, 100-105 and 200-105`, `Cisco playlists`, `SDN Videos`. \
<br />
...
内容: Hacking \
主なプレイリスト: `Browser hacking`, `DevTools hacking`, `OS hacking`, `SerenityOS`, `Emulator hacking`. \
<br />
...
内容: Security \
主なプレイリスト: `CompTIA Security+ SY0-501 Training Course`, `CompTIA N10-007 Network+ Study Groups`, `and many more like this!`.
...
内容: Ethical hacking, Security \
主なプレイリスト: `Cyber Security - Penetration Testing Course (Offensive Security)`, `Kali Linux Tutorials | Pentesting Methods |`.
...
内容: Ethical hacking \
主なプレイリスト: `Browser Exploitation`, `Hardware Security Research/Mobile`, `Binary Exploitation`. \
<br />
...
内容: Networking and security, Tutorials on Pentesting tools, Ethical hacking \
主なプレイリスト: `Using Wireshark`, `NodeMCU`, `RaspberryPi`, `Cyber Weapons lab`. \
<br />
...
内容: Pentesting, Ethical hacking, Linux \
主なプレイリスト: `Metasploit`, `Linux`, `NMap`,`Osint`. \
<br />
...
内容: Cyber security \
主なプレイリスト: `Breaking Into Cybersecurity Videos - Simply Cyber`, `Cybersecurity Job Hunting QA with Recruiters`, `Free Pentester List Companion`.
...
内容: Networking, Cyber security, Ethical hacking \
主なプレイリスト: `Linux - NetworkChuck`, `FREE Security+ SY0-601 // Complete Course // thisisIT 2020`, `FREE CCNA 200-301 // Complete Course // NetworkChuck 2020`.
...
内容: Cyber security, Ethical hacking, Malware analysis \
主なプレイリスト: `Malware Analysis`, `TryHackMe`, `FORENSICS`. \
<br />
...
内容: Privacy guides, bitcoin \
主なプレイリスト: `Privacy guides`, `Bitcoin series`. \
<br />
...
内容: Privacy and security tutorials and reviews \
主なプレイリスト: `Go Incognito: A Guide to Security, Privacy, & Anonymity`. \
<br/>
...
内容: Malware identification, Exploits, Reverse engineering \
主なプレイリスト: `Dynamic Malware Analysis`, `Reverse Engineering Malware`, `Intro Reverse Engineering`, `Intro Trusted Computing`, `Introduction to ARM`.
...
内容: Ethical hacking, Penetration testing \
主なプレイリスト: `Game Hacking 100 - Game Hacking Course`, `C++ Pattern Scanning Tutorial`, `Linux Hacking Tutorials`.
...
内容: Cybersecurity, malware exploration, and virtualization. \
主なプレイリスト: `Malware Videos`, `Virtualization Tech Videos`, `YouTube Channel Hijacking Malware`.
<br/>

[🔼 Back to the top関連](#contents)

## インターネット／ネットワーク <a id="internetnetworking"></a>
...
内容: Internet, Networking, Command line, Hardware \
主なプレイリスト: `A lot of router/modem playlists`, `Software management of internet connection and network videos`.
...
内容: Networking \
主なプレイリスト: `Network Direction`, `Network Fundamentals`, `Firewall and LAN videos`. \
<br />
...
内容: Networking, CCNA \
主なプレイリスト: `Full Series | 200-301 CCNA | Free Cisco Video Training 2020 | Networking Inc.`, `other networking videos`.
...
内容: Networking hardware with other concepts with helpful the visuals. There is also a crash course on A+ and Net+. \
主なプレイリスト: `Information Technology`, `CompTIA Certification`.
...
内容: Electronics and Communication \
主なプレイリスト: `BJT`, `Analog Electronics`, `Network Analysis`. \
<br />
...
内容: SDR, Linux \
主なプレイリスト: `War Dragon`, `Raspberry Pi`, `WiFi IDS, monitoring, and incident response`, `and much more.`. \
<br />

[🔼 Back to the top関連](#contents)

## ソフトウェア全般 <a id="software-in-general"></a>
...
内容: Google Spreadsheets \
主なプレイリスト: `Google Sheets - Fundamental Skills`, `Google Apps Scripts - Fundamental`. \
<br />
...
内容: Excel, Office suite \
主なプレイリスト: `Excel 2020 Tutorials`, `Advanced Excel Tutorials`, `Microsoft Visio Tutorials`, `Windows 10 Tutorials`.
...
内容: Office suite, Microsoft \
主なプレイリスト: `Excel playlists`, `QuickBooks playlists`, `Power BI Tutorials`, `Microsoft Outlook 2019`, `more videos about Microsoft programs`.
...
内容: Theoretical videos \
主なプレイリスト: `How To Build An App`, `The Basics (Code)`, `other science videos`. \
<br />
...
内容: Linux \
主なプレイリスト: `Install and overview`, `Linux How-to`. \
<br />
...
内容: Windows \
主なプレイリスト: `Windows Server Beginners Tutorials`, `Managing Networking services in Windows Server`, `Managing Active Directory Infrastructure`.
...
内容: Linux, Emacs, CLI, Privacy in general.\
主なプレイリスト: `Privacy & Security`, `The church of Emacs`, `The command line`, `The Arch way`. \
<br />
...
内容: Linux Tutorials, Distribution reviews, Linux Guides \
主なプレイリスト: `Hardware reviews`, `Linux essentials`, `Linux commands for beginners`. \
<br />
...
内容: Linux, Windows, and his utility tools. \
主なプレイリスト: `CTT Utility Videos`, `Windows Playlists`, `Linux Playlists`. \
<br/>
...
内容: Linux \
主なプレイリスト: `window manager, dotfiles, and configuration`, `linux programs you should know about!`, `shell scripts, tricks, power usage.`.
...
内容: Linux apps and terminal setups, Server apps  \
主なプレイリスト: `Linux for Newbs`, `Neovim for Newbs`, `Tmux for Newbs`  \
<br/>
...
内容: Printing \
主なプレイリスト: `3D printing for beginners`, `3D Printing`, `Ender playlists`, `Onshape 3D Modelling`, `Printer reviews playlists`.
...
内容: All hardware \
主なプレイリスト: `Build Guides, Buyer's Guides, and Ultimate Guides`, `Computer Systems & All-in-Ones`, `CPU, Motherboard, Memory Videos`, `many more`.
...
内容: All hardware \
主なプレイリスト: `Hardware News`, `PC Case Reviews`, `Pre-Built Gaming PC Reviews`, `many more`. \
<br />
...
内容: All hardware \
主なプレイリスト: `PC Building`, `GPU`, `Custom Builds`. \
<br />
...
内容: Arduino \
主なプレイリスト: `Arduino Tutorials for Beginners`, `Raspberry Pi Tutorials for Beginners`, `a lot more Arduino tutorials/projects videos!`.
...
内容: Raspberry Pi, 3D Printing, Electronics \
主なプレイリスト: `3D Printing`, `DIY or Buy`, `Build your own Ambilight with the Raspberry Pi`. \
<br />
...
内容: Raspberry Pi \
主なプレイリスト: `Getting started with your Raspberry Pi`. \
<br />
...
内容: Raspberry Pi, Electronics, Operation System \
主なプレイリスト: `Artificial Intelligence`, `Pi Zero Projects`, `Migrating to Linux`, `many more`. \
<br />
...
内容: Raspberry Pi, Electronics, Operation System, Single Board Computers, Gaming \
主なプレイリスト: `Single Board Computer Reviews`, `Gaming on SBCs`, `many more`. \
<br />
...
内容: Server Hardware, Networking and other hardware for the professional \
主なプレイリスト: `About Servers`, `Fanless`, `Mini PC`, `Workstations`, `Current Events`, `Storage`, `Server Processors`, `Networking`, `Cool server hardware`.
...
内容: All technological devices internal working \
主なプレイリスト: `Memory`, `SSD`, `Microchips`, `Mouse`, `PCB`. \
<br />
...
内容: Radio-controlled devices, Arduino \
主なプレイリスト: `Arduino RC Things`, `RUBE editor tutorials`, `Arduino mini radiosonde`, `Arduino GSM Things`, `Noobs guide to quadcopters`.
...
内容: Various devices, Linux, Open source \
主なプレイリスト: `DIY / Repair`, `Retro / Vintage`, `Linux`, `FPGA`. \
<br />
...
内容: Reverse engineering, Video game hacking \
主なプレイリスト: `Game & Watch Hacking`, `Game Boy Hacking`, `Embedded & IoT hacking`, `Reversing WannaCry`.
...
内容: Electronics, Computer peripherals, Devices \
主なプレイリスト: `Electronics Tutorial - DC Fundamentals`, `Electronics Tutorials - AC Theory Series`, `Open Source Hardware`, `and many more!`.
...
内容: Electronics, Circuits \
主なプレイリスト: `Basics on Capacitors and Inductors`, `Op Amp Tutorials`, `Circuit Tutorials`, `Bipolar Transistor Videos`.
...
内容: Electronics \
主なプレイリスト: `Electronics for Beginners`, `All about bateries`, `Passive filters`, `Oscilloscope tutorials`, `Tutorials about inductors`.
...
内容: Electronics, Systems, Theoretical classes \
主なプレイリスト: `Control Systems`, `Electromagnetic Field Theory`, `Digital System Design/Digital logic design`, `Circuit Theory/Network Theory`, `Transmission Lines and Waveguides`.
...
内容: Devices, Repair tutorials \
主なプレイリスト: `Not recognizing internal SSD/hard drive`, `SSD Data Recovery`, `Macbook USB port not working`, `usb drive data recovery`, `and much more!`.

[🔼 Back to the top関連](#contents)

## 競技プログラミング <a id="competitive-programming"></a>
...
内容: Data Structures and Algorithms, Dynamic Programming, Leetcode \
主なプレイリスト: `Dynamic Programming`, `Graph Algorithms`, `Binary Tree`. \
<br />
...
内容: System Design, Data Structures & Algorithms \
主なプレイリスト: `System Design`, `Competitive Programming A-Z`. \
<br />
...
内容: Large scale system design \
主なプレイリスト: `Algorithms You Should Know For System Design`, `System Design Fundamentals`, `System Design Interview`.
...
内容: Data Structures & Algorithms \
主なプレイリスト: `Data Structures and Algorithms`, `Coding Interview Questions and Answers`. \
<br />
...
内容: Leetcode, Software Engineering Interview \
主なプレイリスト: `Tree, Binary Trees & Binary Search Tree`, `Sorting, Searching & Heaps`, `Dynamic Programming, Recursion & Backtracking`, `Graphs, Greedy Algorithms & Other`. 
<br />
...
内容: Leetcode, Codeforces \
主なプレイリスト: `Codeforces Problems`, `Leetcode Coding Interview Problems`. \
<br />
...
内容: Leetcode, Coding Interview \
主なプレイリスト: `LeetCode East`, `LeetCode Medium`, `LeetCode Hard`. \
<br />
...
内容: Leetcode, Coding Interview \
主なプレイリスト: `Technical Interview Questions`. \
<br />
...
内容: Leetcode, HackerRank, Coding Interview \
主なプレイリスト: `LeetCode Solution`, `HackerRank Solution`. \
<br />
...
内容: Code Chef, Codeforces \
主なプレイリスト: `Codeforces Screencasts`. \
<br />
...
内容: Algoritms, Data structures \
主なプレイリスト: `Network Flow playlist`, `Data structures playlist`, `Graph Theory Playlist`, `Tree Algoritms`, `Dynamic Programming`.
...
内容: Data Structures, Algorithms, Coding Interview \
主なプレイリスト: `Array Methods Mini Course`, `Javascript Algorithms + Data Structures`. \
<br />
...
内容: Theoretical, Data \
主なプレイリスト: `Introduction to Data Structures`, `Sorting Algorithm Lectures/Visualizations`, `Introduction to Object-Oriented Programming`.

[🔼 Back to the top関連](#contents)

## デジタルデザイン <a id="digital-design"></a>
...
内容: Adobe Illustrator, Illustrations \
主なプレイリスト: `Adobe Illustrator CC Flat Illustration Tutorials`, `Logo Creation Tutorials Playlist`, `Adobe Illustrator CC for Beginners`, `more Adobe Illustrator playlists`.
...
内容: Adobe Illustrator, Illustrations, Flat design \
主なプレイリスト: `Tutorials - Illustrator`, `Tutorials - After Effects`, `Tutorials - Flat Design`. \
<br />
...
内容: Adobe Illustrator, Adobe Photoshop, Hand-drawing \
主なプレイリスト: `Adobe Illustrator Tutorials`, `Character Illustration Illustrator Tutorials`, `Adobe Illustrator Tools Tutorials`.
...
内容: Adobe Illustrator, Adobe Photoshop \
主なプレイリスト: `Illustrator Tutorials`, `Photoshop Tutorials`, `other design videos`. \
<br />
...
内容: Gimp, Inkscape, Adobe Illustrator \
主なプレイリスト: `Gimp Photo Manipulation`, `Inkscape playlist`, `Adobe Illustrator videos`. \
<br />
...
内容: Procreate, Ipad/tablet drawing \
主なプレイリスト: `PROCREATE TUTORIALS`, `DIGITAL ART TUTORIALS`, `Digital Drawing on iPad Pro | Easy Drawing Tutorials`, `more playlists!`.
...
内容: All design, Illustrations, Web design \
主なプレイリスト: `Learn Adobe Photoshop`, `Learn About Fonts`, `Photo and video manipulation playlists`, `Figma videos`, `Learn Photo Effects`.
...
内容: Inkscape, Gimp \
主なプレイリスト: `Inkscape Beginner Tutorials`, `GIMP Tutorials`, `Inkscape Typeface Tutorials`, `Inkscape Logo Design Tutorials`.
...
主なプレイリスト: `The Logo Design Process`, `Adobe Illustrator Tips & Tricks`, `Character Designs`, `Illustrator Speedarts`.
...
内容: web, graphic design \
主なプレイリスト: `Design careers`, `Workflow`, `Design chat`, `Freelancing as a designer`. \
<br />
...
内容: Design principles, Design tools tutorials \
主なプレイリスト: `365 days of creativity`, `Illustrator CC`, `Indesing tutorials`, `Photoshop CC`. \
<br />

[🔼 Back to the top関連](#contents)

## 音声・動画 <a id="audio-and-video"></a>
...
内容: Audio, Hardware \
主なプレイリスト: `PreSonus Studio One Tutorials`, `Cubase Tutorials`, `Ableton Tutorials by OBEDIA`, `Cakewalk Sonar Tutorials`.
...
内容: After Effects, Animation \
主なプレイリスト: `SPEEDPAINT ANIMATION`, `Motion Design`, `After Effects Tutorials`. \
<br />
...
内容: Animation, Design \
主なプレイリスト: `After Effects Tutorials`, `Text Animation - After Effects Tutorials`, `Logo Intro - After Effects Tutorials`, `Motion Graphics - After Effects Tutorials`.
...
内容: Video, Photos \
主なプレイリスト: `Video Editing`, `Manipulation PicsArt`, `many other video/photo editing videos`. \
<br />
...
内容: Blender, 3D modeling \
主なプレイリスト: `Blender beginner tutorial series`, `Blender modeling chair tutorial`, `Couch tutorial series`.
...
内容: 3D modeling, Reptology, Blender \
主なプレイリスト: `Learn sculpting in blender 2.8`, `Blender 2.8 for beginners full course`. \
<br />
...
内容: Blender, 3D modeling \
主なプレイリスト: `Blender 2.9 Beginner Tutorial Series`, `CG Fast Track`. \
<br />
...
内容: Animation, Blender, 3D modeling, Visual Effects \
主なプレイリスト: `Blender beginner tutorial series`, `Bob Ross with Realistic 3D graphics`, `Blender Nature tutorials`, `Star wars 3D tutorials`.
...
内容: Video, Photos \
主なプレイリスト: `Shading with nodes`.`Making looping animations with Blender in Eevee engine` \
<br />
...
内容: Music theory, Music libraries \
主なプレイリスト: `SCAMP Tutorial`, `SCAMP`, `Video Essays` \
<br />

[🔼 Back to the top関連](#contents)

## 生活スキル <a id="life-skills"></a>
...
内容: Job searching, General skills, Life tips \
主なプレイリスト: `Searching For A Job`, `Economic thinking playlists`, `Office Suite tutorials`, `Making Decisions`, `Life skills playlists`, `and more!`.
...
内容: Career, Productivity, Software engineering, Life tips \
主なプレイリスト: `Finance`, `Start ups`, `Book reviews & recommendations`, `Productivity`, `Technical interview preparation`, `Career & success`, `Software engineering`.
...
内容: Job tips, Health \
主なプレイリスト: `How to Kickstart Your Software Engineering Career`, `📈career 📈`, `🖥t e c h 🖥`, `🌱health 🌱`.
...
内容: Interviews, Portfolio Reviews, Getting a Job \
主なプレイリスト: `Entrepreneurship`, `How to apply to jobs`. \
<br />
...
内容: Programming, Job Offers, Salaries, Interviewing \
主なプレイリスト: `Path to Software Engineering`, `Tech Shows`, `Startup Series`, `Interviews`, `Data Science Analytics`.
...
内容: Open Source, Freelancing \
主なプレイリスト: `Freelancing tips`, `LinkFree Videos`, `Git must know commands`. \
<br/>
