...
- [Latest Ansible Documentation](https://docs.ansible.com/ansible/latest/user_guide/index.html) - Ansibleの最新ユーザーガイド・ドキュメント。
- [Ansible Galaxy Website](https://galaxy.ansible.com/) - Ansible Roleの公式リポジトリ・コミュニティサイト。
- [Ansible Blog](https://www.ansible.com/blog) - 公式Ansibleブログ。
...
- [Get Help](https://forum.ansible.com/c/help/6) - 質問・回答のためのフォーラム。新しい議論を始める際は適切なタグを追加する。
- [Bullhorn newsletter](https://docs.ansible.com/ansible/devel/community/communication.html#the-bullhorn) - リリースや重要な変更の告知に使用される。
- [Social Spaces](https://forum.ansible.com/c/chat/4) - 同じ関心を持つ人々と集い交流する。
- [News & Announcements](https://forum.ansible.com/c/news/5) - 社交イベントを含むプロジェクト全体の告知を追跡する。

コミュニケーションの詳細は[Ansible communication guide](https://docs.ansible.com/ansible/devel/community/communication.html)を参照。
...
- [How To Manage Remote Servers with Ansible](https://www.digitalocean.com/community/tutorial_series/how-to-manage-remote-servers-with-ansible) - Ansibleでリモートサーバーを管理する方法を扱うチュートリアル。
- [Ansible Tutorial by leucos](https://github.com/leucos/ansible-tuto) - Ansibleの12ステップチュートリアル。
- [Programming Community Curated Resources for learning Ansible](https://hackr.io/tutorials/learn-ansible) - 推奨リソースのリスト。
- [Ansible TopTechSkills.com Tutorial Series on Ansible](https://www.toptechskills.com/ansible-tutorials-courses/) - Ansibleのインストール・利用方法に関するチュートリアル。
...
- [Ansible for DevOps](https://www.ansiblefordevops.com/) - 1台から数千台のサーバーをプロビジョニング・管理するためにAnsibleを使い始める助けとなる書籍。無料サンプルは[こちら](https://leanpub.com/ansible-for-devops/read_sample)。
- [Ansible for Kubernetes](https://www.ansibleforkubernetes.com/) - Ansibleで実運用の大規模スケーラブル・高可用性アプリケーションをデプロイ・保守する。
...
- [Ansible YouTube Channel](https://www.youtube.com/channel/UCPJo5UY1KsP7J1BuHmiWNzQ) - 公式Ansible YouTubeチャンネル。
- [Introduction to Ansible](https://youtu.be/iVWmbStE1MM) - Cloud Academyによる初心者向け概要。
- [Ansible 101 by Jeff Geerling](https://www.jeffgeerling.com/blog/2020/ansible-101-jeff-geerling-youtube-streaming-series) - Jeff Geerlingによる優れたAnsible動画シリーズ。
...
- [Automation Controller](https://www.ansible.com/products/controller) - 旧Ansible Tower。IT自動化の拡張、複雑なデプロイ管理、生産性向上を支援するRed Hat製品で、チーム全体へAnsibleの力を広げる。
- [AWX](https://github.com/ansible/awx) - Ansible上に構築されたWebベースUI、REST API、タスクエンジン。Automation Controllerの上流プロジェクト。
- [Ansible Lint](https://github.com/ansible/ansible-lint) - Playbookのベストプラクティスと改善可能な振る舞いを検査する。
- [Ansible Doctor](https://github.com/thegeeklab/ansible-doctor) - Jinja2テンプレートに基づく、Ansible Role向けの注釈風シンプルなドキュメント生成器。
...
- [ansible-security-scanner](https://github.com/cpeoples/ansible-security-scanner) - Static analyzer for playbooks, roles and collections covering hardcoded credentials, RCE, and supply-chain risks. Outputs SARIF, CycloneDX SBOM and GitLab SAST.
...
- [Ansible Vagrant Examples by geerlingguy](https://github.com/geerlingguy/ansible-vagrant-examples) - Vagrantを使いローカルVMへデプロイするAnsible例。
- [Ansible playbook for Linux machine setup](https://github.com/olivomarco/my-ansible-linux-setup) - Dockerデーモンを備え、自動更新・強化されたDebian/Ubuntuマシンを設定するAnsible Playbook。
- [Ansible Lockdown](https://github.com/ansible-lockdown) - OS・アプリケーションの[CIS](https://www.cisecurity.org/#/)または[STIG](https://public.cyber.mil/stigs/)ベースライン準拠を監査・是正するためのAnsibleコンテンツ。
- [DevSec Hardening Framework](https://dev-sec.io/) - LinuxベースOS、MySQL、NGINX、SSHサーバー／サービスを強化するDevSec Collection。
...
- [Ansible Language Server](https://github.com/ansible/ansible-language-server) - 対応エディターにAnsibleサポートを追加するLanguage Server。
- [VS Code - official Ansible Extension](https://marketplace.visualstudio.com/items?itemName=redhat.ansible) - ansible-language-serverを活用してVisual Studio Code・OpenVSX対応エディターへAnsible言語サポートを追加する。

- [Vim](https://www.vim.org/) - オープンソースで無料のコマンドラインテキストエディター。便利なVimプラグイン:
...
- [Emacs](https://www.gnu.org/software/emacs/) - 自動インデント、構文強調、組み込みターミナルシェルなどをサポートする無料・オープンソースのテキストエディター・IDE:
