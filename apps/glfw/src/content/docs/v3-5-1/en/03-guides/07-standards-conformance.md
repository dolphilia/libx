...
with [glfwSetClipboardString](/docs/glfw/v3-5-1/en/04-reference/06-input-reference/#gaba1f022c5eb07dfac421df34cdcd31dd), the clipboard will be emptied when the library
is terminated.
...
the [GLFW_SCALE_FRAMEBUFFER](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gaa5a9c6b4722670fd33d6e8a88f2e21bc) window hint will only be able to scale the
...
hints to `GLFW_TRUE` will cause [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb) to fail.
...
[glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb) to fail.
...
functional ICD is missing, [glfwVulkanSupported](/docs/glfw/v3-5-1/en/04-reference/07-vulkan-support-reference/#ga2e7f30931e02464b5bc8d0d4b6f9fe2b) will return `GLFW_FALSE` and
all other Vulkan-related functions will fail with an [GLFW_API_UNAVAILABLE](/docs/glfw/v3-5-1/en/04-reference/02-error-codes/#ga56882b290db23261cc6c053c40c2d08e)
error.
...
[glfwGetRequiredInstanceExtensions](/docs/glfw/v3-5-1/en/04-reference/07-vulkan-support-reference/#ga99ad342d82f4a3421e2864978cb6d1d6) will return an empty list and window
...
extensions are not available, [glfwGetRequiredInstanceExtensions](/docs/glfw/v3-5-1/en/04-reference/07-vulkan-support-reference/#ga99ad342d82f4a3421e2864978cb6d1d6) will
return an empty list and window surface creation will fail.

GLFW uses the `VK_KHR_surface` and either the `VK_KHR_xlib_surface` or
`VK_KHR_xcb_surface` extensions to create surfaces on X11.  If `VK_KHR_surface`
or both `VK_KHR_xlib_surface` and `VK_KHR_xcb_surface` are not available, [glfwGetRequiredInstanceExtensions](/docs/glfw/v3-5-1/en/04-reference/07-vulkan-support-reference/#ga99ad342d82f4a3421e2864978cb6d1d6) will return an empty list and window surface
creation will fail.

GLFW uses the `VK_KHR_surface` and `VK_KHR_wayland_surface` extensions to create
surfaces on Wayland.  If any of these extensions are not available, [glfwGetRequiredInstanceExtensions](/docs/glfw/v3-5-1/en/04-reference/07-vulkan-support-reference/#ga99ad342d82f4a3421e2864978cb6d1d6) will return an empty list and window surface
creation will fail.
