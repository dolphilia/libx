...
description: "Internal interfaces and platform organization"
---
...
## Native interface
The [native interface](/docs/glfw/v3-5-1/en/04-reference/08-native-access/) is a small set of publicly available
