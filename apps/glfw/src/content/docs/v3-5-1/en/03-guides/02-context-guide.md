---
title: "Context guide"
description: "OpenGL and OpenGL ES context management"
---
...
There are a number of hints, specified using [glfwWindowHint](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga7d9c8c62384b1e2821c4dc48952d2033), related to
what kind of context is created.  See
[context related hints](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_hints_ctx) in the window guide.


<a id="context_sharing"></a>

### Context object sharing
When creating a window and its OpenGL or OpenGL ES context with [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb), you can specify another window whose context the new one
...
[GLFW_VISIBLE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_VISIBLE_hint) window hint.
...
You should still [process events](/docs/glfw/v3-5-1/en/03-guides/05-input-guide/#events) as long as you have at least one
...
[GLFW_CLIENT_API](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_CLIENT_API_hint) hint to `GLFW_NO_API`.

Windows without contexts should not be passed to [glfwMakeContextCurrent](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga1c04dc242268f827290fe40aa1c91157) or
[glfwSwapBuffers](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga15a5a1ee5b3c2ca6b15ca209a12efd14).  Doing this generates a [GLFW_NO_WINDOW_CONTEXT](/docs/glfw/v3-5-1/en/04-reference/02-error-codes/#gacff24d2757da752ae4c80bf452356487) error.
...
The context of a window is made current with [glfwMakeContextCurrent](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga1c04dc242268f827290fe40aa1c91157).

```c
glfwMakeContextCurrent(window);
```

The window of the current context is returned by [glfwGetCurrentContext](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#gad94e80185397a6cf5fe2ab30567af71c).
...
functions without a current context will generate a [GLFW_NO_CURRENT_CONTEXT](/docs/glfw/v3-5-1/en/04-reference/02-error-codes/#gaa8290386e9528ccb9e42a3a4e16fc0d0)
error.
...
[context hints](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_hints_ctx).  If your needs are more complex, you can
check the actual OpenGL or OpenGL ES version with
[context attributes](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_attribs_ctx), or you can check whether
...
[extension loader library](/docs/glfw/v3-5-1/en/03-guides/02-context-guide/#context_glext_auto) will save you a ton of
tedious, repetitive, error prone work.

To use a certain extension, you must first check whether the context supports
that extension and then, if it introduces new functions, retrieve the pointers
to those functions.  GLFW provides [glfwExtensionSupported](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga87425065c011cef1ebd6aac75e059dfa) and [glfwGetProcAddress](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga35f1837e6f666781842483937612f163) for manual loading of extensions and new API functions.
...
To include the extension header, define [GLFW_INCLUDE_GLEXT](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_INCLUDE_GLEXT) before including
the GLFW header.
...
This is done with [glfwExtensionSupported](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga87425065c011cef1ebd6aac75e059dfa).
...
extension is supported, [glfwExtensionSupported](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga87425065c011cef1ebd6aac75e059dfa) returns `GLFW_TRUE`,
...
retrieve pointers to these functions with [glfwGetProcAddress](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga35f1837e6f666781842483937612f163).
