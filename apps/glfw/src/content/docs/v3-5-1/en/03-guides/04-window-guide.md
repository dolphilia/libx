---
title: "Window guide"
description: "Window creation, properties and events"
---
...
## Window objects
The [GLFWwindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3c96d80d363e67d13a41b5d1821f3242) object encapsulates both a window and a context.  They are
created with [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb) and destroyed with [glfwDestroyWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacdf43e51376051d2c091662e9fe3d7b2), or
[glfwTerminate](/docs/glfw/v3-5-1/en/04-reference/01-initialization-version-error/#gaaae48c0a18607ea4a4ba951d939f0901), if any remain.  As the window and context are inseparably
...
### Window creation
A window and its OpenGL or OpenGL ES context are created with [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb), which returns a handle to the created window object.  For
...
Windowed mode windows can be made full screen by setting a monitor with [glfwSetWindowMonitor](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga81c76c418af80a1cce7055bccb0ae0a7), and full screen ones can be made windowed by unsetting it
with the same function.

Each field of the [GLFWvidmode](/docs/glfw/v3-5-1/en/04-reference/05-monitor-reference/#ga902c2816ac9b34b757282daab59b2565) structure corresponds to a function parameter
...
----------------        | --------------
GLFWvidmode.width       | `width` parameter of [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb)
GLFWvidmode.height      | `height` parameter of [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb)
GLFWvidmode.redBits     | [GLFW_RED_BITS](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_RED_BITS) hint
GLFWvidmode.greenBits   | [GLFW_GREEN_BITS](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_GREEN_BITS) hint
GLFWvidmode.blueBits    | [GLFW_BLUE_BITS](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_BLUE_BITS) hint
GLFWvidmode.refreshRate | [GLFW_REFRESH_RATE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_REFRESH_RATE) hint

Once you have a full screen window, you can change its resolution, refresh rate
and monitor with [glfwSetWindowMonitor](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga81c76c418af80a1cce7055bccb0ae0a7).  If you only need change its
resolution you can also call [glfwSetWindowSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga371911f12c74c504dd8d47d832d095cb).  In all cases, the new
video mode will be selected the same way as the video mode chosen by [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb).  If the window has an OpenGL or OpenGL ES context, it will be
unaffected.
...
[GLFW_AUTO_ICONIFY](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_AUTO_ICONIFY_hint) window hint, for example if you
...
Note that [glfwGetVideoMode](/docs/glfw/v3-5-1/en/04-reference/05-monitor-reference/#gaba376fa7e76634b4788bddc505d6c9d5) returns the _current_ video mode of a monitor,
...
### Window destruction
When a window is no longer needed, destroy it with [glfwDestroyWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacdf43e51376051d2c091662e9fe3d7b2).
...
All windows remaining when [glfwTerminate](/docs/glfw/v3-5-1/en/04-reference/01-initialization-version-error/#gaaae48c0a18607ea4a4ba951d939f0901) is called are destroyed as well.
...
initialized with [glfwInit](/docs/glfw/v3-5-1/en/04-reference/01-initialization-version-error/#ga317aac130a235ab08c6db0834907d85e).  Integer value hints can be set individually
with [glfwWindowHint](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga7d9c8c62384b1e2821c4dc48952d2033) and string value hints with [glfwWindowHintString](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga8cb2782861c9d997bcf2dea97f363e5f).
You can reset all at once to their defaults with [glfwDefaultWindowHints](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gaa77c4898dfb83344a6b4f76aa16b9a4a).
...
arguments to [glfwCreateWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3555a418df92ad53f917597fe2f64aeb).
...
- [GLFW_STEREO](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_STEREO)
- [GLFW_DOUBLEBUFFER](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_DOUBLEBUFFER)
- [GLFW_CLIENT_API](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_CLIENT_API_hint)
- [GLFW_CONTEXT_CREATION_API](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_CONTEXT_CREATION_API_hint)
...
- [GLFW_OPENGL_FORWARD_COMPAT](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_OPENGL_FORWARD_COMPAT_hint)
- [GLFW_OPENGL_PROFILE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_OPENGL_PROFILE_hint)
...
_by the user_.  The window will still be resizable using the [glfwSetWindowSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga371911f12c74c504dd8d47d832d095cb) function.  Possible values are `GLFW_TRUE` and `GLFW_FALSE`.
...
focus when [glfwShowWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga61be47917b72536a148300f46494fc66) is called. Possible values are `GLFW_TRUE` and
`GLFW_FALSE`.

<a id="GLFW_SCALE_TO_MONITOR"></a>
__GLFW_SCALE_TO_MONITOR__ specified whether the window content area should be
resized based on [content scale](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_scale) changes.  This can be
...
based on [content scale](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_scale) changes.  This can be
because of a global user settings change or because the window was moved to
a monitor with different scale settings.
...
An [extension loader library](/docs/glfw/v3-5-1/en/03-guides/02-context-guide/#context_glext_auto) that assumes it knows
which API was used to create the current context may fail if you change this
hint.  This can be resolved by having it load functions via [glfwGetProcAddress](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga35f1837e6f666781842483937612f163).
...
functions or the OSMesa native access functions [glfwGetOSMesaColorBuffer](/docs/glfw/v3-5-1/en/04-reference/08-native-access/#ga3b36e3e3dcf308b776427b6bd73cc132)
and [glfwGetOSMesaDepthBuffer](/docs/glfw/v3-5-1/en/04-reference/08-native-access/#ga6b64039ffc88a7a2f57f0956c0c75d53) to retrieve the framebuffer contents.
...
Do not confuse these hints with [GLFW_VERSION_MAJOR](/docs/glfw/v3-5-1/en/04-reference/01-initialization-version-error/#ga6337d9ea43b22fc529b2bba066b4a576) and [GLFW_VERSION_MINOR](/docs/glfw/v3-5-1/en/04-reference/01-initialization-version-error/#gaf80d40f0aea7088ff337606e9c48f7a3), which provide the API version of the GLFW header.
...
set the [GLFW_OPENGL_PROFILE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_OPENGL_PROFILE_hint) hint accordingly.
...
ignored on other platforms.  This is set with [glfwWindowHintString](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga8cb2782861c9d997bcf2dea97f363e5f).
...
[glfwWindowHintString](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga8cb2782861c9d997bcf2dea97f363e5f).
...
These are set with [glfwWindowHintString](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga8cb2782861c9d997bcf2dea97f363e5f).
...
### User pointer
Each window has a user pointer that can be set with [glfwSetWindowUserPointer](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3d2fc6026e690ab31a13f78bc9fd3651) and queried with [glfwGetWindowUserPointer](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gae77a4add0d2023ca21ff1443ced01653).  This
...
The current state of the close flag is returned by [glfwWindowShouldClose](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga24e02fbfefbb81fc45320989f8140ab5)
and can be set or cleared directly with [glfwSetWindowShouldClose](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga49c449dde2a6f87d996f4daaa09d6708).  A common
...
### Window size
The size of a window can be changed with [glfwSetWindowSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga371911f12c74c504dd8d47d832d095cb).  For windowed
mode windows, this sets the size, in
[screen coordinates](/docs/glfw/v3-5-1/en/03-guides/01-introduction-to-the-api/#coordinate_systems) of the _content area_ or _content
...
There is also [glfwGetWindowSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gaeea7cbc03373a41fb51cfbf9f2a5d4c6) for directly retrieving the current size of
a window.
...
[framebuffer size](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_fbsize), which is in pixels, for pixel-based
calls.
...
can retrieve the extents of these with [glfwGetWindowFrameSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga1a9fd382058c53101b21cf211898f1f1).
...
There is also [glfwGetFramebufferSize](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga0e2637a4161afb283f5300c7f94785c9) for directly retrieving the current
...
The content scale for a window can be retrieved with [glfwGetWindowContentScale](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gaf5d31de9c19c4f994facea64d2b3106c).
...
window is created and when its content scale later changes, set the [GLFW_SCALE_TO_MONITOR](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_SCALE_TO_MONITOR) window hint.
...
the [GLFW_SCALE_FRAMEBUFFER](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gaa5a9c6b4722670fd33d6e8a88f2e21bc) window hint.
...
be enforced with [glfwSetWindowSizeLimits](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gac314fa6cec7d2d307be9963e2709cc90).  The user may resize the window
...
with [glfwSetWindowAspectRatio](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga72ac8cb1ee2e312a878b55153d81b937).  The user may resize the window freely
...
a specific position, you can set the desired position with the [GLFW_POSITION_X](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_POSITION_X) and [GLFW_POSITION_Y](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_POSITION_Y) window hints.
...
The position of a windowed mode window can be changed with [glfwSetWindowPos](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga1abb6d690e8c88e0c8cd1751356dbca8).  This moves the window so that the upper-left corner of its
content area has the specified [screen coordinates](/docs/glfw/v3-5-1/en/03-guides/01-introduction-to-the-api/#coordinate_systems).
...
There is also [glfwGetWindowPos](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga73cb526c000876fd8ddf571570fdb634) for directly retrieving the current position
...
whether one has been moved.  The [GLFW_POSITION_X](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_POSITION_X) and [GLFW_POSITION_Y](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_POSITION_Y)
window hints are ignored.  The [glfwGetWindowPos](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga73cb526c000876fd8ddf571570fdb634) and [glfwSetWindowPos](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga1abb6d690e8c88e0c8cd1751356dbca8)
functions emit [GLFW_FEATURE_UNAVAILABLE](/docs/glfw/v3-5-1/en/04-reference/02-error-codes/#ga526fba20a01504a8086c763b6ca53ce5).  The window position callback will
not be called.
...
set a new UTF-8 encoded window title with [glfwSetWindowTitle](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga5d877f09e968cef7a360b513306f17ff).
...
The current window title can be queried with [glfwGetWindowTitle](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gac6151765c54b789c4fe66c6bc6215953).
...
specifying a list of candidate images with [glfwSetWindowIcon](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gadd7ccd39fe7a7d1f0904666ae5932dc5).
...
handle for this monitor with [glfwGetWindowMonitor](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga4d766499ac02c60f02221a9dfab87299).

```c
GLFWmonitor* monitor = glfwGetWindowMonitor(window);
```

This monitor handle is one of those returned by [glfwGetMonitors](/docs/glfw/v3-5-1/en/04-reference/05-monitor-reference/#ga70b1156d5d24e9928f145d6c864369d2).
...
with [glfwSetWindowMonitor](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga81c76c418af80a1cce7055bccb0ae0a7).  When making a window full screen on the same or
...
Windows can be iconified (i.e. minimized) with [glfwIconifyWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga1bb559c0ebaad63c5c05ad2a066779c4).
...
Iconified windows can be restored with [glfwRestoreWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga52527a5904b47d802b6b4bb519cdebc7).  This function
...
You can also get the current iconification state with [glfwGetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacccb29947ea4b16860ebef42c2cb9337).
...
iconified or restore one from iconification.  The [glfwRestoreWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga52527a5904b47d802b6b4bb519cdebc7)
function can only restore windows from maximization and the iconify callback
will not be called.  The [GLFW_ICONIFIED](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_ICONIFIED_attrib) attribute
will be false.  The [glfwIconifyWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga1bb559c0ebaad63c5c05ad2a066779c4) function works normally.


<a id="window_maximize"></a>

### Window maximization
Windows can be maximized (i.e. zoomed) with [glfwMaximizeWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga3f541387449d911274324ae7f17ec56b).
...
Maximized windows can be restored with [glfwRestoreWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga52527a5904b47d802b6b4bb519cdebc7).  This function
...
You can also get the current maximization state with [glfwGetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacccb29947ea4b16860ebef42c2cb9337).
...
behavior by setting the [GLFW_MAXIMIZED](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_MAXIMIZED_hint) window hint
...
### Window visibility
Windowed mode windows can be hidden with [glfwHideWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga49401f82a1ba5f15db5590728314d47c).
...
and calling [glfwHideWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga49401f82a1ba5f15db5590728314d47c) on a full screen window does nothing.

Hidden windows can be shown with [glfwShowWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga61be47917b72536a148300f46494fc66).
...
the [GLFW_FOCUS_ON_SHOW](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FOCUS_ON_SHOW_hint) window hint to change
this behavior for all newly created windows, or change the behavior for an
existing window with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).

You can also get the current visibility state with [glfwGetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacccb29947ea4b16860ebef42c2cb9337).
...
setting the [GLFW_VISIBLE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_VISIBLE_hint) window hint before creating
the window.
...
### Window input focus
Windows can be given input focus and brought to the front with [glfwFocusWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga873780357abd3f3a081d71a40aae45a1).
...
[attention requests](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#window_attention).
...
You can also get the current input focus state with [glfwGetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacccb29947ea4b16860ebef42c2cb9337).
...
behavior by setting the [GLFW_FOCUSED](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FOCUSED_hint) window hint
before creating the window.
...
attention with [glfwRequestWindowAttention](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga2f8d59323fc4692c1d54ba08c863a703).
...
the [GLFW_TRANSPARENT_FRAMEBUFFER](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_TRANSPARENT_FRAMEBUFFER_hint)
window hint.
...
with the
[GLFW_TRANSPARENT_FRAMEBUFFER](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_TRANSPARENT_FRAMEBUFFER_attrib)
window attribute.
...
The opacity of the whole window, including any decorations, can be set with [glfwSetWindowOpacity](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gac31caeb3d1088831b13d2c8a156802e9).
...
The current opacity of a window can be queried with [glfwGetWindowOpacity](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gad09f0bd7a6307c4533b7061828480a84).
...
overlay like for example a notification, the [GLFW_FLOATING](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga7fb0be51407783b41adbf5bec0b09d80) and [GLFW_MOUSE_PASSTHROUGH](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga88981797d29800808ec242274ab5c03a) window hints and attributes may be useful.


<a id="window_attribs"></a>

### Window attributes
Windows have a number of attributes that can be returned using [glfwGetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gacccb29947ea4b16860ebef42c2cb9337).  Some reflect state that may change as a result of user
...
The [GLFW_DECORATED](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_DECORATED_attrib),
[GLFW_RESIZABLE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_RESIZABLE_attrib),
[GLFW_FLOATING](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FLOATING_attrib),
[GLFW_AUTO_ICONIFY](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_AUTO_ICONIFY_attrib) and
[GLFW_FOCUS_ON_SHOW](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FOCUS_ON_SHOW_attrib) window attributes can be
changed with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).
...
[GLFW_RESIZABLE](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_RESIZABLE_hint) window hint or after with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).
...
[GLFW_DECORATED](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_DECORATED_hint) window hint or after with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).
...
with the [GLFW_AUTO_ICONIFY](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_AUTO_ICONIFY_hint) window hint or after
with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).
...
[GLFW_FLOATING](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FLOATING_hint) window hint or after with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).
...
__GLFW_FOCUS_ON_SHOW__ specifies whether the window will be given input
focus when [glfwShowWindow](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga61be47917b72536a148300f46494fc66) is called. This can be set before creation
with the [GLFW_FOCUS_ON_SHOW](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_FOCUS_ON_SHOW_hint) window hint or
after with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).

<a id="GLFW_MOUSE_PASSTHROUGH_attrib"></a>
__GLFW_MOUSE_PASSTHROUGH__ specifies whether the window is transparent to mouse
input, letting any mouse events pass through to whatever window is behind it.
This can be set before creation with the
[GLFW_MOUSE_PASSTHROUGH](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_MOUSE_PASSTHROUGH_hint) window hint or after
with [glfwSetWindowAttrib](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#gace2afda29b4116ec012e410a6819033e).  This is only supported for undecorated windows.
...
[GLFW_DOUBLEBUFFER](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_DOUBLEBUFFER_attrib), as this is not provided by
OpenGL ES.
...
the [GLFW_DOUBLEBUFFER](/docs/glfw/v3-5-1/en/03-guides/04-window-guide/#GLFW_DOUBLEBUFFER_hint) window hint.
...
a new frame.  This is done with [glfwSwapBuffers](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga15a5a1ee5b3c2ca6b15ca209a12efd14).
...
function [glfwSwapInterval](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga6d4e0cdf151b5e579bd67f13202994ed) it is possible to select the minimum number of
monitor refreshes the driver should wait from the time [glfwSwapBuffers](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga15a5a1ee5b3c2ca6b15ca209a12efd14) was
...
If the interval is zero, the swap will take place immediately when [glfwSwapBuffers](/docs/glfw/v3-5-1/en/04-reference/03-window-reference/#ga15a5a1ee5b3c2ca6b15ca209a12efd14) is called without waiting for a refresh.  Otherwise at least
...
You can check for these extensions with [glfwExtensionSupported](/docs/glfw/v3-5-1/en/04-reference/04-context-reference/#ga87425065c011cef1ebd6aac75e059dfa).
