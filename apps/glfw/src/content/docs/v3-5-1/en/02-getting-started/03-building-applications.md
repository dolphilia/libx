...
description: "Build and link applications that use GLFW"
...
your development environment.  See [option macros](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#build_macros) below for
...
[GLFW_INCLUDE_NONE](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_INCLUDE_NONE) macro will explicitly prevent the GLFW header from
...
with the DLL version of GLFW, you also need to define the [GLFW_DLL](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_DLL).  This
...
the [GLFW_DLL](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_DLL) macro.  This can be done in your source files, as long as it
...
[GLFW_DLL](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_DLL) macro.
...
[extension loader library](/docs/glfw/v3-5-1/en/03-guides/02-context-guide/#context_glext_auto), use the OpenGL CMake
package.
...
for the GLFW header and, when applicable, the [GLFW_DLL](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#GLFW_DLL) macro.
...
[extension loader library](/docs/glfw/v3-5-1/en/03-guides/02-context-guide/#context_glext_auto), you should add the `gl`
pkg-config package.
...
It is recommended that you use [pkg-config](/docs/glfw/v3-5-1/en/02-getting-started/03-building-applications/#build_link_pkgconfig) when
